...
public class Step2_1 extends Step2<BigDecimal> {
    ...
    public static final BigDecimal M = BigDecimal.valueOf(49721724815627L);
    ...
    public BigDecimal call() throws Exception {
        BigDecimal sumd = BigDecimal.valueOf(0);
        BigDecimal xd = BigDecimal.valueOf(1);
        BigDecimal m = getM();
        for (long coefficient : getCoefficients()) {
            sumd = sumd.add(xd.multiply(BigDecimal.valueOf(coefficient)));
            xd = xd.multiply(m);
        }
        return sumd;
    }

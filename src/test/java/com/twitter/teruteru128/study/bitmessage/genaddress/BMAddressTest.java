...
public class BMAddressTest {
    ...
    public void encodeAddressTest() throws Exception {
        ...
        byte[] pubSigningKey = new byte[Ed25519.SECRET_KEY_SIZE];
        byte[] pubEncryptionKey = new byte[Ed25519.SECRET_KEY_SIZE];
        ...
        assertFalse(bmAddress.encodeAddress(4, 1, ripe).equals(address));
    }

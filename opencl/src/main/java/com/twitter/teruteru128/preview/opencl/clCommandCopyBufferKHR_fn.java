...
/**
 * {@snippet :
 * int (*clCommandCopyBufferKHR_fn)(struct _cl_command_buffer_khr* command_buffer,struct _cl_command_queue* command_queue,struct _cl_mem* src_buffer,struct _cl_mem* dst_buffer,unsigned long long src_offset,unsigned long long dst_offset,unsigned long long size,unsigned int num_sync_points_in_wait_list,unsigned int* sync_point_wait_list,unsigned int* sync_point,struct _cl_mutable_command_khr** mutable_handle);
 * }
 */
public interface clCommandCopyBufferKHR_fn {
    ...
    static MemorySegment allocate(clCommandCopyBufferKHR_fn fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$213.const$2, fi, constants$213.const$1, scope);
    }
    static clCommandCopyBufferKHR_fn ofAddress(MemorySegment addr, Arena arena) {

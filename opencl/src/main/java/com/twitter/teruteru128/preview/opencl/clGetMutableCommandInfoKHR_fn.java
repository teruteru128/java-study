...
/**
 * {@snippet :
 * int (*clGetMutableCommandInfoKHR_fn)(struct _cl_mutable_command_khr* command,unsigned int param_name,unsigned long long param_value_size,void* param_value,unsigned long long* param_value_size_ret);
 * }
 */
public interface clGetMutableCommandInfoKHR_fn {
    ...
    static MemorySegment allocate(clGetMutableCommandInfoKHR_fn fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$224.const$5, fi, constants$176.const$4, scope);
    }
    static clGetMutableCommandInfoKHR_fn ofAddress(MemorySegment addr, Arena arena) {

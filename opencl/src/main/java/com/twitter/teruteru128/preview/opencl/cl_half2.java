...
public class cl_half2 {
    ...
    private static final OfShort x$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$862:24"), groupElement("x"));
    ...
    private static final OfShort y$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$862:24"), groupElement("y"));
    ...
    private static final OfShort s0$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$863:24"), groupElement("s0"));
    ...
    private static final OfShort s1$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$863:24"), groupElement("s1"));
    ...
    private static final OfShort lo$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$864:24"), groupElement("lo"));
    ...
    private static final OfShort hi$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$864:24"), groupElement("hi"));

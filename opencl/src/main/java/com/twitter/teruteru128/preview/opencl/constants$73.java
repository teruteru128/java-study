...
final class constants$73 {
    ...
    static final VarHandle const$0 = constants$62.const$1.varHandle(MemoryLayout.PathElement.groupElement("$anon$1"), MemoryLayout.PathElement.groupElement("s1"));
    static final VarHandle const$1 = constants$62.const$1.varHandle(MemoryLayout.PathElement.groupElement("$anon$2"), MemoryLayout.PathElement.groupElement("lo"));
    static final VarHandle const$2 = constants$62.const$1.varHandle(MemoryLayout.PathElement.groupElement("$anon$2"), MemoryLayout.PathElement.groupElement("hi"));

...
public class cl_char8 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$595:23"),
        MemoryLayout.structLayout(
            cl_char4.layout().withName("lo"),
            cl_char4.layout().withName("hi")
        ).withName("$anon$596:23"),
    ...
    private static final OfByte x$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$594:23"), groupElement("x"));
    ...
    private static final OfByte y$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$594:23"), groupElement("y"));
    ...
    private static final OfByte z$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$594:23"), groupElement("z"));
    ...
    private static final OfByte w$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$594:23"), groupElement("w"));
    ...
    private static final OfByte s0$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$595:23"), groupElement("s0"));
    ...
    private static final OfByte s1$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$595:23"), groupElement("s1"));
    ...
    private static final OfByte s2$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$595:23"), groupElement("s2"));
    ...
    private static final OfByte s3$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$595:23"), groupElement("s3"));
    ...
    private static final OfByte s4$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$595:23"), groupElement("s4"));
    ...
    private static final OfByte s5$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$595:23"), groupElement("s5"));
    ...
    private static final OfByte s6$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$595:23"), groupElement("s6"));
    ...
    private static final OfByte s7$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$595:23"), groupElement("s7"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$596:23"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$596:23"), groupElement("hi"));

...
public class cl_char4 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$575:23"),
        MemoryLayout.structLayout(
            opencl_h.C_CHAR.withName("s0"),
            opencl_h.C_CHAR.withName("s1"),
            opencl_h.C_CHAR.withName("s2"),
            opencl_h.C_CHAR.withName("s3")
        ).withName("$anon$576:23"),
        MemoryLayout.structLayout(
            cl_char2.layout().withName("lo"),
            cl_char2.layout().withName("hi")
        ).withName("$anon$577:23")
    ).withName("$anon$571:9");
    ...
    private static final OfByte x$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$575:23"), groupElement("x"));
    ...
    private static final OfByte y$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$575:23"), groupElement("y"));
    ...
    private static final OfByte z$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$575:23"), groupElement("z"));
    ...
    private static final OfByte w$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$575:23"), groupElement("w"));
    ...
    private static final OfByte s0$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$576:23"), groupElement("s0"));
    ...
    private static final OfByte s1$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$576:23"), groupElement("s1"));
    ...
    private static final OfByte s2$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$576:23"), groupElement("s2"));
    ...
    private static final OfByte s3$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$576:23"), groupElement("s3"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$577:23"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$577:23"), groupElement("hi"));

...
public class cl_uint4 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$1024:23"),
        MemoryLayout.structLayout(
            opencl_h.C_INT.withName("s0"),
            opencl_h.C_INT.withName("s1"),
            opencl_h.C_INT.withName("s2"),
            opencl_h.C_INT.withName("s3")
        ).withName("$anon$1025:23"),
        MemoryLayout.structLayout(
            cl_uint2.layout().withName("lo"),
            cl_uint2.layout().withName("hi")
        ).withName("$anon$1026:23"),
    ...
    private static final OfInt x$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1024:23"), groupElement("x"));
    ...
    private static final OfInt y$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1024:23"), groupElement("y"));
    ...
    private static final OfInt z$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1024:23"), groupElement("z"));
    ...
    private static final OfInt w$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1024:23"), groupElement("w"));
    ...
    private static final OfInt s0$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1025:23"), groupElement("s0"));
    ...
    private static final OfInt s1$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1025:23"), groupElement("s1"));
    ...
    private static final OfInt s2$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1025:23"), groupElement("s2"));
    ...
    private static final OfInt s3$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1025:23"), groupElement("s3"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1026:23"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1026:23"), groupElement("hi"));

...
/**
 * {@snippet lang=c :
 * typedef cl_mem (*clCreateFromGLTexture_fn)(cl_context, cl_mem_flags, cl_GLenum, cl_GLint, cl_GLuint, cl_int *) __attribute__((stdcall))
 * }
 */
public class clCreateFromGLTexture_fn {
    ...
    private static final MethodHandle UP$MH = opencl_h.upcallHandle(clCreateFromGLTexture_fn.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(clCreateFromGLTexture_fn.Function fi, Arena arena) {

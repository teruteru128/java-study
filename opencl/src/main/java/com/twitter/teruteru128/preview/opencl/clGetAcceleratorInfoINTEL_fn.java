...
/**
 * {@snippet :
 * int (*clGetAcceleratorInfoINTEL_fn)(struct _cl_accelerator_intel* accelerator,unsigned int param_name,unsigned long long param_value_size,void* param_value,unsigned long long* param_value_size_ret);
 * }
 */
public interface clGetAcceleratorInfoINTEL_fn {
    ...
    static MemorySegment allocate(clGetAcceleratorInfoINTEL_fn fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$245.const$5, fi, constants$176.const$4, scope);
    }
    static clGetAcceleratorInfoINTEL_fn ofAddress(MemorySegment addr, Arena arena) {

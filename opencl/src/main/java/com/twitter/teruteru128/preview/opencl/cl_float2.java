...
public class cl_float2 {
    ...
    private static final OfFloat x$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1236:23"), groupElement("x"));
    ...
    private static final OfFloat y$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1236:23"), groupElement("y"));
    ...
    private static final OfFloat s0$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1237:23"), groupElement("s0"));
    ...
    private static final OfFloat s1$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1237:23"), groupElement("s1"));
    ...
    private static final OfFloat lo$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1238:23"), groupElement("lo"));
    ...
    private static final OfFloat hi$LAYOUT = (OfFloat)$LAYOUT.select(groupElement("$anon$1238:23"), groupElement("hi"));

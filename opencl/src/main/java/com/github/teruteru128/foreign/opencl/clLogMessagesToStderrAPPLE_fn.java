...
/**
 * {@snippet lang=c :
 * typedef void (*clLogMessagesToStderrAPPLE_fn)(const char *, const void *, size_t, void *) __attribute__((stdcall))
 * }
 */
public class clLogMessagesToStderrAPPLE_fn {
    ...
    private static final MethodHandle UP$MH = opencl_h.upcallHandle(clLogMessagesToStderrAPPLE_fn.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(clLogMessagesToStderrAPPLE_fn.Function fi, Arena arena) {

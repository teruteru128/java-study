...
public class cl_ulong4 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$1174:23"),
        MemoryLayout.structLayout(
            cl_ulong2.layout().withName("lo"),
            cl_ulong2.layout().withName("hi")
        ).withName("$anon$1175:23"),
        MemoryLayout.sequenceLayout(2, MemoryLayout.sequenceLayout(2, opencl_h.C_LONG_LONG)).withName("v2")
    ).withName("$anon$1169:9");
    ...
    private static final OfLong x$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1173:23"), groupElement("x"));
    ...
    private static final OfLong y$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1173:23"), groupElement("y"));
    ...
    private static final OfLong z$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1173:23"), groupElement("z"));
    ...
    private static final OfLong w$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1173:23"), groupElement("w"));
    ...
    private static final OfLong s0$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1174:23"), groupElement("s0"));
    ...
    private static final OfLong s1$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1174:23"), groupElement("s1"));
    ...
    private static final OfLong s2$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1174:23"), groupElement("s2"));
    ...
    private static final OfLong s3$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1174:23"), groupElement("s3"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1175:23"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1175:23"), groupElement("hi"));

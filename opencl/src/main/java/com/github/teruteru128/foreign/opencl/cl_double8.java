...
public class cl_double8 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$1344:23"),
        MemoryLayout.structLayout(
            cl_double4.layout().withName("lo"),
            cl_double4.layout().withName("hi")
        ).withName("$anon$1345:23"),
        MemoryLayout.sequenceLayout(4, MemoryLayout.sequenceLayout(2, opencl_h.C_DOUBLE)).withName("v2")
    ).withName("$anon$1339:9");
    ...
    private static final OfDouble x$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1343:23"), groupElement("x"));
    ...
    private static final OfDouble y$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1343:23"), groupElement("y"));
    ...
    private static final OfDouble z$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1343:23"), groupElement("z"));
    ...
    private static final OfDouble w$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1343:23"), groupElement("w"));
    ...
    private static final OfDouble s0$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1344:23"), groupElement("s0"));
    ...
    private static final OfDouble s1$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1344:23"), groupElement("s1"));
    ...
    private static final OfDouble s2$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1344:23"), groupElement("s2"));
    ...
    private static final OfDouble s3$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1344:23"), groupElement("s3"));
    ...
    private static final OfDouble s4$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1344:23"), groupElement("s4"));
    ...
    private static final OfDouble s5$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1344:23"), groupElement("s5"));
    ...
    private static final OfDouble s6$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1344:23"), groupElement("s6"));
    ...
    private static final OfDouble s7$LAYOUT = (OfDouble)$LAYOUT.select(groupElement("$anon$1344:23"), groupElement("s7"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1345:23"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$1345:23"), groupElement("hi"));

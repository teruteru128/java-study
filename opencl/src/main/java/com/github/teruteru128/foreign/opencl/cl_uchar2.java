...
public class cl_uchar2 {
    ...
    private static final OfByte x$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$637:23"), groupElement("x"));
    ...
    private static final OfByte y$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$637:23"), groupElement("y"));
    ...
    private static final OfByte s0$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$638:23"), groupElement("s0"));
    ...
    private static final OfByte s1$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$638:23"), groupElement("s1"));
    ...
    private static final OfByte lo$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$639:23"), groupElement("lo"));
    ...
    private static final OfByte hi$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$639:23"), groupElement("hi"));

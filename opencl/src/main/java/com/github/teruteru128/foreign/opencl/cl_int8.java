...
public class cl_int8 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$969:23"),
        MemoryLayout.structLayout(
            cl_int4.layout().withName("lo"),
            cl_int4.layout().withName("hi")
        ).withName("$anon$970:23"),
    ...
    private static final OfInt x$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$968:23"), groupElement("x"));
    ...
    private static final OfInt y$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$968:23"), groupElement("y"));
    ...
    private static final OfInt z$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$968:23"), groupElement("z"));
    ...
    private static final OfInt w$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$968:23"), groupElement("w"));
    ...
    private static final OfInt s0$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$969:23"), groupElement("s0"));
    ...
    private static final OfInt s1$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$969:23"), groupElement("s1"));
    ...
    private static final OfInt s2$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$969:23"), groupElement("s2"));
    ...
    private static final OfInt s3$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$969:23"), groupElement("s3"));
    ...
    private static final OfInt s4$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$969:23"), groupElement("s4"));
    ...
    private static final OfInt s5$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$969:23"), groupElement("s5"));
    ...
    private static final OfInt s6$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$969:23"), groupElement("s6"));
    ...
    private static final OfInt s7$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$969:23"), groupElement("s7"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$970:23"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$970:23"), groupElement("hi"));

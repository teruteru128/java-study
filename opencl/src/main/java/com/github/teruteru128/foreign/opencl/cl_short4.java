...
public class cl_short4 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$725:23"),
        MemoryLayout.structLayout(
            opencl_h.C_SHORT.withName("s0"),
            opencl_h.C_SHORT.withName("s1"),
            opencl_h.C_SHORT.withName("s2"),
            opencl_h.C_SHORT.withName("s3")
        ).withName("$anon$726:23"),
        MemoryLayout.structLayout(
            cl_short2.layout().withName("lo"),
            cl_short2.layout().withName("hi")
        ).withName("$anon$727:23"),
    ...
    private static final OfShort x$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$725:23"), groupElement("x"));
    ...
    private static final OfShort y$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$725:23"), groupElement("y"));
    ...
    private static final OfShort z$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$725:23"), groupElement("z"));
    ...
    private static final OfShort w$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$725:23"), groupElement("w"));
    ...
    private static final OfShort s0$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$726:23"), groupElement("s0"));
    ...
    private static final OfShort s1$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$726:23"), groupElement("s1"));
    ...
    private static final OfShort s2$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$726:23"), groupElement("s2"));
    ...
    private static final OfShort s3$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$726:23"), groupElement("s3"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$727:23"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$727:23"), groupElement("hi"));

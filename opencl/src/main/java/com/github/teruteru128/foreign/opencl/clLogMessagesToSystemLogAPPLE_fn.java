...
/**
 * {@snippet lang=c :
 * typedef void (*clLogMessagesToSystemLogAPPLE_fn)(const char *, const void *, size_t, void *) __attribute__((stdcall))
 * }
 */
public class clLogMessagesToSystemLogAPPLE_fn {
    ...
    private static final MethodHandle UP$MH = opencl_h.upcallHandle(clLogMessagesToSystemLogAPPLE_fn.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(clLogMessagesToSystemLogAPPLE_fn.Function fi, Arena arena) {

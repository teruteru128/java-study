...
public class cl_ulong2 {
    ...
    private static final OfLong x$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1160:23"), groupElement("x"));
    ...
    private static final OfLong y$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1160:23"), groupElement("y"));
    ...
    private static final OfLong s0$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1161:23"), groupElement("s0"));
    ...
    private static final OfLong s1$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1161:23"), groupElement("s1"));
    ...
    private static final OfLong lo$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1162:23"), groupElement("lo"));
    ...
    private static final OfLong hi$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$1162:23"), groupElement("hi"));

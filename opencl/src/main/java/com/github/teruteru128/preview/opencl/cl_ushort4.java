...
public class cl_ushort4 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$800:23"),
        MemoryLayout.structLayout(
            opencl_h.C_SHORT.withName("s0"),
            opencl_h.C_SHORT.withName("s1"),
            opencl_h.C_SHORT.withName("s2"),
            opencl_h.C_SHORT.withName("s3")
        ).withName("$anon$801:23"),
        MemoryLayout.structLayout(
            cl_ushort2.layout().withName("lo"),
            cl_ushort2.layout().withName("hi")
        ).withName("$anon$802:23"),
        MemoryLayout.sequenceLayout(1, opencl_h.C_LONG_LONG).withName("v4")
    ).withName("$anon$796:9");
    ...
    private static final OfShort x$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$800:23"), groupElement("x"));
    ...
    private static final OfShort y$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$800:23"), groupElement("y"));
    ...
    private static final OfShort z$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$800:23"), groupElement("z"));
    ...
    private static final OfShort w$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$800:23"), groupElement("w"));
    ...
    private static final OfShort s0$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$801:23"), groupElement("s0"));
    ...
    private static final OfShort s1$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$801:23"), groupElement("s1"));
    ...
    private static final OfShort s2$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$801:23"), groupElement("s2"));
    ...
    private static final OfShort s3$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$801:23"), groupElement("s3"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$802:23"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$802:23"), groupElement("hi"));

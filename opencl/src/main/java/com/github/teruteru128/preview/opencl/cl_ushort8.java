...
public class cl_ushort8 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        ).withName("$anon$820:23"),
        MemoryLayout.structLayout(
            cl_ushort4.layout().withName("lo"),
            cl_ushort4.layout().withName("hi")
        ).withName("$anon$821:23"),
    ...
    private static final OfShort x$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$819:23"), groupElement("x"));
    ...
    private static final OfShort y$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$819:23"), groupElement("y"));
    ...
    private static final OfShort z$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$819:23"), groupElement("z"));
    ...
    private static final OfShort w$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$819:23"), groupElement("w"));
    ...
    private static final OfShort s0$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$820:23"), groupElement("s0"));
    ...
    private static final OfShort s1$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$820:23"), groupElement("s1"));
    ...
    private static final OfShort s2$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$820:23"), groupElement("s2"));
    ...
    private static final OfShort s3$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$820:23"), groupElement("s3"));
    ...
    private static final OfShort s4$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$820:23"), groupElement("s4"));
    ...
    private static final OfShort s5$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$820:23"), groupElement("s5"));
    ...
    private static final OfShort s6$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$820:23"), groupElement("s6"));
    ...
    private static final OfShort s7$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$820:23"), groupElement("s7"));
    ...
    private static final GroupLayout lo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$821:23"), groupElement("lo"));
    ...
    private static final GroupLayout hi$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$821:23"), groupElement("hi"));

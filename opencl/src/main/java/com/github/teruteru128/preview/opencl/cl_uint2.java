...
public class cl_uint2 {
    ...
    private static final OfInt x$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1011:23"), groupElement("x"));
    ...
    private static final OfInt y$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1011:23"), groupElement("y"));
    ...
    private static final OfInt s0$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1012:23"), groupElement("s0"));
    ...
    private static final OfInt s1$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1012:23"), groupElement("s1"));
    ...
    private static final OfInt lo$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1013:23"), groupElement("lo"));
    ...
    private static final OfInt hi$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1013:23"), groupElement("hi"));

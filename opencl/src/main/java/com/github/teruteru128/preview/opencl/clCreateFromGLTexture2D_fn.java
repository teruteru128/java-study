...
/**
 * {@snippet lang=c :
 * typedef cl_mem (*clCreateFromGLTexture2D_fn)(cl_context, cl_mem_flags, cl_GLenum, cl_GLint, cl_GLuint, cl_int *) __attribute__((stdcall))
 * }
 */
public class clCreateFromGLTexture2D_fn {
    ...
    private static final MethodHandle UP$MH = opencl_h.upcallHandle(clCreateFromGLTexture2D_fn.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(clCreateFromGLTexture2D_fn.Function fi, Arena arena) {

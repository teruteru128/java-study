...
public class Factory {
  ...
  static void create(String[] args)
      throws IOException, InterruptedException, NoSuchAlgorithmException, DigestException,
      SQLException, URISyntaxException, AWTException, InvalidParameterSpecException,
    ...
    switch (args[0]) {
      ...
      case "yattaze" -> {
        ...
        List<String> list;
        try (var f = new BufferedReader(new InputStreamReader(
            Objects.requireNonNull(ClassLoader.getSystemResourceAsStream(args[1])),
  ...
  private static void extracted(String path, String patternArg) throws IOException {
    ...
    Files.walkFileTree(p, EnumSet.noneOf(FileVisitOption.class), MAX_VALUE,
  ...
  private static void extracted()
    ...
    var p = factory.generatePrivate(new ECPrivateKeySpec(new BigInteger(1,
    ...
    var signObject = new SignedObject(
        (Function<String, String> & Serializable) i -> i.repeat(3) + "って？", p, sign);
    ...
    var y = new BigInteger(1,
        hexFormat.parseHex("A8E145E1A671C4C4D40EDA5CF858273798E5746EB277A568C1B710ABB440E46F"));

...
public class __gmp_randstate_struct {
    ...
    private static final long _mp_seed$OFFSET = $LAYOUT.byteOffset(groupElement("_mp_seed"));
    ...
    private static final long _mp_alg$OFFSET = $LAYOUT.byteOffset(groupElement("_mp_alg"));
    ...
    public static class _mp_algdata {
        ...
        private static final long _mp_lc$OFFSET = $LAYOUT.byteOffset(groupElement("_mp_lc"));
    ...
    private static final long _mp_algdata$OFFSET = $LAYOUT.byteOffset(groupElement("_mp_algdata"));

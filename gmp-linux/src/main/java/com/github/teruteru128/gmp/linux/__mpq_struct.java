...
public class __mpq_struct {
    ...
    private static final long _mp_num$OFFSET = $LAYOUT.byteOffset(groupElement("_mp_num"));
    ...
    private static final long _mp_den$OFFSET = $LAYOUT.byteOffset(groupElement("_mp_den"));

...
public class _CMSG_SP3_COMPATIBLE_AUX_INFO {
    ...
    public static int cbSize$get(MemorySegment seg) {
        return (int)constants$2090.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int cbSize$get(MemorySegment seg, long index) {
        return (int)constants$2090.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int dwFlags$get(MemorySegment seg) {
        return (int)constants$2090.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwFlags$get(MemorySegment seg, long index) {
        return (int)constants$2090.const$1.get(seg.asSlice(index*sizeof()));
    }

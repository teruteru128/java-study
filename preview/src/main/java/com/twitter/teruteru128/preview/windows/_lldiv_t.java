...
public class _lldiv_t {
    ...
    public static long quot$get(MemorySegment seg) {
        return (long)constants$2975.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void quot$set(MemorySegment seg, long x) {
        constants$2975.const$0.set(seg, x);
    }
    public static long quot$get(MemorySegment seg, long index) {
        return (long)constants$2975.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void quot$set(MemorySegment seg, long index, long x) {
        constants$2975.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static long rem$get(MemorySegment seg) {
        return (long)constants$2975.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long rem$get(MemorySegment seg, long index) {
        return (long)constants$2975.const$1.get(seg.asSlice(index*sizeof()));
    }

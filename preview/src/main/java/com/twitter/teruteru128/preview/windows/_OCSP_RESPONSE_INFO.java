...
public class _OCSP_RESPONSE_INFO {
    ...
    public static int dwStatus$get(MemorySegment seg) {
        return (int)constants$2068.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwStatus$set(MemorySegment seg, int x) {
        constants$2068.const$1.set(seg, x);
    }
    public static int dwStatus$get(MemorySegment seg, long index) {
        return (int)constants$2068.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void dwStatus$set(MemorySegment seg, long index, int x) {
        constants$2068.const$1.set(seg.asSlice(index*sizeof()), x);
    }

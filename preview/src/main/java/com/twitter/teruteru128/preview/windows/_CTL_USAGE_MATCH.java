...
public class _CTL_USAGE_MATCH {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2214.const$0;
    }
    public static VarHandle dwType$VH() {
        return constants$2214.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwType$get(MemorySegment seg) {
        return (int)constants$2214.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwType$set(MemorySegment seg, int x) {
        constants$2214.const$1.set(seg, x);
    }
    public static int dwType$get(MemorySegment seg, long index) {
        return (int)constants$2214.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void dwType$set(MemorySegment seg, long index, int x) {
        constants$2214.const$1.set(seg.asSlice(index*sizeof()), x);
    }

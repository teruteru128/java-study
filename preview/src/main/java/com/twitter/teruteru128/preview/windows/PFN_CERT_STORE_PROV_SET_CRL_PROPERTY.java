...
/**
 * {@snippet :
 * int (*PFN_CERT_STORE_PROV_SET_CRL_PROPERTY)(void* hStoreProv,struct _CRL_CONTEXT* pCrlContext,unsigned long dwPropId,unsigned long dwFlags,void* pvData);
 * }
 */
public interface PFN_CERT_STORE_PROV_SET_CRL_PROPERTY {
    ...
    static MemorySegment allocate(PFN_CERT_STORE_PROV_SET_CRL_PROPERTY fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$2130.const$5, fi, constants$1278.const$1, scope);
    }
    static PFN_CERT_STORE_PROV_SET_CRL_PROPERTY ofAddress(MemorySegment addr, Arena arena) {

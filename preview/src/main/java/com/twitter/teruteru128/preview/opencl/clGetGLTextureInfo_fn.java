...
/**
 * {@snippet :
 * int (*clGetGLTextureInfo_fn)(struct _cl_mem* memobj,unsigned int param_name,unsigned long long param_value_size,void* param_value,unsigned long long* param_value_size_ret);
 * }
 */
public interface clGetGLTextureInfo_fn {
    ...
    static MemorySegment allocate(clGetGLTextureInfo_fn fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$207.const$4, fi, constants$176.const$4, scope);
    }
    static clGetGLTextureInfo_fn ofAddress(MemorySegment addr, Arena arena) {

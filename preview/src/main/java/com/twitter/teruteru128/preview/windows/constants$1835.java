...
final class constants$1835 {
    ...
    static final VarHandle const$0 = constants$1834.const$0.varHandle(MemoryLayout.PathElement.groupElement("ClientPrincipalName"));
    static final VarHandle const$1 = constants$1834.const$0.varHandle(MemoryLayout.PathElement.groupElement("AuthenticationLevel"));
    static final VarHandle const$2 = constants$1834.const$0.varHandle(MemoryLayout.PathElement.groupElement("AuthenticationService"));
    static final VarHandle const$3 = constants$1834.const$0.varHandle(MemoryLayout.PathElement.groupElement("NullSession"));
    ...
    static final VarHandle const$5 = constants$1835.const$4.varHandle(MemoryLayout.PathElement.groupElement("Version"));
}

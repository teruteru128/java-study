...
public class tagCALPSTR {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$3592.const$3;
    }
    public static VarHandle cElems$VH() {
        return constants$3592.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cElems$get(MemorySegment seg) {
        return (int)constants$3592.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cElems$set(MemorySegment seg, int x) {
        constants$3592.const$4.set(seg, x);
    }
    public static int cElems$get(MemorySegment seg, long index) {
        return (int)constants$3592.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void cElems$set(MemorySegment seg, long index, int x) {
        constants$3592.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pElems$VH() {
        return constants$3592.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pElems$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3592.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pElems$set(MemorySegment seg, MemorySegment x) {
        constants$3592.const$5.set(seg, x);
    }
    public static MemorySegment pElems$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3592.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void pElems$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3592.const$5.set(seg.asSlice(index*sizeof()), x);
    }

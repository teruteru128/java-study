...
public class _PRINTER_INFO_8A {
    ...
    public static MemorySegment pDevMode$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2834.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pDevMode$set(MemorySegment seg, MemorySegment x) {
        constants$2834.const$5.set(seg, x);
    }
    public static MemorySegment pDevMode$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2834.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void pDevMode$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2834.const$5.set(seg.asSlice(index*sizeof()), x);
    }

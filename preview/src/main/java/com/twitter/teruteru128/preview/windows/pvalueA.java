...
public class pvalueA {
    ...
    public static MemorySegment pv_valuename$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1481.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pv_valuename$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1481.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int pv_valuelen$get(MemorySegment seg) {
        return (int)constants$1481.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pv_valuelen$set(MemorySegment seg, int x) {
        constants$1481.const$1.set(seg, x);
    }
    public static int pv_valuelen$get(MemorySegment seg, long index) {
        return (int)constants$1481.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void pv_valuelen$set(MemorySegment seg, long index, int x) {
        constants$1481.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pv_value_context$VH() {
        return constants$1481.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pv_value_context$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1481.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pv_value_context$set(MemorySegment seg, MemorySegment x) {
        constants$1481.const$2.set(seg, x);
    }
    public static MemorySegment pv_value_context$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1481.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void pv_value_context$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1481.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pv_type$VH() {
        return constants$1481.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int pv_type$get(MemorySegment seg) {
        return (int)constants$1481.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pv_type$set(MemorySegment seg, int x) {
        constants$1481.const$3.set(seg, x);
    }
    public static int pv_type$get(MemorySegment seg, long index) {
        return (int)constants$1481.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void pv_type$set(MemorySegment seg, long index, int x) {
        constants$1481.const$3.set(seg.asSlice(index*sizeof()), x);
    }

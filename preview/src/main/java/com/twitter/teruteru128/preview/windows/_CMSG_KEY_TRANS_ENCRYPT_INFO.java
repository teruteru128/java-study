...
public class _CMSG_KEY_TRANS_ENCRYPT_INFO {
    ...
    public static int cbSize$get(MemorySegment seg) {
        return (int)constants$2111.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwRecipientIndex$get(MemorySegment seg) {
        return (int)constants$2111.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwRecipientIndex$set(MemorySegment seg, int x) {
        constants$2111.const$5.set(seg, x);
    }
    public static int dwRecipientIndex$get(MemorySegment seg, long index) {
        return (int)constants$2111.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void dwRecipientIndex$set(MemorySegment seg, long index, int x) {
        constants$2111.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int dwFlags$get(MemorySegment seg) {
        return (int)constants$2112.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwFlags$get(MemorySegment seg, long index) {
        return (int)constants$2112.const$0.get(seg.asSlice(index*sizeof()));
    }

...
public class _STORAGE_DEVICE_TIERING_DESCRIPTOR {
    ...
    public static int Version$get(MemorySegment seg) {
        return (int)constants$2409.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int Version$get(MemorySegment seg, long index) {
        return (int)constants$2409.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void Version$set(MemorySegment seg, long index, int x) {
        constants$2409.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle Size$VH() {
        return constants$2409.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int Size$get(MemorySegment seg) {
        return (int)constants$2409.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Size$set(MemorySegment seg, int x) {
        constants$2409.const$2.set(seg, x);
    }
    public static int Size$get(MemorySegment seg, long index) {
        return (int)constants$2409.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void Size$set(MemorySegment seg, long index, int x) {
        constants$2409.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int Flags$get(MemorySegment seg) {
        return (int)constants$2409.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int TotalNumberOfTiers$get(MemorySegment seg) {
        return (int)constants$2409.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void TotalNumberOfTiers$set(MemorySegment seg, int x) {
        constants$2409.const$4.set(seg, x);
    }
    public static int TotalNumberOfTiers$get(MemorySegment seg, long index) {
        return (int)constants$2409.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void TotalNumberOfTiers$set(MemorySegment seg, long index, int x) {
        constants$2409.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int NumberOfTiersReturned$get(MemorySegment seg) {
        return (int)constants$2409.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int NumberOfTiersReturned$get(MemorySegment seg, long index) {
        return (int)constants$2409.const$5.get(seg.asSlice(index*sizeof()));
    }

...
public class tagRECT {
    ...
    public static int left$get(MemorySegment seg) {
        return (int)constants$546.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int left$get(MemorySegment seg, long index) {
        return (int)constants$546.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int top$get(MemorySegment seg) {
        return (int)constants$546.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int top$get(MemorySegment seg, long index) {
        return (int)constants$546.const$5.get(seg.asSlice(index*sizeof()));
    }

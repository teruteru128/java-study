...
public class _ENUM_SERVICE_STATUSW {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$4491.const$2;
    }
    public static VarHandle lpServiceName$VH() {
        return constants$4491.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpServiceName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$4491.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpServiceName$set(MemorySegment seg, MemorySegment x) {
        constants$4491.const$3.set(seg, x);
    }
    public static MemorySegment lpServiceName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$4491.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void lpServiceName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$4491.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle lpDisplayName$VH() {
        return constants$4491.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpDisplayName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$4491.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpDisplayName$set(MemorySegment seg, MemorySegment x) {
        constants$4491.const$4.set(seg, x);
    }
    public static MemorySegment lpDisplayName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$4491.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void lpDisplayName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$4491.const$4.set(seg.asSlice(index*sizeof()), x);
    }

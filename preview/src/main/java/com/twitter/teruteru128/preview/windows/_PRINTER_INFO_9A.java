...
public class _PRINTER_INFO_9A {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2835.const$2;
    }
    public static VarHandle pDevMode$VH() {
        return constants$2835.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pDevMode$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2835.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pDevMode$set(MemorySegment seg, MemorySegment x) {
        constants$2835.const$3.set(seg, x);
    }
    public static MemorySegment pDevMode$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2835.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void pDevMode$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2835.const$3.set(seg.asSlice(index*sizeof()), x);
    }

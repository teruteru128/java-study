...
public class _FSCTL_OFFLOAD_READ_INPUT {
    ...
    public static int Size$get(MemorySegment seg) {
        return (int)constants$2700.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Size$set(MemorySegment seg, int x) {
        constants$2700.const$5.set(seg, x);
    }
    public static int Size$get(MemorySegment seg, long index) {
        return (int)constants$2700.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void Size$set(MemorySegment seg, long index, int x) {
        constants$2700.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int Flags$get(MemorySegment seg) {
        return (int)constants$2701.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int Flags$get(MemorySegment seg, long index) {
        return (int)constants$2701.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int TokenTimeToLive$get(MemorySegment seg) {
        return (int)constants$2701.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void TokenTimeToLive$set(MemorySegment seg, int x) {
        constants$2701.const$1.set(seg, x);
    }
    public static int TokenTimeToLive$get(MemorySegment seg, long index) {
        return (int)constants$2701.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void TokenTimeToLive$set(MemorySegment seg, long index, int x) {
        constants$2701.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int Reserved$get(MemorySegment seg) {
        return (int)constants$2701.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long FileOffset$get(MemorySegment seg) {
        return (long)constants$2701.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void FileOffset$set(MemorySegment seg, long x) {
        constants$2701.const$3.set(seg, x);
    }
    public static long FileOffset$get(MemorySegment seg, long index) {
        return (long)constants$2701.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void FileOffset$set(MemorySegment seg, long index, long x) {
        constants$2701.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static long CopyLength$get(MemorySegment seg) {
        return (long)constants$2701.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long CopyLength$get(MemorySegment seg, long index) {
        return (long)constants$2701.const$4.get(seg.asSlice(index*sizeof()));
    }

...
public class tagEMRSETCOLORSPACE {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1111.const$4;
    }
    public static MemorySegment emr$slice(MemorySegment seg) {
        return seg.asSlice(0, 8);
    }
    public static VarHandle ihCS$VH() {
        return constants$1111.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int ihCS$get(MemorySegment seg) {
        return (int)constants$1111.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void ihCS$set(MemorySegment seg, int x) {
        constants$1111.const$5.set(seg, x);
    }
    public static int ihCS$get(MemorySegment seg, long index) {
        return (int)constants$1111.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void ihCS$set(MemorySegment seg, long index, int x) {
        constants$1111.const$5.set(seg.asSlice(index*sizeof()), x);
    }

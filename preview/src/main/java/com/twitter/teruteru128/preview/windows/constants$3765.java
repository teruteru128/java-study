...
final class constants$3765 {

    // Suppresses default constructor, ensuring non-instantiability.
    private constants$3765() {}
    static final MemorySegment const$0 = RuntimeHelper.lookupGlobalVariable("IID_IXMLDOMDocumentFragment", constants$27.const$0);
    ...
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(IXMLDOMDocumentFragmentVtbl.QueryInterface.class, "apply", constants$37.const$3);
    static final VarHandle const$3 = constants$3765.const$1.varHandle(MemoryLayout.PathElement.groupElement("QueryInterface"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(IXMLDOMDocumentFragmentVtbl.AddRef.class, "apply", constants$18.const$5);
    static final VarHandle const$5 = constants$3765.const$1.varHandle(MemoryLayout.PathElement.groupElement("AddRef"));
}

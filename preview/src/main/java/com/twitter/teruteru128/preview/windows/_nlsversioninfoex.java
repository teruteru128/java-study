...
public class _nlsversioninfoex {
    ...
    public static int dwNLSVersionInfoSize$get(MemorySegment seg) {
        return (int)constants$1417.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :

...
public class _userHBITMAP {
    ...
    public static int fContext$get(MemorySegment seg) {
        return (int)constants$2358.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int fContext$get(MemorySegment seg, long index) {
        return (int)constants$2358.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static final class __MIDL_IWinTypes_0007 {
        ...
        public static int hInproc$get(MemorySegment seg) {
            return (int)constants$2358.const$2.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static int hInproc$get(MemorySegment seg, long index) {
            return (int)constants$2358.const$2.get(seg.asSlice(index*sizeof()));
        }
        ...
        public static MemorySegment hRemote$get(MemorySegment seg) {
            return (java.lang.foreign.MemorySegment)constants$2358.const$3.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static void hRemote$set(MemorySegment seg, MemorySegment x) {
            constants$2358.const$3.set(seg, x);
        }
        public static MemorySegment hRemote$get(MemorySegment seg, long index) {
            return (java.lang.foreign.MemorySegment)constants$2358.const$3.get(seg.asSlice(index*sizeof()));
        }
        public static void hRemote$set(MemorySegment seg, long index, MemorySegment x) {
            constants$2358.const$3.set(seg.asSlice(index*sizeof()), x);
        }
        public static VarHandle hInproc64$VH() {
            return constants$2358.const$4;
        }
        /**
         * Getter for field:
         * {@snippet :
        ...
        public static long hInproc64$get(MemorySegment seg) {
            return (long)constants$2358.const$4.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static void hInproc64$set(MemorySegment seg, long x) {
            constants$2358.const$4.set(seg, x);
        }
        public static long hInproc64$get(MemorySegment seg, long index) {
            return (long)constants$2358.const$4.get(seg.asSlice(index*sizeof()));
        }
        public static void hInproc64$set(MemorySegment seg, long index, long x) {
            constants$2358.const$4.set(seg.asSlice(index*sizeof()), x);
        }

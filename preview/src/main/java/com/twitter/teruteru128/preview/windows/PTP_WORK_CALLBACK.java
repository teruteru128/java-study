...
/**
 * {@snippet :
 * void (*PTP_WORK_CALLBACK)(struct _TP_CALLBACK_INSTANCE* Instance,void* Context,struct _TP_WORK* Work);
 * }
 */
public interface PTP_WORK_CALLBACK {
    ...
    static MemorySegment allocate(PTP_WORK_CALLBACK fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$534.const$4, fi, constants$508.const$5, scope);
    }
    static PTP_WORK_CALLBACK ofAddress(MemorySegment addr, Arena arena) {

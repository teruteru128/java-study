...
public interface PFN_CMSG_IMPORT_KEY_AGREE {
    ...
    static MemorySegment allocate(PFN_CMSG_IMPORT_KEY_AGREE fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$2115.const$1, fi, constants$588.const$3, scope);
    }
    static PFN_CMSG_IMPORT_KEY_AGREE ofAddress(MemorySegment addr, Arena arena) {

...
public class _BYTE_BLOB {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2341.const$5;
    }
    public static VarHandle clSize$VH() {
        return constants$2342.const$0;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int clSize$get(MemorySegment seg) {
        return (int)constants$2342.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void clSize$set(MemorySegment seg, int x) {
        constants$2342.const$0.set(seg, x);
    }
    public static int clSize$get(MemorySegment seg, long index) {
        return (int)constants$2342.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void clSize$set(MemorySegment seg, long index, int x) {
        constants$2342.const$0.set(seg.asSlice(index*sizeof()), x);
    }

...
public class tagCALPWSTR {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$3593.const$0;
    }
    public static VarHandle cElems$VH() {
        return constants$3593.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cElems$get(MemorySegment seg) {
        return (int)constants$3593.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cElems$set(MemorySegment seg, int x) {
        constants$3593.const$1.set(seg, x);
    }
    public static int cElems$get(MemorySegment seg, long index) {
        return (int)constants$3593.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void cElems$set(MemorySegment seg, long index, int x) {
        constants$3593.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pElems$VH() {
        return constants$3593.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pElems$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3593.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pElems$set(MemorySegment seg, MemorySegment x) {
        constants$3593.const$2.set(seg, x);
    }
    public static MemorySegment pElems$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3593.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void pElems$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3593.const$2.set(seg.asSlice(index*sizeof()), x);
    }

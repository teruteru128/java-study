...
final class constants$913 {
    ...
    static final VarHandle const$0 = constants$910.const$4.varHandle(MemoryLayout.PathElement.groupElement("bOpenGL"));
    ...
    static final VarHandle const$2 = constants$913.const$1.varHandle(MemoryLayout.PathElement.groupElement("tmHeight"));
    static final VarHandle const$3 = constants$913.const$1.varHandle(MemoryLayout.PathElement.groupElement("tmAscent"));
    static final VarHandle const$4 = constants$913.const$1.varHandle(MemoryLayout.PathElement.groupElement("tmDescent"));
    static final VarHandle const$5 = constants$913.const$1.varHandle(MemoryLayout.PathElement.groupElement("tmInternalLeading"));
}

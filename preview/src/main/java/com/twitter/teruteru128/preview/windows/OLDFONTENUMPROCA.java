...
/**
 * {@snippet :
 * int (*OLDFONTENUMPROCA)(struct tagLOGFONTA*,struct tagTEXTMETRICA*,unsigned long,long long);
 * }
 */
public interface OLDFONTENUMPROCA {
    ...
    static MemorySegment allocate(OLDFONTENUMPROCA fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$993.const$3, fi, constants$993.const$2, scope);
    }
    static OLDFONTENUMPROCA ofAddress(MemorySegment addr, Arena arena) {

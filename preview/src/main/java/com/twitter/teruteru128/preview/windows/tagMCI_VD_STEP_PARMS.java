...
public class tagMCI_VD_STEP_PARMS {
    ...
    public static long dwCallback$get(MemorySegment seg) {
        return (long)constants$1570.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwCallback$set(MemorySegment seg, long x) {
        constants$1570.const$0.set(seg, x);
    }
    public static long dwCallback$get(MemorySegment seg, long index) {
        return (long)constants$1570.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void dwCallback$set(MemorySegment seg, long index, long x) {
        constants$1570.const$0.set(seg.asSlice(index*sizeof()), x);
    }

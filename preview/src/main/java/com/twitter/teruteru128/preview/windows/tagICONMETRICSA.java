...
public class tagICONMETRICSA {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1343.const$1;
    }
    public static VarHandle cbSize$VH() {
        return constants$1343.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cbSize$get(MemorySegment seg) {
        return (int)constants$1343.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cbSize$set(MemorySegment seg, int x) {
        constants$1343.const$2.set(seg, x);
    }
    public static int cbSize$get(MemorySegment seg, long index) {
        return (int)constants$1343.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void cbSize$set(MemorySegment seg, long index, int x) {
        constants$1343.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle iHorzSpacing$VH() {
        return constants$1343.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int iHorzSpacing$get(MemorySegment seg) {
        return (int)constants$1343.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void iHorzSpacing$set(MemorySegment seg, int x) {
        constants$1343.const$3.set(seg, x);
    }
    public static int iHorzSpacing$get(MemorySegment seg, long index) {
        return (int)constants$1343.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void iHorzSpacing$set(MemorySegment seg, long index, int x) {
        constants$1343.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle iVertSpacing$VH() {
        return constants$1343.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int iVertSpacing$get(MemorySegment seg) {
        return (int)constants$1343.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void iVertSpacing$set(MemorySegment seg, int x) {
        constants$1343.const$4.set(seg, x);
    }
    public static int iVertSpacing$get(MemorySegment seg, long index) {
        return (int)constants$1343.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void iVertSpacing$set(MemorySegment seg, long index, int x) {
        constants$1343.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle iTitleWrap$VH() {
        return constants$1343.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int iTitleWrap$get(MemorySegment seg) {
        return (int)constants$1343.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void iTitleWrap$set(MemorySegment seg, int x) {
        constants$1343.const$5.set(seg, x);
    }
    public static int iTitleWrap$get(MemorySegment seg, long index) {
        return (int)constants$1343.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void iTitleWrap$set(MemorySegment seg, long index, int x) {
        constants$1343.const$5.set(seg.asSlice(index*sizeof()), x);
    }

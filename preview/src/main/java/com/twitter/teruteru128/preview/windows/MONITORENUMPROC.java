...
/**
 * {@snippet :
 * int (*MONITORENUMPROC)(struct HMONITOR__*,struct HDC__*,struct tagRECT*,long long);
 * }
 */
public interface MONITORENUMPROC {
    ...
    static MemorySegment allocate(MONITORENUMPROC fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1368.const$1, fi, constants$707.const$4, scope);
    }
    static MONITORENUMPROC ofAddress(MemorySegment addr, Arena arena) {

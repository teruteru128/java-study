...
public interface LPFIBER_START_ROUTINE {
    ...
    static MemorySegment allocate(LPFIBER_START_ROUTINE fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$743.const$0, fi, constants$0.const$0, scope);
    }
    static LPFIBER_START_ROUTINE ofAddress(MemorySegment addr, Arena arena) {

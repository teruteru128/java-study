...
final class constants$3939 {

    // Suppresses default constructor, ensuring non-instantiability.
    private constants$3939() {}
    static final MemorySegment const$0 = RuntimeHelper.lookupGlobalVariable("IID_IXMLDOMDocumentType", constants$27.const$0);
    static final StructLayout const$1 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("get_entities"),
        RuntimeHelper.POINTER.withName("get_notations")
    ).withName("IXMLDOMDocumentTypeVtbl");
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(IXMLDOMDocumentTypeVtbl.QueryInterface.class, "apply", constants$37.const$3);
    static final VarHandle const$3 = constants$3939.const$1.varHandle(MemoryLayout.PathElement.groupElement("QueryInterface"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(IXMLDOMDocumentTypeVtbl.AddRef.class, "apply", constants$18.const$5);
    static final VarHandle const$5 = constants$3939.const$1.varHandle(MemoryLayout.PathElement.groupElement("AddRef"));
}

...
final class constants$2822 {

    // Suppresses default constructor, ensuring non-instantiability.
    private constants$2822() {}
    static final VarHandle const$0 = constants$2821.const$3.varHandle(MemoryLayout.PathElement.groupElement("pName"));
    static final VarHandle const$1 = constants$2821.const$3.varHandle(MemoryLayout.PathElement.groupElement("pComment"));
    ...
    static final VarHandle const$3 = constants$2822.const$2.varHandle(MemoryLayout.PathElement.groupElement("pServerName"));
    static final VarHandle const$4 = constants$2822.const$2.varHandle(MemoryLayout.PathElement.groupElement("pPrinterName"));
    static final VarHandle const$5 = constants$2822.const$2.varHandle(MemoryLayout.PathElement.groupElement("pShareName"));
}

...
public class _PRINTER_INFO_5W {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2832.const$2;
    }
    public static VarHandle pPrinterName$VH() {
        return constants$2832.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pPrinterName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2832.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pPrinterName$set(MemorySegment seg, MemorySegment x) {
        constants$2832.const$3.set(seg, x);
    }
    public static MemorySegment pPrinterName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2832.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void pPrinterName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2832.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pPortName$VH() {
        return constants$2832.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pPortName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2832.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pPortName$set(MemorySegment seg, MemorySegment x) {
        constants$2832.const$4.set(seg, x);
    }
    public static MemorySegment pPortName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2832.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void pPortName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2832.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle Attributes$VH() {
        return constants$2832.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int Attributes$get(MemorySegment seg) {
        return (int)constants$2832.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int DeviceNotSelectedTimeout$get(MemorySegment seg) {
        return (int)constants$2833.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int TransmissionRetryTimeout$get(MemorySegment seg) {
        return (int)constants$2833.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :

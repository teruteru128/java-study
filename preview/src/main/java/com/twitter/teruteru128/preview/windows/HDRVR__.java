 ...
 * }
 */
public class HDRVR__ {

    public static MemoryLayout $LAYOUT() {
        return constants$1553.const$0;
    }
    ...
    public static int unused$get(MemorySegment seg) {
        return (int)constants$1553.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int unused$get(MemorySegment seg, long index) {
        return (int)constants$1553.const$1.get(seg.asSlice(index*sizeof()));
    }

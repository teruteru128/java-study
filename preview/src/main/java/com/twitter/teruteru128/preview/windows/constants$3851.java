...
final class constants$3851 {

    // Suppresses default constructor, ensuring non-instantiability.
    private constants$3851() {}
    static final StructLayout const$0 = MemoryLayout.structLayout(
        RuntimeHelper.POINTER.withName("lpVtbl")
    ).withName("IXMLDOMAttribute");
    static final VarHandle const$1 = constants$3851.const$0.varHandle(MemoryLayout.PathElement.groupElement("lpVtbl"));
    static final MemorySegment const$2 = RuntimeHelper.lookupGlobalVariable("IID_IXMLDOMElement", constants$27.const$0);
    static final StructLayout const$3 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("getAttributeNode"),
        RuntimeHelper.POINTER.withName("setAttributeNode"),
        RuntimeHelper.POINTER.withName("removeAttributeNode"),
        RuntimeHelper.POINTER.withName("getElementsByTagName"),
        RuntimeHelper.POINTER.withName("normalize")
    ).withName("IXMLDOMElementVtbl");
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(IXMLDOMElementVtbl.QueryInterface.class, "apply", constants$37.const$3);
    static final VarHandle const$5 = constants$3851.const$3.varHandle(MemoryLayout.PathElement.groupElement("QueryInterface"));
}

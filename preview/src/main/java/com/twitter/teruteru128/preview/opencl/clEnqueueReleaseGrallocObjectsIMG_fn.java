...
/**
 * {@snippet :
 * int (*clEnqueueReleaseGrallocObjectsIMG_fn)(struct _cl_command_queue* command_queue,unsigned int num_objects,struct _cl_mem** mem_objects,unsigned int num_events_in_wait_list,struct _cl_event** event_wait_list,struct _cl_event** event);
 * }
 */
public interface clEnqueueReleaseGrallocObjectsIMG_fn {
    ...
    static MemorySegment allocate(clEnqueueReleaseGrallocObjectsIMG_fn fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$232.const$3, fi, constants$207.const$5, scope);
    }
    static clEnqueueReleaseGrallocObjectsIMG_fn ofAddress(MemorySegment addr, Arena arena) {

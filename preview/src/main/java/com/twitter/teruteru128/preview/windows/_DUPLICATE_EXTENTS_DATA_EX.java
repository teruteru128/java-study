...
public class _DUPLICATE_EXTENTS_DATA_EX {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2718.const$1;
    }
    public static VarHandle Size$VH() {
        return constants$2718.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long Size$get(MemorySegment seg) {
        return (long)constants$2718.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Size$set(MemorySegment seg, long x) {
        constants$2718.const$2.set(seg, x);
    }
    public static long Size$get(MemorySegment seg, long index) {
        return (long)constants$2718.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void Size$set(MemorySegment seg, long index, long x) {
        constants$2718.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle FileHandle$VH() {
        return constants$2718.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment FileHandle$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2718.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void FileHandle$set(MemorySegment seg, MemorySegment x) {
        constants$2718.const$3.set(seg, x);
    }
    public static MemorySegment FileHandle$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2718.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void FileHandle$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2718.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int Flags$get(MemorySegment seg) {
        return (int)constants$2718.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Flags$set(MemorySegment seg, int x) {
        constants$2718.const$4.set(seg, x);
    }
    public static int Flags$get(MemorySegment seg, long index) {
        return (int)constants$2718.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void Flags$set(MemorySegment seg, long index, int x) {
        constants$2718.const$4.set(seg.asSlice(index*sizeof()), x);
    }

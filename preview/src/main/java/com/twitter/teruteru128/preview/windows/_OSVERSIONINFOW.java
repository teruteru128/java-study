...
public class _OSVERSIONINFOW {
    ...
    public static int dwOSVersionInfoSize$get(MemorySegment seg) {
        return (int)constants$477.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwMajorVersion$get(MemorySegment seg) {
        return (int)constants$477.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwMajorVersion$get(MemorySegment seg, long index) {
        return (int)constants$477.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int dwMinorVersion$get(MemorySegment seg) {
        return (int)constants$477.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwMinorVersion$get(MemorySegment seg, long index) {
        return (int)constants$477.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int dwBuildNumber$get(MemorySegment seg) {
        return (int)constants$477.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwBuildNumber$get(MemorySegment seg, long index) {
        return (int)constants$477.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int dwPlatformId$get(MemorySegment seg) {
        return (int)constants$478.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwPlatformId$get(MemorySegment seg, long index) {
        return (int)constants$478.const$0.get(seg.asSlice(index*sizeof()));
    }

...
final class constants$3752 {

    // Suppresses default constructor, ensuring non-instantiability.
    private constants$3752() {}
    static final VarHandle const$0 = constants$3749.const$0.varHandle(MemoryLayout.PathElement.groupElement("get_nodeValue"));
    ...
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(IXMLDOMNodeVtbl.put_nodeValue.class, "apply", constants$3752.const$1);
    static final MethodHandle const$3 = RuntimeHelper.downcallHandle(
        constants$3752.const$1
    );
    static final VarHandle const$4 = constants$3749.const$0.varHandle(MemoryLayout.PathElement.groupElement("put_nodeValue"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(IXMLDOMNodeVtbl.get_nodeType.class, "apply", constants$34.const$0);
}

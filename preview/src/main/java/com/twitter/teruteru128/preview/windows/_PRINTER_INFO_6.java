...
public class _PRINTER_INFO_6 {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2833.const$2;
    }
    public static VarHandle dwStatus$VH() {
        return constants$2833.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwStatus$get(MemorySegment seg) {
        return (int)constants$2833.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwStatus$set(MemorySegment seg, int x) {
        constants$2833.const$3.set(seg, x);
    }
    public static int dwStatus$get(MemorySegment seg, long index) {
        return (int)constants$2833.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void dwStatus$set(MemorySegment seg, long index, int x) {
        constants$2833.const$3.set(seg.asSlice(index*sizeof()), x);
    }

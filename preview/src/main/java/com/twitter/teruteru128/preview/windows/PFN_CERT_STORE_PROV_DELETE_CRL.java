...
public interface PFN_CERT_STORE_PROV_DELETE_CRL {
    ...
    static MemorySegment allocate(PFN_CERT_STORE_PROV_DELETE_CRL fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$2130.const$4, fi, constants$570.const$5, scope);
    }
    static PFN_CERT_STORE_PROV_DELETE_CRL ofAddress(MemorySegment addr, Arena arena) {

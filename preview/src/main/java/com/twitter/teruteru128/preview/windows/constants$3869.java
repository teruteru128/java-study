...
final class constants$3869 {

    // Suppresses default constructor, ensuring non-instantiability.
    private constants$3869() {}
    static final StructLayout const$0 = MemoryLayout.structLayout(
        RuntimeHelper.POINTER.withName("lpVtbl")
    ).withName("IXMLDOMElement");
    static final VarHandle const$1 = constants$3869.const$0.varHandle(MemoryLayout.PathElement.groupElement("lpVtbl"));
    static final MemorySegment const$2 = RuntimeHelper.lookupGlobalVariable("IID_IXMLDOMText", constants$27.const$0);
    ...
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(IXMLDOMTextVtbl.QueryInterface.class, "apply", constants$37.const$3);
    static final VarHandle const$5 = constants$3869.const$3.varHandle(MemoryLayout.PathElement.groupElement("QueryInterface"));
}

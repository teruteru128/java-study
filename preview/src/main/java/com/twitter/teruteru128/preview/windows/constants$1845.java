...
final class constants$1845 {
    ...
    static final VarHandle const$1 = constants$1845.const$0.varHandle(MemoryLayout.PathElement.groupElement("Version"));
    static final VarHandle const$2 = constants$1845.const$0.varHandle(MemoryLayout.PathElement.groupElement("Flags"));
    static final VarHandle const$3 = constants$1845.const$0.varHandle(MemoryLayout.PathElement.groupElement("ServerPrincipalNameBufferLength"));
    static final VarHandle const$4 = constants$1845.const$0.varHandle(MemoryLayout.PathElement.groupElement("ServerPrincipalName"));
    static final VarHandle const$5 = constants$1845.const$0.varHandle(MemoryLayout.PathElement.groupElement("ClientPrincipalNameBufferLength"));
}

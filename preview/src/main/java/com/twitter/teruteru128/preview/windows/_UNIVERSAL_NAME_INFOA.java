...
public class _UNIVERSAL_NAME_INFOA {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1515.const$1;
    }
    public static VarHandle lpUniversalName$VH() {
        return constants$1515.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpUniversalName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1515.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpUniversalName$set(MemorySegment seg, MemorySegment x) {
        constants$1515.const$2.set(seg, x);
    }
    public static MemorySegment lpUniversalName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1515.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void lpUniversalName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1515.const$2.set(seg.asSlice(index*sizeof()), x);
    }

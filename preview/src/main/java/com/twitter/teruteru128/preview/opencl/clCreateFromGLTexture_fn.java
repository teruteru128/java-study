...
/**
 * {@snippet :
 * struct _cl_mem* (*clCreateFromGLTexture_fn)(struct _cl_context* context,unsigned long long flags,unsigned int target,int miplevel,unsigned int texture,int* errcode_ret);
 * }
 */
public interface clCreateFromGLTexture_fn {
    ...
    static MemorySegment allocate(clCreateFromGLTexture_fn fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$206.const$5, fi, constants$206.const$4, scope);
    }
    static clCreateFromGLTexture_fn ofAddress(MemorySegment addr, Arena arena) {

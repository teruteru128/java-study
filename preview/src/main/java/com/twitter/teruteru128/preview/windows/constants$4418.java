...
final class constants$4418 {

    // Suppresses default constructor, ensuring non-instantiability.
    private constants$4418() {}
    static final VarHandle const$0 = constants$4414.const$4.varHandle(MemoryLayout.PathElement.groupElement("lpTemplateName"));
    ...
    static final VarHandle const$2 = constants$4418.const$1.varHandle(MemoryLayout.PathElement.groupElement("lStructSize"));
    static final VarHandle const$3 = constants$4418.const$1.varHandle(MemoryLayout.PathElement.groupElement("hwndOwner"));
    static final VarHandle const$4 = constants$4418.const$1.varHandle(MemoryLayout.PathElement.groupElement("hInstance"));
    static final VarHandle const$5 = constants$4418.const$1.varHandle(MemoryLayout.PathElement.groupElement("lpstrFilter"));
}

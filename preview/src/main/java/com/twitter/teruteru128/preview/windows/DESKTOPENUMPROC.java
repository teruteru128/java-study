...
public interface DESKTOPENUMPROC {
    ...
    static MemorySegment allocate(DESKTOPENUMPROC fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1137.const$4, fi, constants$39.const$3, scope);
    }
    static DESKTOPENUMPROC ofAddress(MemorySegment addr, Arena arena) {

...
public class _CRYPT_ENCODE_PARA {
    ...
    public static int cbSize$get(MemorySegment seg) {
        return (int)constants$2021.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment pfnAlloc$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2022.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pfnAlloc$set(MemorySegment seg, MemorySegment x) {
        constants$2022.const$0.set(seg, x);
    }
    public static MemorySegment pfnAlloc$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2022.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void pfnAlloc$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2022.const$0.set(seg.asSlice(index*sizeof()), x);
    }

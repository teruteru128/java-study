...
/**
 * {@snippet :
 * int (*clGetGLContextInfoKHR_fn)(long long* properties,unsigned int param_name,unsigned long long param_value_size,void* param_value,unsigned long long* param_value_size_ret);
 * }
 */
public interface clGetGLContextInfoKHR_fn {
    ...
    static MemorySegment allocate(clGetGLContextInfoKHR_fn fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$205.const$3, fi, constants$176.const$4, scope);
    }
    static clGetGLContextInfoKHR_fn ofAddress(MemorySegment addr, Arena arena) {

...
final class constants$944 {
    ...
    static final VarHandle const$0 = constants$943.const$3.varHandle(MemoryLayout.PathElement.groupElement("elfMatch"));
    static final VarHandle const$1 = constants$943.const$3.varHandle(MemoryLayout.PathElement.groupElement("elfReserved"));
    static final VarHandle const$2 = constants$943.const$3.varHandle(MemoryLayout.PathElement.groupElement("elfCulture"));
    static final StructLayout const$3 = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(32, JAVA_BYTE).withName("dmDeviceName"),
        ...
        MemoryLayout.sequenceLayout(32, JAVA_BYTE).withName("dmFormName"),
    ...
    static final VarHandle const$4 = constants$944.const$3.varHandle(MemoryLayout.PathElement.groupElement("dmSpecVersion"));
    static final VarHandle const$5 = constants$944.const$3.varHandle(MemoryLayout.PathElement.groupElement("dmDriverVersion"));
}

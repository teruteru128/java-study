...
public class DISPLAYCONFIG_TARGET_BASE_TYPE {
    ...
    public static int baseOutputTechnology$get(MemorySegment seg) {
        return (int)constants$966.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :

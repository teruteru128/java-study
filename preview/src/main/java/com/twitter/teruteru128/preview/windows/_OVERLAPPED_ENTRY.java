...
public class _OVERLAPPED_ENTRY {
    ...
    public static long lpCompletionKey$get(MemorySegment seg) {
        return (long)constants$552.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long lpCompletionKey$get(MemorySegment seg, long index) {
        return (long)constants$552.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment lpOverlapped$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$552.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpOverlapped$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$552.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long Internal$get(MemorySegment seg) {
        return (long)constants$553.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long Internal$get(MemorySegment seg, long index) {
        return (long)constants$553.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int dwNumberOfBytesTransferred$get(MemorySegment seg) {
        return (int)constants$553.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwNumberOfBytesTransferred$get(MemorySegment seg, long index) {
        return (int)constants$553.const$1.get(seg.asSlice(index*sizeof()));
    }

...
public class tagMIXERCAPS2A {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1659.const$3;
    }
    public static VarHandle wMid$VH() {
        return constants$1659.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static short wMid$get(MemorySegment seg) {
        return (short)constants$1659.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void wMid$set(MemorySegment seg, short x) {
        constants$1659.const$4.set(seg, x);
    }
    public static short wMid$get(MemorySegment seg, long index) {
        return (short)constants$1659.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void wMid$set(MemorySegment seg, long index, short x) {
        constants$1659.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle wPid$VH() {
        return constants$1659.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static short wPid$get(MemorySegment seg) {
        return (short)constants$1659.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void wPid$set(MemorySegment seg, short x) {
        constants$1659.const$5.set(seg, x);
    }
    public static short wPid$get(MemorySegment seg, long index) {
        return (short)constants$1659.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void wPid$set(MemorySegment seg, long index, short x) {
        constants$1659.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle vDriverVersion$VH() {
        return constants$1660.const$0;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int vDriverVersion$get(MemorySegment seg) {
        return (int)constants$1660.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int fdwSupport$get(MemorySegment seg) {
        return (int)constants$1660.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void fdwSupport$set(MemorySegment seg, int x) {
        constants$1660.const$1.set(seg, x);
    }
    public static int fdwSupport$get(MemorySegment seg, long index) {
        return (int)constants$1660.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void fdwSupport$set(MemorySegment seg, long index, int x) {
        constants$1660.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle cDestinations$VH() {
        return constants$1660.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cDestinations$get(MemorySegment seg) {
        return (int)constants$1660.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cDestinations$set(MemorySegment seg, int x) {
        constants$1660.const$2.set(seg, x);
    }
    public static int cDestinations$get(MemorySegment seg, long index) {
        return (int)constants$1660.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void cDestinations$set(MemorySegment seg, long index, int x) {
        constants$1660.const$2.set(seg.asSlice(index*sizeof()), x);
    }

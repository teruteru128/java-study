...
public class tagBinaryParam {
    ...
    public static MemorySegment Buffer$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1825.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment Buffer$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1825.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short Size$get(MemorySegment seg) {
        return (short)constants$1825.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short Size$get(MemorySegment seg, long index) {
        return (short)constants$1825.const$2.get(seg.asSlice(index*sizeof()));
    }

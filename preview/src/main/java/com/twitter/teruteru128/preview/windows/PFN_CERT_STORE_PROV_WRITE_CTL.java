...
/**
 * {@snippet :
 * int (*PFN_CERT_STORE_PROV_WRITE_CTL)(void* hStoreProv,struct _CTL_CONTEXT* pCtlContext,unsigned long dwFlags);
 * }
 */
public interface PFN_CERT_STORE_PROV_WRITE_CTL {
    ...
    static MemorySegment allocate(PFN_CERT_STORE_PROV_WRITE_CTL fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$2131.const$1, fi, constants$570.const$5, scope);
    }
    static PFN_CERT_STORE_PROV_WRITE_CTL ofAddress(MemorySegment addr, Arena arena) {

...
public interface UILANGUAGE_ENUMPROCW {
    ...
    static MemorySegment allocate(UILANGUAGE_ENUMPROCW fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1420.const$5, fi, constants$39.const$3, scope);
    }
    static UILANGUAGE_ENUMPROCW ofAddress(MemorySegment addr, Arena arena) {

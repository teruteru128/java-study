...
public interface PFN_CRYPT_FREE {
    ...
    static MemorySegment allocate(PFN_CRYPT_FREE fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$2021.const$3, fi, constants$0.const$0, scope);
    }
    static PFN_CRYPT_FREE ofAddress(MemorySegment addr, Arena arena) {

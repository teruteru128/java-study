...
public class tagRemHENHMETAFILE {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2348.const$4;
    }
    public static VarHandle cbData$VH() {
        return constants$2348.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cbData$get(MemorySegment seg) {
        return (int)constants$2348.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cbData$set(MemorySegment seg, int x) {
        constants$2348.const$5.set(seg, x);
    }
    public static int cbData$get(MemorySegment seg, long index) {
        return (int)constants$2348.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void cbData$set(MemorySegment seg, long index, int x) {
        constants$2348.const$5.set(seg.asSlice(index*sizeof()), x);
    }

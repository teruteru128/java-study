...
public class _CONSOLE_FONT_INFO {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1453.const$1;
    }
    public static VarHandle nFont$VH() {
        return constants$1453.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int nFont$get(MemorySegment seg) {
        return (int)constants$1453.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void nFont$set(MemorySegment seg, int x) {
        constants$1453.const$2.set(seg, x);
    }
    public static int nFont$get(MemorySegment seg, long index) {
        return (int)constants$1453.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void nFont$set(MemorySegment seg, long index, int x) {
        constants$1453.const$2.set(seg.asSlice(index*sizeof()), x);
    }

...
final class constants$3800 {

    // Suppresses default constructor, ensuring non-instantiability.
    private constants$3800() {}
    ...
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(IXMLDOMDocumentVtbl.load.class, "apply", constants$3800.const$0);
    static final MethodHandle const$2 = RuntimeHelper.downcallHandle(
        constants$3800.const$0
    );
    static final VarHandle const$3 = constants$3780.const$1.varHandle(MemoryLayout.PathElement.groupElement("load"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(IXMLDOMDocumentVtbl.get_readyState.class, "apply", constants$34.const$0);
    static final VarHandle const$5 = constants$3780.const$1.varHandle(MemoryLayout.PathElement.groupElement("get_readyState"));
}

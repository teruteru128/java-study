 ...
 * }
 */
public class MachineGlobalObjectTableRegistrationToken__ {

    public static MemoryLayout $LAYOUT() {
        return constants$3176.const$0;
    }
    public static VarHandle unused$VH() {
        return constants$3176.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int unused$get(MemorySegment seg) {
        return (int)constants$3176.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void unused$set(MemorySegment seg, int x) {
        constants$3176.const$1.set(seg, x);
    }
    public static int unused$get(MemorySegment seg, long index) {
        return (int)constants$3176.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void unused$set(MemorySegment seg, long index, int x) {
        constants$3176.const$1.set(seg.asSlice(index*sizeof()), x);
    }

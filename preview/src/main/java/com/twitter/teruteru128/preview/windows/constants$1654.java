...
final class constants$1654 {
    ...
    static final VarHandle const$0 = constants$1653.const$2.varHandle(MemoryLayout.PathElement.groupElement("wTechnology"));
    static final VarHandle const$1 = constants$1653.const$2.varHandle(MemoryLayout.PathElement.groupElement("wReserved1"));
    static final VarHandle const$2 = constants$1653.const$2.varHandle(MemoryLayout.PathElement.groupElement("dwSupport"));
    ...
    static final VarHandle const$4 = constants$1654.const$3.varHandle(MemoryLayout.PathElement.groupElement("wMid"));
    static final VarHandle const$5 = constants$1654.const$3.varHandle(MemoryLayout.PathElement.groupElement("wPid"));
}

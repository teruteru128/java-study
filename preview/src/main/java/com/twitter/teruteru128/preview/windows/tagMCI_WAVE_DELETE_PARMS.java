...
public class tagMCI_WAVE_DELETE_PARMS {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1573.const$4;
    }
    public static VarHandle dwCallback$VH() {
        return constants$1573.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long dwCallback$get(MemorySegment seg) {
        return (long)constants$1573.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwCallback$set(MemorySegment seg, long x) {
        constants$1573.const$5.set(seg, x);
    }
    public static long dwCallback$get(MemorySegment seg, long index) {
        return (long)constants$1573.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void dwCallback$set(MemorySegment seg, long index, long x) {
        constants$1573.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle dwFrom$VH() {
        return constants$1574.const$0;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwFrom$get(MemorySegment seg) {
        return (int)constants$1574.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwFrom$set(MemorySegment seg, int x) {
        constants$1574.const$0.set(seg, x);
    }
    public static int dwFrom$get(MemorySegment seg, long index) {
        return (int)constants$1574.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void dwFrom$set(MemorySegment seg, long index, int x) {
        constants$1574.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle dwTo$VH() {
        return constants$1574.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwTo$get(MemorySegment seg) {
        return (int)constants$1574.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwTo$set(MemorySegment seg, int x) {
        constants$1574.const$1.set(seg, x);
    }
    public static int dwTo$get(MemorySegment seg, long index) {
        return (int)constants$1574.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void dwTo$set(MemorySegment seg, long index, int x) {
        constants$1574.const$1.set(seg.asSlice(index*sizeof()), x);
    }

...
final class constants$1617 {
    ...
    static final VarHandle const$1 = constants$1617.const$0.varHandle(MemoryLayout.PathElement.groupElement("wMid"));
    static final VarHandle const$2 = constants$1617.const$0.varHandle(MemoryLayout.PathElement.groupElement("wPid"));
    static final VarHandle const$3 = constants$1617.const$0.varHandle(MemoryLayout.PathElement.groupElement("vDriverVersion"));
    static final VarHandle const$4 = constants$1617.const$0.varHandle(MemoryLayout.PathElement.groupElement("dwFormats"));
    static final VarHandle const$5 = constants$1617.const$0.varHandle(MemoryLayout.PathElement.groupElement("wChannels"));
}

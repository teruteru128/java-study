...
public class SERVICE_STATUS_HANDLE__ {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$4487.const$3;
    }
    public static VarHandle unused$VH() {
        return constants$4487.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int unused$get(MemorySegment seg) {
        return (int)constants$4487.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void unused$set(MemorySegment seg, int x) {
        constants$4487.const$4.set(seg, x);
    }
    public static int unused$get(MemorySegment seg, long index) {
        return (int)constants$4487.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void unused$set(MemorySegment seg, long index, int x) {
        constants$4487.const$4.set(seg.asSlice(index*sizeof()), x);
    }

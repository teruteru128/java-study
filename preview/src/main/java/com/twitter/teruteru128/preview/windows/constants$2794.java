...
final class constants$2794 {
    ...
    static final VarHandle const$0 = constants$2792.const$0.varHandle(MemoryLayout.PathElement.groupElement("pcRefParent"));
    static final VarHandle const$1 = constants$2792.const$0.varHandle(MemoryLayout.PathElement.groupElement("pszHeaderTitle"));
    static final VarHandle const$2 = constants$2792.const$0.varHandle(MemoryLayout.PathElement.groupElement("pszHeaderSubTitle"));
    static final VarHandle const$3 = constants$2792.const$0.varHandle(MemoryLayout.PathElement.groupElement("hActCtx"));
    ...
    static final VarHandle const$5 = constants$2794.const$4.varHandle(MemoryLayout.PathElement.groupElement("dwSize"));
}

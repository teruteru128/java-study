...
public class _RTL_CONDITION_VARIABLE {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$494.const$1;
    }
    public static VarHandle Ptr$VH() {
        return constants$494.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment Ptr$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$494.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Ptr$set(MemorySegment seg, MemorySegment x) {
        constants$494.const$2.set(seg, x);
    }
    public static MemorySegment Ptr$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$494.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void Ptr$set(MemorySegment seg, long index, MemorySegment x) {
        constants$494.const$2.set(seg.asSlice(index*sizeof()), x);
    }

...
public class _SCM_PD_PROPERTY_SET {
    ...
    public static int Version$get(MemorySegment seg) {
        return (int)constants$2515.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Version$set(MemorySegment seg, int x) {
        constants$2515.const$0.set(seg, x);
    }
    public static int Version$get(MemorySegment seg, long index) {
        return (int)constants$2515.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void Version$set(MemorySegment seg, long index, int x) {
        constants$2515.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int Size$get(MemorySegment seg) {
        return (int)constants$2515.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int PropertyId$get(MemorySegment seg) {
        return (int)constants$2515.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void PropertyId$set(MemorySegment seg, int x) {
        constants$2515.const$2.set(seg, x);
    }
    public static int PropertyId$get(MemorySegment seg, long index) {
        return (int)constants$2515.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void PropertyId$set(MemorySegment seg, long index, int x) {
        constants$2515.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle SetType$VH() {
        return constants$2515.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int SetType$get(MemorySegment seg) {
        return (int)constants$2515.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void SetType$set(MemorySegment seg, int x) {
        constants$2515.const$3.set(seg, x);
    }
    public static int SetType$get(MemorySegment seg, long index) {
        return (int)constants$2515.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void SetType$set(MemorySegment seg, long index, int x) {
        constants$2515.const$3.set(seg.asSlice(index*sizeof()), x);
    }

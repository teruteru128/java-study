...
public class DDEPOKE {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1522.const$1;
    }
    public static VarHandle cfFormat$VH() {
        return constants$1522.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static short cfFormat$get(MemorySegment seg) {
        return (short)constants$1522.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cfFormat$set(MemorySegment seg, short x) {
        constants$1522.const$3.set(seg, x);
    }
    public static short cfFormat$get(MemorySegment seg, long index) {
        return (short)constants$1522.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void cfFormat$set(MemorySegment seg, long index, short x) {
        constants$1522.const$3.set(seg.asSlice(index*sizeof()), x);
    }

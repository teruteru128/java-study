...
public class cl_ushort4 {
    ...
    public static short x$get(MemorySegment seg) {
        return (short)constants$93.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short x$get(MemorySegment seg, long index) {
        return (short)constants$93.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short y$get(MemorySegment seg) {
        return (short)constants$93.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short y$get(MemorySegment seg, long index) {
        return (short)constants$93.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short z$get(MemorySegment seg) {
        return (short)constants$93.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short z$get(MemorySegment seg, long index) {
        return (short)constants$93.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short w$get(MemorySegment seg) {
        return (short)constants$94.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short w$get(MemorySegment seg, long index) {
        return (short)constants$94.const$0.get(seg.asSlice(index*sizeof()));
    }

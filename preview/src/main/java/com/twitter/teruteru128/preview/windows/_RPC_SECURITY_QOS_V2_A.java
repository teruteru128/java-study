...
public class _RPC_SECURITY_QOS_V2_A {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1743.const$2;
    }
    public static VarHandle Version$VH() {
        return constants$1743.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int Version$get(MemorySegment seg) {
        return (int)constants$1743.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Version$set(MemorySegment seg, int x) {
        constants$1743.const$3.set(seg, x);
    }
    public static int Version$get(MemorySegment seg, long index) {
        return (int)constants$1743.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void Version$set(MemorySegment seg, long index, int x) {
        constants$1743.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle Capabilities$VH() {
        return constants$1743.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int Capabilities$get(MemorySegment seg) {
        return (int)constants$1743.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Capabilities$set(MemorySegment seg, int x) {
        constants$1743.const$4.set(seg, x);
    }
    public static int Capabilities$get(MemorySegment seg, long index) {
        return (int)constants$1743.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void Capabilities$set(MemorySegment seg, long index, int x) {
        constants$1743.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle IdentityTracking$VH() {
        return constants$1743.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int IdentityTracking$get(MemorySegment seg) {
        return (int)constants$1743.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int ImpersonationType$get(MemorySegment seg) {
        return (int)constants$1744.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int AdditionalSecurityInfoType$get(MemorySegment seg) {
        return (int)constants$1744.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static final class u {
        ...
        public static MemorySegment HttpCredentials$get(MemorySegment seg) {
            return (java.lang.foreign.MemorySegment)constants$1744.const$2.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static void HttpCredentials$set(MemorySegment seg, MemorySegment x) {
            constants$1744.const$2.set(seg, x);
        }
        public static MemorySegment HttpCredentials$get(MemorySegment seg, long index) {
            return (java.lang.foreign.MemorySegment)constants$1744.const$2.get(seg.asSlice(index*sizeof()));
        }
        public static void HttpCredentials$set(MemorySegment seg, long index, MemorySegment x) {
            constants$1744.const$2.set(seg.asSlice(index*sizeof()), x);
        }

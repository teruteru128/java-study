 ...
 * }
 */
public class _userHMETAFILE {

    public static MemoryLayout $LAYOUT() {
        return constants$2352.const$4;
    }
    public static VarHandle fContext$VH() {
        return constants$2352.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int fContext$get(MemorySegment seg) {
        return (int)constants$2352.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void fContext$set(MemorySegment seg, int x) {
        constants$2352.const$5.set(seg, x);
    }
    public static int fContext$get(MemorySegment seg, long index) {
        return (int)constants$2352.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void fContext$set(MemorySegment seg, long index, int x) {
        constants$2352.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    /**
     * {@snippet :
     ...
     * }
     */
    public static final class __MIDL_IWinTypes_0004 {

        // Suppresses default constructor, ensuring non-instantiability.
        private __MIDL_IWinTypes_0004() {}
        public static MemoryLayout $LAYOUT() {
            return constants$2353.const$0;
        }
        public static VarHandle hInproc$VH() {
            return constants$2353.const$1;
        }
        /**
         * Getter for field:
         * {@snippet :
        ...
        public static int hInproc$get(MemorySegment seg) {
            return (int)constants$2353.const$1.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static void hInproc$set(MemorySegment seg, int x) {
            constants$2353.const$1.set(seg, x);
        }
        public static int hInproc$get(MemorySegment seg, long index) {
            return (int)constants$2353.const$1.get(seg.asSlice(index*sizeof()));
        }
        public static void hInproc$set(MemorySegment seg, long index, int x) {
            constants$2353.const$1.set(seg.asSlice(index*sizeof()), x);
        }
        public static VarHandle hRemote$VH() {
            return constants$2353.const$2;
        }
        /**
         * Getter for field:
         * {@snippet :
        ...
        public static MemorySegment hRemote$get(MemorySegment seg) {
            return (java.lang.foreign.MemorySegment)constants$2353.const$2.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static void hRemote$set(MemorySegment seg, MemorySegment x) {
            constants$2353.const$2.set(seg, x);
        }
        public static MemorySegment hRemote$get(MemorySegment seg, long index) {
            return (java.lang.foreign.MemorySegment)constants$2353.const$2.get(seg.asSlice(index*sizeof()));
        }
        public static void hRemote$set(MemorySegment seg, long index, MemorySegment x) {
            constants$2353.const$2.set(seg.asSlice(index*sizeof()), x);
        }
        public static VarHandle hInproc64$VH() {
            return constants$2353.const$3;
        }
        /**
         * Getter for field:
         * {@snippet :
        ...
        public static long hInproc64$get(MemorySegment seg) {
            return (long)constants$2353.const$3.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static void hInproc64$set(MemorySegment seg, long x) {
            constants$2353.const$3.set(seg, x);
        }
        public static long hInproc64$get(MemorySegment seg, long index) {
            return (long)constants$2353.const$3.get(seg.asSlice(index*sizeof()));
        }
        public static void hInproc64$set(MemorySegment seg, long index, long x) {
            constants$2353.const$3.set(seg.asSlice(index*sizeof()), x);
        }

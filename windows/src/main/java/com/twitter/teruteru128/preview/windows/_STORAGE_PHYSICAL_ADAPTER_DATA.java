...
public class _STORAGE_PHYSICAL_ADAPTER_DATA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("AdapterId"),
        Windows_h.C_INT.withName("HealthStatus"),
        Windows_h.C_INT.withName("CommandProtocol"),
        _STORAGE_SPEC_VERSION.layout().withName("SpecVersion"),
        MemoryLayout.sequenceLayout(8, Windows_h.C_CHAR).withName("Vendor"),
        MemoryLayout.sequenceLayout(40, Windows_h.C_CHAR).withName("Model"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("FirmwareRevision"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("PhysicalLocation"),
        Windows_h.C_CHAR.withName("ExpanderConnected"),
        MemoryLayout.sequenceLayout(3, Windows_h.C_CHAR).withName("Reserved0"),

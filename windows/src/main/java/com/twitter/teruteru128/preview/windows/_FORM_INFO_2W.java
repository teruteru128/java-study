...
public class _FORM_INFO_2W {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("pKeyword"),
        Windows_h.C_LONG.withName("StringType"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("pMuiDll"),
        Windows_h.C_LONG.withName("dwResourceId"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("pDisplayName"),

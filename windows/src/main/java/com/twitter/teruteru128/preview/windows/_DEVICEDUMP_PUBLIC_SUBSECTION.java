...
public class _DEVICEDUMP_PUBLIC_SUBSECTION {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2484.const$1;
    }
    public static VarHandle dwFlags$VH() {
        return constants$2484.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwFlags$get(MemorySegment seg) {
        return (int)constants$2484.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwFlags$set(MemorySegment seg, int x) {
        constants$2484.const$2.set(seg, x);
    }
    public static int dwFlags$get(MemorySegment seg, long index) {
        return (int)constants$2484.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void dwFlags$set(MemorySegment seg, long index, int x) {
        constants$2484.const$2.set(seg.asSlice(index*sizeof()), x);
    }

...
public class HTASK__ {
    ...
    public static int unused$get(MemorySegment seg) {
        return (int)constants$539.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void unused$set(MemorySegment seg, int x) {
        constants$539.const$1.set(seg, x);
    }
    public static int unused$get(MemorySegment seg, long index) {
        return (int)constants$539.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void unused$set(MemorySegment seg, long index, int x) {
        constants$539.const$1.set(seg.asSlice(index*sizeof()), x);
    }

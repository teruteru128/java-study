...
public interface GENERIC_BINDING_ROUTINE {
    ...
    static MemorySegment allocate(GENERIC_BINDING_ROUTINE fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$2276.const$4, fi, constants$33.const$3, scope);
    }
    static GENERIC_BINDING_ROUTINE ofAddress(MemorySegment addr, Arena arena) {

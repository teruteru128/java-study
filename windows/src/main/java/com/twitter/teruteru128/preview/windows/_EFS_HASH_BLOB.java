...
public class _EFS_HASH_BLOB {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2247.const$4;
    }
    public static VarHandle cbData$VH() {
        return constants$2247.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cbData$get(MemorySegment seg) {
        return (int)constants$2247.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cbData$set(MemorySegment seg, int x) {
        constants$2247.const$5.set(seg, x);
    }
    public static int cbData$get(MemorySegment seg, long index) {
        return (int)constants$2247.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void cbData$set(MemorySegment seg, long index, int x) {
        constants$2247.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pbData$VH() {
        return constants$2248.const$0;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pbData$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2248.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pbData$set(MemorySegment seg, MemorySegment x) {
        constants$2248.const$0.set(seg, x);
    }
    public static MemorySegment pbData$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2248.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void pbData$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2248.const$0.set(seg.asSlice(index*sizeof()), x);
    }

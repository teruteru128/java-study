 ...
 *     HRESULT (*QueryInterface)(ISynchronizeHandle *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(ISynchronizeHandle *) __attribute__((stdcall));
 *     ULONG (*Release)(ISynchronizeHandle *) __attribute__((stdcall));
 *     HRESULT (*GetHandle)(ISynchronizeHandle *, HANDLE *) __attribute__((stdcall));
 * }
 * }
 */

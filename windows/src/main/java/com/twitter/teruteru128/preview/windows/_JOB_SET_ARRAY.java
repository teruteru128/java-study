...
public class _JOB_SET_ARRAY {
     ...
     * }
     */
    public static MemorySegment JobHandle$get(MemorySegment seg) {
     ...
     * }
     */
    public static void JobHandle$set(MemorySegment seg, MemorySegment x) {
        constants$183.const$0.set(seg, x);
    }
    public static MemorySegment JobHandle$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$183.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void JobHandle$set(MemorySegment seg, long index, MemorySegment x) {

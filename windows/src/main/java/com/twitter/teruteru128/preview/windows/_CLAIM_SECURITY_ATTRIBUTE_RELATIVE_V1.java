...
public class _CLAIM_SECURITY_ATTRIBUTE_RELATIVE_V1 {
    ...
    public static class Values {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.sequenceLayout(1, Windows_h.C_LONG).withName("pInt64"),
            MemoryLayout.sequenceLayout(1, Windows_h.C_LONG).withName("pUint64"),
            MemoryLayout.sequenceLayout(1, Windows_h.C_LONG).withName("ppString"),
            MemoryLayout.sequenceLayout(1, Windows_h.C_LONG).withName("pFqbn"),
            MemoryLayout.sequenceLayout(1, Windows_h.C_LONG).withName("pOctetString")
        ).withName("$anon$11961:5");

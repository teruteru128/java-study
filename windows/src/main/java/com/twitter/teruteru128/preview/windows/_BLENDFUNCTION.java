...
public class _BLENDFUNCTION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("BlendOp"),
        Windows_h.C_CHAR.withName("BlendFlags"),
        Windows_h.C_CHAR.withName("SourceConstantAlpha"),
        Windows_h.C_CHAR.withName("AlphaFormat")

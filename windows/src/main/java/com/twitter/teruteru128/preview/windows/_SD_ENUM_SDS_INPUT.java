...
public class _SD_ENUM_SDS_INPUT {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2674.const$3;
    }
    public static VarHandle StartingOffset$VH() {
        return constants$2674.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long StartingOffset$get(MemorySegment seg) {
        return (long)constants$2674.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long MaxSDEntriesToReturn$get(MemorySegment seg) {
        return (long)constants$2674.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :

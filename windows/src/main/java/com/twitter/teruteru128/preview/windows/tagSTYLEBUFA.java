...
public class tagSTYLEBUFA {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$4525.const$3;
    }
    public static VarHandle dwStyle$VH() {
        return constants$4525.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwStyle$get(MemorySegment seg) {
        return (int)constants$4525.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwStyle$set(MemorySegment seg, int x) {
        constants$4525.const$4.set(seg, x);
    }
    public static int dwStyle$get(MemorySegment seg, long index) {
        return (int)constants$4525.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void dwStyle$set(MemorySegment seg, long index, int x) {
        constants$4525.const$4.set(seg.asSlice(index*sizeof()), x);
    }

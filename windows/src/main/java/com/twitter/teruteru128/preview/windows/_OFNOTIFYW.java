...
public class _OFNOTIFYW {
    ...
    public static MemorySegment lpOFN$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$4431.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpOFN$set(MemorySegment seg, MemorySegment x) {
        constants$4431.const$4.set(seg, x);
    }
    public static MemorySegment lpOFN$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$4431.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void lpOFN$set(MemorySegment seg, long index, MemorySegment x) {
        constants$4431.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pszFile$VH() {
        return constants$4431.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pszFile$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$4431.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pszFile$set(MemorySegment seg, MemorySegment x) {
        constants$4431.const$5.set(seg, x);
    }
    public static MemorySegment pszFile$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$4431.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void pszFile$set(MemorySegment seg, long index, MemorySegment x) {
        constants$4431.const$5.set(seg.asSlice(index*sizeof()), x);
    }

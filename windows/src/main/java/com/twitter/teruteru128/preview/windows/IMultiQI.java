 ...
 * }
 */
public class IMultiQI {

    public static MemoryLayout $LAYOUT() {
        return constants$3033.const$5;
    }
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3034.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        constants$3034.const$0.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3034.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3034.const$0.set(seg.asSlice(index*sizeof()), x);
    }

...
public class _TXFS_READ_BACKUP_INFORMATION_OUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            ...
            MemoryLayout.sequenceLayout(1, Windows_h.C_CHAR).withName("Buffer")
        ).withName("$anon$13605:5")
    ...
    private static final OfInt BufferLength$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$13605:5"), groupElement("BufferLength"));
    ...
    private static final SequenceLayout Buffer$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$13605:5"), groupElement("Buffer"));

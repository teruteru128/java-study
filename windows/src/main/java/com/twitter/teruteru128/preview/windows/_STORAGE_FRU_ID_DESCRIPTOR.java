...
public class _STORAGE_FRU_ID_DESCRIPTOR {
    ...
    public static int Version$get(MemorySegment seg) {
        return (int)constants$2439.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int Version$get(MemorySegment seg, long index) {
        return (int)constants$2439.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void Version$set(MemorySegment seg, long index, int x) {
        constants$2439.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle Size$VH() {
        return constants$2439.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int Size$get(MemorySegment seg) {
        return (int)constants$2439.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Size$set(MemorySegment seg, int x) {
        constants$2439.const$4.set(seg, x);
    }
    public static int Size$get(MemorySegment seg, long index) {
        return (int)constants$2439.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void Size$set(MemorySegment seg, long index, int x) {
        constants$2439.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle IdentifierSize$VH() {
        return constants$2439.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int IdentifierSize$get(MemorySegment seg) {
        return (int)constants$2439.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void IdentifierSize$set(MemorySegment seg, int x) {
        constants$2439.const$5.set(seg, x);
    }
    public static int IdentifierSize$get(MemorySegment seg, long index) {
        return (int)constants$2439.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void IdentifierSize$set(MemorySegment seg, long index, int x) {
        constants$2439.const$5.set(seg.asSlice(index*sizeof()), x);
    }

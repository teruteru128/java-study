...
public class _CMSG_RECIPIENT_ENCODE_INFO {
    ...
    private static final AddressLayout pKeyTrans$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$7015:5"), groupElement("pKeyTrans"));
    ...
    private static final AddressLayout pKeyAgree$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$7015:5"), groupElement("pKeyAgree"));
    ...
    private static final AddressLayout pMailList$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$7015:5"), groupElement("pMailList"));

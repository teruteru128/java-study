...
public class _COMMPROP {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_SHORT.withName("wPacketLength"),
        Windows_h.C_SHORT.withName("wPacketVersion"),
        Windows_h.C_LONG.withName("dwServiceMask"),
        Windows_h.C_LONG.withName("dwReserved1"),
        Windows_h.C_LONG.withName("dwMaxTxQueue"),
        Windows_h.C_LONG.withName("dwMaxRxQueue"),
        Windows_h.C_LONG.withName("dwMaxBaud"),
        Windows_h.C_LONG.withName("dwProvSubType"),
        Windows_h.C_LONG.withName("dwProvCapabilities"),
        Windows_h.C_LONG.withName("dwSettableParams"),
        Windows_h.C_LONG.withName("dwSettableBaud"),
        Windows_h.C_SHORT.withName("wSettableData"),
        Windows_h.C_SHORT.withName("wSettableStopParity"),
        Windows_h.C_LONG.withName("dwCurrentTxQueue"),
        Windows_h.C_LONG.withName("dwCurrentRxQueue"),
        Windows_h.C_LONG.withName("dwProvSpec1"),
        Windows_h.C_LONG.withName("dwProvSpec2"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_SHORT).withName("wcProvChar"),

...
public class _DEVICE_LB_PROVISIONING_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(7, Windows_h.C_CHAR).withName("Reserved1"),
        Windows_h.C_LONG_LONG.withName("OptimalUnmapGranularity"),
        Windows_h.C_LONG_LONG.withName("UnmapGranularityAlignment"),
        Windows_h.C_LONG.withName("MaxUnmapLbaCount"),
        Windows_h.C_LONG.withName("MaxUnmapBlockDescriptorCount")

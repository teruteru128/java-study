 ...
 *     HRESULT (*QueryInterface)(IEnumSTATPROPSTG *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IEnumSTATPROPSTG *) __attribute__((stdcall));
 *     ULONG (*Release)(IEnumSTATPROPSTG *) __attribute__((stdcall));
 *     HRESULT (*Next)(IEnumSTATPROPSTG *, ULONG, STATPROPSTG *, ULONG *) __attribute__((stdcall));
 *     HRESULT (*Skip)(IEnumSTATPROPSTG *, ULONG) __attribute__((stdcall));
 *     HRESULT (*Reset)(IEnumSTATPROPSTG *) __attribute__((stdcall));
 *     HRESULT (*Clone)(IEnumSTATPROPSTG *, IEnumSTATPROPSTG **) __attribute__((stdcall));
 * }
 * }
 */

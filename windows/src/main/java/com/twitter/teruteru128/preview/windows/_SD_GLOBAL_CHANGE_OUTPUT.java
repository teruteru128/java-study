...
public class _SD_GLOBAL_CHANGE_OUTPUT {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2677.const$0;
    }
    public static VarHandle Flags$VH() {
        return constants$2677.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int Flags$get(MemorySegment seg) {
        return (int)constants$2677.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Flags$set(MemorySegment seg, int x) {
        constants$2677.const$1.set(seg, x);
    }
    public static int Flags$get(MemorySegment seg, long index) {
        return (int)constants$2677.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void Flags$set(MemorySegment seg, long index, int x) {
        constants$2677.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle ChangeType$VH() {
        return constants$2677.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int ChangeType$get(MemorySegment seg) {
        return (int)constants$2677.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void ChangeType$set(MemorySegment seg, int x) {
        constants$2677.const$2.set(seg, x);
    }
    public static int ChangeType$get(MemorySegment seg, long index) {
        return (int)constants$2677.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void ChangeType$set(MemorySegment seg, long index, int x) {
        constants$2677.const$2.set(seg.asSlice(index*sizeof()), x);
    }

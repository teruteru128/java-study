...
public class tagTYPEDESC {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("lptdesc"),
            Windows_h.C_POINTER.withName("lpadesc"),
            Windows_h.C_LONG.withName("hreftype")
    ...
    private static final AddressLayout lptdesc$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$653:36"), groupElement("lptdesc"));
    ...
    private static final AddressLayout lpadesc$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$653:36"), groupElement("lpadesc"));
    ...
    private static final OfInt hreftype$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$653:36"), groupElement("hreftype"));

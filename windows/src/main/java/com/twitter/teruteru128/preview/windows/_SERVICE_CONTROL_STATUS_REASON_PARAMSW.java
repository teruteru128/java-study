...
public class _SERVICE_CONTROL_STATUS_REASON_PARAMSW {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$4504.const$0;
    }
    public static VarHandle dwReason$VH() {
        return constants$4504.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwReason$get(MemorySegment seg) {
        return (int)constants$4504.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwReason$set(MemorySegment seg, int x) {
        constants$4504.const$1.set(seg, x);
    }
    public static int dwReason$get(MemorySegment seg, long index) {
        return (int)constants$4504.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void dwReason$set(MemorySegment seg, long index, int x) {
        constants$4504.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pszComment$VH() {
        return constants$4504.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pszComment$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$4504.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pszComment$set(MemorySegment seg, MemorySegment x) {
        constants$4504.const$2.set(seg, x);
    }
    public static MemorySegment pszComment$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$4504.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void pszComment$set(MemorySegment seg, long index, MemorySegment x) {
        constants$4504.const$2.set(seg.asSlice(index*sizeof()), x);
    }

...
public interface ICMENUMPROCW {
    ...
    static MemorySegment allocate(ICMENUMPROCW fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1068.const$2, fi, constants$39.const$3, scope);
    }
    static ICMENUMPROCW ofAddress(MemorySegment addr, Arena arena) {

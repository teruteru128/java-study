...
public class _OPEN_PRINTER_PROPS_INFOA {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1883.const$0;
    }
    public static VarHandle dwSize$VH() {
        return constants$1883.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwSize$get(MemorySegment seg) {
        return (int)constants$1883.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwSize$set(MemorySegment seg, int x) {
        constants$1883.const$1.set(seg, x);
    }
    public static int dwSize$get(MemorySegment seg, long index) {
        return (int)constants$1883.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void dwSize$set(MemorySegment seg, long index, int x) {
        constants$1883.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pszSheetName$VH() {
        return constants$1883.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pszSheetName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1883.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pszSheetName$set(MemorySegment seg, MemorySegment x) {
        constants$1883.const$2.set(seg, x);
    }
    public static MemorySegment pszSheetName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1883.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void pszSheetName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1883.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle uSheetIndex$VH() {
        return constants$1883.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int uSheetIndex$get(MemorySegment seg) {
        return (int)constants$1883.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void uSheetIndex$set(MemorySegment seg, int x) {
        constants$1883.const$3.set(seg, x);
    }
    public static int uSheetIndex$get(MemorySegment seg, long index) {
        return (int)constants$1883.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void uSheetIndex$set(MemorySegment seg, long index, int x) {
        constants$1883.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle dwFlags$VH() {
        return constants$1883.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwFlags$get(MemorySegment seg) {
        return (int)constants$1883.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwFlags$set(MemorySegment seg, int x) {
        constants$1883.const$4.set(seg, x);
    }
    public static int dwFlags$get(MemorySegment seg, long index) {
        return (int)constants$1883.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void dwFlags$set(MemorySegment seg, long index, int x) {
        constants$1883.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle bModal$VH() {
        return constants$1883.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int bModal$get(MemorySegment seg) {
        return (int)constants$1883.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void bModal$set(MemorySegment seg, int x) {
        constants$1883.const$5.set(seg, x);
    }
    public static int bModal$get(MemorySegment seg, long index) {
        return (int)constants$1883.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void bModal$set(MemorySegment seg, long index, int x) {
        constants$1883.const$5.set(seg.asSlice(index*sizeof()), x);
    }

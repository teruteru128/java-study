 ...
 * }
 */
public class tagMCI_LOAD_PARMSW {

    public static MemoryLayout $LAYOUT() {
        return constants$1567.const$5;
    }
    ...
    public static long dwCallback$get(MemorySegment seg) {
        return (long)constants$1568.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long dwCallback$get(MemorySegment seg, long index) {
        return (long)constants$1568.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment lpfilename$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1568.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpfilename$set(MemorySegment seg, MemorySegment x) {
        constants$1568.const$1.set(seg, x);
    }
    public static MemorySegment lpfilename$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1568.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void lpfilename$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1568.const$1.set(seg.asSlice(index*sizeof()), x);
    }

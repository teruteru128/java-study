...
public class _STORAGE_OPERATIONAL_REASON {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("Reason"),
    ...
    public static class RawBytes {
        ...
        public static class ScsiSenseKey {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                Windows_h.C_CHAR.withName("SenseKey"),
                Windows_h.C_CHAR.withName("ASC"),
                Windows_h.C_CHAR.withName("ASCQ"),
                Windows_h.C_CHAR.withName("Reserved")
            ).withName("$anon$2759:9");
        ...
        public static class NVDIMM_N {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                Windows_h.C_CHAR.withName("CriticalHealth"),
                MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("ModuleHealth"),
                Windows_h.C_CHAR.withName("ErrorThresholdStatus")
            ).withName("$anon$2769:9");

...
public class tagCONVINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG_LONG.withName("hUser"),
        Windows_h.C_POINTER.withName("hConvPartner"),
        Windows_h.C_POINTER.withName("hszSvcPartner"),
        Windows_h.C_POINTER.withName("hszServiceReq"),
        Windows_h.C_POINTER.withName("hszTopic"),
        Windows_h.C_POINTER.withName("hszItem"),
        Windows_h.C_INT.withName("wFmt"),
        Windows_h.C_INT.withName("wType"),
        Windows_h.C_INT.withName("wStatus"),
        Windows_h.C_INT.withName("wConvst"),
        Windows_h.C_INT.withName("wLastError"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("hConvList"),
        tagCONVCONTEXT.layout().withName("ConvCtxt"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("hwnd"),
        Windows_h.C_POINTER.withName("hwndPartner")

...
public class BITMAPV5HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("bV5Size"),
        Windows_h.C_LONG.withName("bV5Width"),
        Windows_h.C_LONG.withName("bV5Height"),
        Windows_h.C_SHORT.withName("bV5Planes"),
        Windows_h.C_SHORT.withName("bV5BitCount"),
        Windows_h.C_LONG.withName("bV5Compression"),
        Windows_h.C_LONG.withName("bV5SizeImage"),
        Windows_h.C_LONG.withName("bV5XPelsPerMeter"),
        Windows_h.C_LONG.withName("bV5YPelsPerMeter"),
        Windows_h.C_LONG.withName("bV5ClrUsed"),
        Windows_h.C_LONG.withName("bV5ClrImportant"),
        Windows_h.C_LONG.withName("bV5RedMask"),
        Windows_h.C_LONG.withName("bV5GreenMask"),
        Windows_h.C_LONG.withName("bV5BlueMask"),
        Windows_h.C_LONG.withName("bV5AlphaMask"),
        Windows_h.C_LONG.withName("bV5CSType"),
        tagICEXYZTRIPLE.layout().withName("bV5Endpoints"),
        Windows_h.C_LONG.withName("bV5GammaRed"),
        Windows_h.C_LONG.withName("bV5GammaGreen"),
        Windows_h.C_LONG.withName("bV5GammaBlue"),
        Windows_h.C_LONG.withName("bV5Intent"),
        Windows_h.C_LONG.withName("bV5ProfileData"),
        Windows_h.C_LONG.withName("bV5ProfileSize"),
        Windows_h.C_LONG.withName("bV5Reserved")
    ).withName("$anon$868:9");

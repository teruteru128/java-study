...
/**
 * {@snippet :
 * int (*PFN_CERT_STORE_PROV_GET_CTL_PROPERTY)(void* hStoreProv,struct _CTL_CONTEXT* pCtlContext,unsigned long dwPropId,unsigned long dwFlags,void* pvData,unsigned long* pcbData);
 * }
 */
public interface PFN_CERT_STORE_PROV_GET_CTL_PROPERTY {
    ...
    static MemorySegment allocate(PFN_CERT_STORE_PROV_GET_CTL_PROPERTY fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$2134.const$5, fi, constants$1489.const$2, scope);
    }
    static PFN_CERT_STORE_PROV_GET_CTL_PROPERTY ofAddress(MemorySegment addr, Arena arena) {

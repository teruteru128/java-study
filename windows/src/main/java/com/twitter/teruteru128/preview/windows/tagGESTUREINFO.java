...
public class tagGESTUREINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("dwInstanceID"),
        Windows_h.C_LONG.withName("dwSequenceID"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_LONG_LONG.withName("ullArguments"),
        Windows_h.C_INT.withName("cbExtraArgs"),
        MemoryLayout.paddingLayout(4)

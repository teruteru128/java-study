...
public class _ldiv_t {
    ...
    public static int quot$get(MemorySegment seg) {
        return (int)constants$2974.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int quot$get(MemorySegment seg, long index) {
        return (int)constants$2974.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int rem$get(MemorySegment seg) {
        return (int)constants$2974.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void rem$set(MemorySegment seg, int x) {
        constants$2974.const$4.set(seg, x);
    }
    public static int rem$get(MemorySegment seg, long index) {
        return (int)constants$2974.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void rem$set(MemorySegment seg, long index, int x) {
        constants$2974.const$4.set(seg.asSlice(index*sizeof()), x);
    }

...
public interface PSC_NOTIFICATION_CALLBACK {
    ...
    static MemorySegment allocate(PSC_NOTIFICATION_CALLBACK fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$4513.const$4, fi, constants$605.const$4, scope);
    }
    static PSC_NOTIFICATION_CALLBACK ofAddress(MemorySegment addr, Arena arena) {

...
public class _BCRYPT_DSA_KEY_BLOB {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1950.const$4;
    }
    public static VarHandle dwMagic$VH() {
        return constants$1950.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwMagic$get(MemorySegment seg) {
        return (int)constants$1950.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwMagic$set(MemorySegment seg, int x) {
        constants$1950.const$5.set(seg, x);
    }
    public static int dwMagic$get(MemorySegment seg, long index) {
        return (int)constants$1950.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void dwMagic$set(MemorySegment seg, long index, int x) {
        constants$1950.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle cbKey$VH() {
        return constants$1951.const$0;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cbKey$get(MemorySegment seg) {
        return (int)constants$1951.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cbKey$set(MemorySegment seg, int x) {
        constants$1951.const$0.set(seg, x);
    }
    public static int cbKey$get(MemorySegment seg, long index) {
        return (int)constants$1951.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void cbKey$set(MemorySegment seg, long index, int x) {
        constants$1951.const$0.set(seg.asSlice(index*sizeof()), x);
    }

...
public class _CMSG_HASHED_ENCODE_INFO {
    ...
    public static int cbSize$get(MemorySegment seg) {
        return (int)constants$2091.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int cbSize$get(MemorySegment seg, long index) {
        return (int)constants$2091.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long hCryptProv$get(MemorySegment seg) {
        return (long)constants$2091.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long hCryptProv$get(MemorySegment seg, long index) {
        return (long)constants$2091.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pvHashAuxInfo$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2091.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pvHashAuxInfo$set(MemorySegment seg, MemorySegment x) {
        constants$2091.const$4.set(seg, x);
    }
    public static MemorySegment pvHashAuxInfo$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2091.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void pvHashAuxInfo$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2091.const$4.set(seg.asSlice(index*sizeof()), x);
    }

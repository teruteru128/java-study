...
public class _IMAGE_ENCLAVE_CONFIG64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("MinimumRequiredConfigSize"),
        Windows_h.C_LONG.withName("PolicyFlags"),
        Windows_h.C_LONG.withName("NumberOfImports"),
        Windows_h.C_LONG.withName("ImportList"),
        Windows_h.C_LONG.withName("ImportEntrySize"),
        ...
        Windows_h.C_LONG.withName("ImageVersion"),
        Windows_h.C_LONG.withName("SecurityVersion"),
        Windows_h.align(Windows_h.C_LONG_LONG, 4).withName("EnclaveSize"),
        Windows_h.C_LONG.withName("NumberOfThreads"),
        Windows_h.C_LONG.withName("EnclaveFlags")

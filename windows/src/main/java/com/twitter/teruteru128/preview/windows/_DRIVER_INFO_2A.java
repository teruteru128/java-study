...
public class _DRIVER_INFO_2A {
    ...
    public static int cVersion$get(MemorySegment seg) {
        return (int)constants$2858.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int cVersion$get(MemorySegment seg, long index) {
        return (int)constants$2858.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment pName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2858.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pName$set(MemorySegment seg, MemorySegment x) {
        constants$2858.const$4.set(seg, x);
    }
    public static MemorySegment pName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2858.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void pName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2858.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pEnvironment$VH() {
        return constants$2858.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pEnvironment$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2858.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pEnvironment$set(MemorySegment seg, MemorySegment x) {
        constants$2858.const$5.set(seg, x);
    }
    public static MemorySegment pEnvironment$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2858.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void pEnvironment$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2858.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pDriverPath$VH() {
        return constants$2859.const$0;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pDriverPath$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2859.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pDriverPath$set(MemorySegment seg, MemorySegment x) {
        constants$2859.const$0.set(seg, x);
    }
    public static MemorySegment pDriverPath$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2859.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void pDriverPath$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2859.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pDataFile$VH() {
        return constants$2859.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pDataFile$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2859.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pDataFile$set(MemorySegment seg, MemorySegment x) {
        constants$2859.const$1.set(seg, x);
    }
    public static MemorySegment pDataFile$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2859.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void pDataFile$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2859.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pConfigFile$VH() {
        return constants$2859.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pConfigFile$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2859.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pConfigFile$set(MemorySegment seg, MemorySegment x) {
        constants$2859.const$2.set(seg, x);
    }
    public static MemorySegment pConfigFile$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2859.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void pConfigFile$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2859.const$2.set(seg.asSlice(index*sizeof()), x);
    }

...
public class _PORT_INFO_1W {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2897.const$5;
    }
    public static VarHandle pName$VH() {
        return constants$2898.const$0;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2898.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pName$set(MemorySegment seg, MemorySegment x) {
        constants$2898.const$0.set(seg, x);
    }
    public static MemorySegment pName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2898.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void pName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2898.const$0.set(seg.asSlice(index*sizeof()), x);
    }

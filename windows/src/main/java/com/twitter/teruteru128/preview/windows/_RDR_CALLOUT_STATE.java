...
public class _RDR_CALLOUT_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("LastError"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("LastEEInfo"),
        Windows_h.C_INT.withName("LastCalledStage"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("ServerName"),
        Windows_h.C_POINTER.withName("ServerPort"),
        Windows_h.C_POINTER.withName("RemoteUser"),
        Windows_h.C_POINTER.withName("AuthType"),
        Windows_h.C_CHAR.withName("ResourceTypePresent"),
        Windows_h.C_CHAR.withName("SessionIdPresent"),
        Windows_h.C_CHAR.withName("InterfacePresent"),
        MemoryLayout.paddingLayout(1),
        _GUID.layout().withName("ResourceType"),
        _GUID.layout().withName("SessionId"),
        _RPC_SYNTAX_IDENTIFIER.layout().withName("Interface"),
        Windows_h.C_POINTER.withName("CertContext")

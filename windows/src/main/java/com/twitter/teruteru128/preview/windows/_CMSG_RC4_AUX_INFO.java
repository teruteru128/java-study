...
public class _CMSG_RC4_AUX_INFO {
    ...
    public static int cbSize$get(MemorySegment seg) {
        return (int)constants$2090.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int cbSize$get(MemorySegment seg, long index) {
        return (int)constants$2090.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int dwBitLen$get(MemorySegment seg) {
        return (int)constants$2090.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwBitLen$get(MemorySegment seg, long index) {
        return (int)constants$2090.const$4.get(seg.asSlice(index*sizeof()));
    }

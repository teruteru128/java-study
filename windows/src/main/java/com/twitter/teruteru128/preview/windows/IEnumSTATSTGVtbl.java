 ...
 * HRESULT (*QueryInterface)(IEnumSTATSTG*,const IID*,void**);
    ...
    public interface QueryInterface {
        ...
        static MemorySegment allocate(QueryInterface fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3261.const$3, fi, constants$37.const$3, scope);
        }
    ...
    public static MemorySegment QueryInterface$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3261.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void QueryInterface$set(MemorySegment seg, MemorySegment x) {
        constants$3261.const$4.set(seg, x);
    }
    public static MemorySegment QueryInterface$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3261.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void QueryInterface$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3261.const$4.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * ULONG (*AddRef)(IEnumSTATSTG*);
    ...
    public interface AddRef {
        ...
        static MemorySegment allocate(AddRef fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3261.const$5, fi, constants$18.const$5, scope);
        }
    ...
    public static MemorySegment AddRef$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3262.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void AddRef$set(MemorySegment seg, MemorySegment x) {
        constants$3262.const$0.set(seg, x);
    }
    public static MemorySegment AddRef$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3262.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void AddRef$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3262.const$0.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * ULONG (*Release)(IEnumSTATSTG*);
    ...
    public interface Release {
        ...
        static MemorySegment allocate(Release fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3262.const$1, fi, constants$18.const$5, scope);
        }
    ...
    public static MemorySegment Release$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3262.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Release$set(MemorySegment seg, MemorySegment x) {
        constants$3262.const$2.set(seg, x);
    }
    public static MemorySegment Release$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3262.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void Release$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3262.const$2.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * HRESULT (*Next)(IEnumSTATSTG*,ULONG,STATSTG*,ULONG*);
    ...
    public interface Next {
        ...
        static MemorySegment allocate(Next fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3262.const$3, fi, constants$585.const$2, scope);
        }
    ...
    public static MemorySegment Next$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3262.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Next$set(MemorySegment seg, MemorySegment x) {
        constants$3262.const$4.set(seg, x);
    }
    public static MemorySegment Next$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3262.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void Next$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3262.const$4.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * HRESULT (*Skip)(IEnumSTATSTG*,ULONG);
    ...
    public interface Skip {
        ...
        static MemorySegment allocate(Skip fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3262.const$5, fi, constants$65.const$2, scope);
        }
    ...
    public static MemorySegment Skip$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3263.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Skip$set(MemorySegment seg, MemorySegment x) {
        constants$3263.const$0.set(seg, x);
    }
    public static MemorySegment Skip$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3263.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void Skip$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3263.const$0.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * HRESULT (*Reset)(IEnumSTATSTG*);
    ...
    public interface Reset {
        ...
        static MemorySegment allocate(Reset fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3263.const$1, fi, constants$18.const$5, scope);
        }
    ...
    public static MemorySegment Reset$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3263.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Reset$set(MemorySegment seg, MemorySegment x) {
        constants$3263.const$2.set(seg, x);
    }
    public static MemorySegment Reset$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3263.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void Reset$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3263.const$2.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * HRESULT (*Clone)(IEnumSTATSTG*,IEnumSTATSTG**);
    ...
    public interface Clone {
        ...
        static MemorySegment allocate(Clone fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3263.const$3, fi, constants$34.const$0, scope);
        }

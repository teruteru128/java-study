...
public class _DISK_EX_INT13_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_SHORT.withName("ExBufferSize"),
        Windows_h.C_SHORT.withName("ExFlags"),
        Windows_h.C_LONG.withName("ExCylinders"),
        Windows_h.C_LONG.withName("ExHeads"),
        Windows_h.C_LONG.withName("ExSectorsPerTrack"),
        Windows_h.C_LONG_LONG.withName("ExSectorsPerDrive"),
        Windows_h.C_SHORT.withName("ExSectorSize"),
        Windows_h.C_SHORT.withName("ExReserved"),

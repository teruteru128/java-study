...
public class tagHELPWININFOW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_INT.withName("wStructSize"),
        Windows_h.C_INT.withName("x"),
        Windows_h.C_INT.withName("y"),
        Windows_h.C_INT.withName("dx"),
        Windows_h.C_INT.withName("dy"),
        Windows_h.C_INT.withName("wMax"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_SHORT).withName("rgchMember")

...
public class _RPC_HTTP_TRANSPORT_CREDENTIALS_V2_W {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_POINTER.withName("TransportCredentials"),
        Windows_h.C_LONG.withName("Flags"),
        Windows_h.C_LONG.withName("AuthenticationTarget"),
        Windows_h.C_LONG.withName("NumberOfAuthnSchemes"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("AuthnSchemes"),
        Windows_h.C_POINTER.withName("ServerCertificateSubject"),
        Windows_h.C_POINTER.withName("ProxyCredentials"),
        Windows_h.C_LONG.withName("NumberOfProxyAuthnSchemes"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("ProxyAuthnSchemes")

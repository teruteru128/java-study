...
public class _devicemodeW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(32, Windows_h.C_SHORT).withName("dmDeviceName"),
        Windows_h.C_SHORT.withName("dmSpecVersion"),
        Windows_h.C_SHORT.withName("dmDriverVersion"),
        Windows_h.C_SHORT.withName("dmSize"),
        Windows_h.C_SHORT.withName("dmDriverExtra"),
        Windows_h.C_LONG.withName("dmFields"),
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                Windows_h.C_SHORT.withName("dmOrientation"),
                Windows_h.C_SHORT.withName("dmPaperSize"),
                Windows_h.C_SHORT.withName("dmPaperLength"),
                Windows_h.C_SHORT.withName("dmPaperWidth"),
                Windows_h.C_SHORT.withName("dmScale"),
                Windows_h.C_SHORT.withName("dmCopies"),
                Windows_h.C_SHORT.withName("dmDefaultSource"),
                Windows_h.C_SHORT.withName("dmPrintQuality")
            ).withName("$anon$2261:7"),
            MemoryLayout.structLayout(
                _POINTL.layout().withName("dmPosition"),
                Windows_h.C_LONG.withName("dmDisplayOrientation"),
                Windows_h.C_LONG.withName("dmDisplayFixedOutput")
            ).withName("$anon$2272:7")
        ).withName("$anon$2259:5"),
        Windows_h.C_SHORT.withName("dmColor"),
        Windows_h.C_SHORT.withName("dmDuplex"),
        Windows_h.C_SHORT.withName("dmYResolution"),
        Windows_h.C_SHORT.withName("dmTTOption"),
        Windows_h.C_SHORT.withName("dmCollate"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_SHORT).withName("dmFormName"),
        Windows_h.C_SHORT.withName("dmLogPixels"),
        Windows_h.C_LONG.withName("dmBitsPerPel"),
        Windows_h.C_LONG.withName("dmPelsWidth"),
        Windows_h.C_LONG.withName("dmPelsHeight"),
        MemoryLayout.unionLayout(
            Windows_h.C_LONG.withName("dmDisplayFlags"),
            Windows_h.C_LONG.withName("dmNup")
        ).withName("$anon$2288:5"),
        Windows_h.C_LONG.withName("dmDisplayFrequency"),
        Windows_h.C_LONG.withName("dmICMMethod"),
        Windows_h.C_LONG.withName("dmICMIntent"),
        Windows_h.C_LONG.withName("dmMediaType"),
        Windows_h.C_LONG.withName("dmDitherType"),
        Windows_h.C_LONG.withName("dmReserved1"),
        Windows_h.C_LONG.withName("dmReserved2"),
        Windows_h.C_LONG.withName("dmPanningWidth"),
        Windows_h.C_LONG.withName("dmPanningHeight")
    ...
    private static final OfShort dmOrientation$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2259:5"), groupElement("$anon$2261:7"), groupElement("dmOrientation"));
    ...
    private static final OfShort dmPaperSize$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2259:5"), groupElement("$anon$2261:7"), groupElement("dmPaperSize"));
    ...
    private static final OfShort dmPaperLength$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2259:5"), groupElement("$anon$2261:7"), groupElement("dmPaperLength"));
    ...
    private static final OfShort dmPaperWidth$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2259:5"), groupElement("$anon$2261:7"), groupElement("dmPaperWidth"));
    ...
    private static final OfShort dmScale$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2259:5"), groupElement("$anon$2261:7"), groupElement("dmScale"));
    ...
    private static final OfShort dmCopies$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2259:5"), groupElement("$anon$2261:7"), groupElement("dmCopies"));
    ...
    private static final OfShort dmDefaultSource$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2259:5"), groupElement("$anon$2261:7"), groupElement("dmDefaultSource"));
    ...
    private static final OfShort dmPrintQuality$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2259:5"), groupElement("$anon$2261:7"), groupElement("dmPrintQuality"));
    ...
    private static final GroupLayout dmPosition$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$2259:5"), groupElement("$anon$2272:7"), groupElement("dmPosition"));
    ...
    private static final OfInt dmDisplayOrientation$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2259:5"), groupElement("$anon$2272:7"), groupElement("dmDisplayOrientation"));
    ...
    private static final OfInt dmDisplayFixedOutput$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2259:5"), groupElement("$anon$2272:7"), groupElement("dmDisplayFixedOutput"));
    ...
    private static final OfInt dmDisplayFlags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2288:5"), groupElement("dmDisplayFlags"));
    ...
    private static final OfInt dmNup$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2288:5"), groupElement("dmNup"));

...
public class tagMONHSZSTRUCTA {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1541.const$0;
    }
    public static VarHandle cb$VH() {
        return constants$1541.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cb$get(MemorySegment seg) {
        return (int)constants$1541.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cb$set(MemorySegment seg, int x) {
        constants$1541.const$1.set(seg, x);
    }
    public static int cb$get(MemorySegment seg, long index) {
        return (int)constants$1541.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void cb$set(MemorySegment seg, long index, int x) {
        constants$1541.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle fsAction$VH() {
        return constants$1541.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int fsAction$get(MemorySegment seg) {
        return (int)constants$1541.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void fsAction$set(MemorySegment seg, int x) {
        constants$1541.const$2.set(seg, x);
    }
    public static int fsAction$get(MemorySegment seg, long index) {
        return (int)constants$1541.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void fsAction$set(MemorySegment seg, long index, int x) {
        constants$1541.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle dwTime$VH() {
        return constants$1541.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwTime$get(MemorySegment seg) {
        return (int)constants$1541.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwTime$set(MemorySegment seg, int x) {
        constants$1541.const$3.set(seg, x);
    }
    public static int dwTime$get(MemorySegment seg, long index) {
        return (int)constants$1541.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void dwTime$set(MemorySegment seg, long index, int x) {
        constants$1541.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle hsz$VH() {
        return constants$1541.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment hsz$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1541.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void hsz$set(MemorySegment seg, MemorySegment x) {
        constants$1541.const$4.set(seg, x);
    }
    public static MemorySegment hsz$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1541.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void hsz$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1541.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle hTask$VH() {
        return constants$1541.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment hTask$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1541.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void hTask$set(MemorySegment seg, MemorySegment x) {
        constants$1541.const$5.set(seg, x);
    }
    public static MemorySegment hTask$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1541.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void hTask$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1541.const$5.set(seg.asSlice(index*sizeof()), x);
    }

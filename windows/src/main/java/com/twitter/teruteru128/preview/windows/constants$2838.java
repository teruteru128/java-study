...
final class constants$2838 {
    ...
    static final VarHandle const$0 = constants$2836.const$0.varHandle(MemoryLayout.PathElement.groupElement("PagesPrinted"));
    ...
    static final VarHandle const$2 = constants$2838.const$1.varHandle(MemoryLayout.PathElement.groupElement("JobId"));
    static final VarHandle const$3 = constants$2838.const$1.varHandle(MemoryLayout.PathElement.groupElement("pPrinterName"));
    static final VarHandle const$4 = constants$2838.const$1.varHandle(MemoryLayout.PathElement.groupElement("pMachineName"));
    static final VarHandle const$5 = constants$2838.const$1.varHandle(MemoryLayout.PathElement.groupElement("pUserName"));
}

...
public class _CMSG_CTRL_KEY_TRANS_DECRYPT_PARA {
    ...
    private static final OfLong hCryptProv$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$8046:5"), groupElement("hCryptProv"));
    ...
    private static final OfLong hNCryptKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$8046:5"), groupElement("hNCryptKey"));
    ...
    private static final AddressLayout pKeyTrans$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("pKeyTrans"));
    ...
    private static final long pKeyTrans$OFFSET = 24;

...
public class _PUBKEYVER3 {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1925.const$3;
    }
    public static VarHandle magic$VH() {
        return constants$1925.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int magic$get(MemorySegment seg) {
        return (int)constants$1925.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void magic$set(MemorySegment seg, int x) {
        constants$1925.const$4.set(seg, x);
    }
    public static int magic$get(MemorySegment seg, long index) {
        return (int)constants$1925.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void magic$set(MemorySegment seg, long index, int x) {
        constants$1925.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle bitlenP$VH() {
        return constants$1925.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int bitlenP$get(MemorySegment seg) {
        return (int)constants$1925.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void bitlenP$set(MemorySegment seg, int x) {
        constants$1925.const$5.set(seg, x);
    }
    public static int bitlenP$get(MemorySegment seg, long index) {
        return (int)constants$1925.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void bitlenP$set(MemorySegment seg, long index, int x) {
        constants$1925.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle bitlenQ$VH() {
        return constants$1926.const$0;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int bitlenQ$get(MemorySegment seg) {
        return (int)constants$1926.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void bitlenQ$set(MemorySegment seg, int x) {
        constants$1926.const$0.set(seg, x);
    }
    public static int bitlenQ$get(MemorySegment seg, long index) {
        return (int)constants$1926.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void bitlenQ$set(MemorySegment seg, long index, int x) {
        constants$1926.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle bitlenJ$VH() {
        return constants$1926.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int bitlenJ$get(MemorySegment seg) {
        return (int)constants$1926.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void bitlenJ$set(MemorySegment seg, int x) {
        constants$1926.const$1.set(seg, x);
    }
    public static int bitlenJ$get(MemorySegment seg, long index) {
        return (int)constants$1926.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void bitlenJ$set(MemorySegment seg, long index, int x) {
        constants$1926.const$1.set(seg.asSlice(index*sizeof()), x);
    }

...
public class _SI_COPYFILE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("SourceFileNameLength"),
        Windows_h.C_LONG.withName("DestinationFileNameLength"),
        Windows_h.C_LONG.withName("Flags"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_SHORT).withName("FileNameBuffer"),

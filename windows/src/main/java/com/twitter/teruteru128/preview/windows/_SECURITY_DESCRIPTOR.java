...
public class _SECURITY_DESCRIPTOR {
    ...
    public static byte Revision$get(MemorySegment seg) {
        return (byte)constants$158.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte Revision$get(MemorySegment seg, long index) {
        return (byte)constants$158.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte Sbz1$get(MemorySegment seg) {
        return (byte)constants$158.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte Sbz1$get(MemorySegment seg, long index) {
        return (byte)constants$158.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short Control$get(MemorySegment seg) {
        return (short)constants$158.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short Control$get(MemorySegment seg, long index) {
        return (short)constants$158.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment Owner$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$158.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment Owner$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$158.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment Sacl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$159.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment Sacl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$159.const$1.get(seg.asSlice(index*sizeof()));
    }

...
public class _KCRM_PROTOCOL_BLOB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("StaticInfoLength"),
        Windows_h.C_LONG.withName("TransactionIdInfoLength"),
        Windows_h.C_LONG.withName("Unused1"),
        Windows_h.C_LONG.withName("Unused2")

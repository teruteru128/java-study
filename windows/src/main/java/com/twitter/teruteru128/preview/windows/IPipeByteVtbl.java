 ...
 *     HRESULT (*QueryInterface)(IPipeByte *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IPipeByte *) __attribute__((stdcall));
 *     ULONG (*Release)(IPipeByte *) __attribute__((stdcall));
 *     HRESULT (*Pull)(IPipeByte *, BYTE *, ULONG, ULONG *) __attribute__((stdcall));
 *     HRESULT (*Push)(IPipeByte *, BYTE *, ULONG) __attribute__((stdcall));
 * }
 * }
 */

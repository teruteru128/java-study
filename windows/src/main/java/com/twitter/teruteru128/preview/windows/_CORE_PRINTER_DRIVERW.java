...
public class _CORE_PRINTER_DRIVERW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(260, Windows_h.C_SHORT).withName("szPackageID")
     ...
     * }
     */
    public static short szPackageID(MemorySegment struct, long index0) {
        return (short)szPackageID$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void szPackageID(MemorySegment struct, long index0, short fieldValue) {

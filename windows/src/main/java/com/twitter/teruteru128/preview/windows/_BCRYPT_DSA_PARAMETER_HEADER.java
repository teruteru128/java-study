...
public class _BCRYPT_DSA_PARAMETER_HEADER {
    ...
    public static int cbLength$get(MemorySegment seg) {
        return (int)constants$1953.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cbLength$set(MemorySegment seg, int x) {
        constants$1953.const$1.set(seg, x);
    }
    public static int cbLength$get(MemorySegment seg, long index) {
        return (int)constants$1953.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void cbLength$set(MemorySegment seg, long index, int x) {
        constants$1953.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle dwMagic$VH() {
        return constants$1953.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwMagic$get(MemorySegment seg) {
        return (int)constants$1953.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwMagic$set(MemorySegment seg, int x) {
        constants$1953.const$2.set(seg, x);
    }
    public static int dwMagic$get(MemorySegment seg, long index) {
        return (int)constants$1953.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void dwMagic$set(MemorySegment seg, long index, int x) {
        constants$1953.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle cbKeyLength$VH() {
        return constants$1953.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cbKeyLength$get(MemorySegment seg) {
        return (int)constants$1953.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cbKeyLength$set(MemorySegment seg, int x) {
        constants$1953.const$3.set(seg, x);
    }
    public static int cbKeyLength$get(MemorySegment seg, long index) {
        return (int)constants$1953.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void cbKeyLength$set(MemorySegment seg, long index, int x) {
        constants$1953.const$3.set(seg.asSlice(index*sizeof()), x);
    }

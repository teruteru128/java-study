 ...
 * }
 */
public class tagEMRPOLYLINE16 {

    public static MemoryLayout $LAYOUT() {
        return constants$1083.const$2;
    }
    ...
    public static int cpts$get(MemorySegment seg) {
        return (int)constants$1083.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int cpts$get(MemorySegment seg, long index) {
        return (int)constants$1083.const$3.get(seg.asSlice(index*sizeof()));
    }

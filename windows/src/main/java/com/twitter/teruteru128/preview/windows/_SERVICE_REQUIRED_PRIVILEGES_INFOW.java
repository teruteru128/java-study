...
public class _SERVICE_REQUIRED_PRIVILEGES_INFOW {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$4483.const$1;
    }
    public static VarHandle pmszRequiredPrivileges$VH() {
        return constants$4483.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pmszRequiredPrivileges$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$4483.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pmszRequiredPrivileges$set(MemorySegment seg, MemorySegment x) {
        constants$4483.const$2.set(seg, x);
    }
    public static MemorySegment pmszRequiredPrivileges$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$4483.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void pmszRequiredPrivileges$set(MemorySegment seg, long index, MemorySegment x) {
        constants$4483.const$2.set(seg.asSlice(index*sizeof()), x);
    }

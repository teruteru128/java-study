...
public interface PFN_CERT_STORE_PROV_FIND_CRL {
    ...
    static MemorySegment allocate(PFN_CERT_STORE_PROV_FIND_CRL fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$2134.const$0, fi, constants$572.const$3, scope);
    }
    static PFN_CERT_STORE_PROV_FIND_CRL ofAddress(MemorySegment addr, Arena arena) {

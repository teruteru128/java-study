...
public interface CODEPAGE_ENUMPROCW {
    ...
    static MemorySegment allocate(CODEPAGE_ENUMPROCW fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1421.const$0, fi, constants$18.const$5, scope);
    }
    static CODEPAGE_ENUMPROCW ofAddress(MemorySegment addr, Arena arena) {

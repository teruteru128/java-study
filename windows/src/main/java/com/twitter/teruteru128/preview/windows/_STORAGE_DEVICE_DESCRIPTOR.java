...
public class _STORAGE_DEVICE_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_CHAR.withName("DeviceType"),
        Windows_h.C_CHAR.withName("DeviceTypeModifier"),
        Windows_h.C_CHAR.withName("RemovableMedia"),
        Windows_h.C_CHAR.withName("CommandQueueing"),
        Windows_h.C_LONG.withName("VendorIdOffset"),
        Windows_h.C_LONG.withName("ProductIdOffset"),
        Windows_h.C_LONG.withName("ProductRevisionOffset"),
        Windows_h.C_LONG.withName("SerialNumberOffset"),
        Windows_h.C_INT.withName("BusType"),
        Windows_h.C_LONG.withName("RawPropertiesLength"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_CHAR).withName("RawDeviceProperties"),

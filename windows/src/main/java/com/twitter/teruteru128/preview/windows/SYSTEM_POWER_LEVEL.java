...
public class SYSTEM_POWER_LEVEL {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("Enable"),
        MemoryLayout.sequenceLayout(3, Windows_h.C_CHAR).withName("Spare"),
        Windows_h.C_LONG.withName("BatteryLevel"),
        POWER_ACTION_POLICY.layout().withName("PowerPolicy"),
        Windows_h.C_INT.withName("MinSystemState")
    ).withName("$anon$17660:9");

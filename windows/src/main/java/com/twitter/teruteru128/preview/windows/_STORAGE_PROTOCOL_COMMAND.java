...
public class _STORAGE_PROTOCOL_COMMAND {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("ReturnStatus"),
        Windows_h.C_LONG.withName("ErrorCode"),
        Windows_h.C_LONG.withName("CommandLength"),
        Windows_h.C_LONG.withName("ErrorInfoLength"),
        Windows_h.C_LONG.withName("DataToDeviceTransferLength"),
        Windows_h.C_LONG.withName("DataFromDeviceTransferLength"),
        Windows_h.C_LONG.withName("TimeOutValue"),
        Windows_h.C_LONG.withName("ErrorInfoOffset"),
        Windows_h.C_LONG.withName("DataToDeviceBufferOffset"),
        Windows_h.C_LONG.withName("DataFromDeviceBufferOffset"),
        Windows_h.C_LONG.withName("CommandSpecific"),
        Windows_h.C_LONG.withName("Reserved0"),
        Windows_h.C_LONG.withName("FixedProtocolReturnData"),
        MemoryLayout.sequenceLayout(3, Windows_h.C_LONG).withName("Reserved1"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_CHAR).withName("Command"),

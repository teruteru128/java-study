...
public class USN_JOURNAL_DATA_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("UsnJournalID"),
        Windows_h.C_LONG_LONG.withName("FirstUsn"),
        Windows_h.C_LONG_LONG.withName("NextUsn"),
        Windows_h.C_LONG_LONG.withName("LowestValidUsn"),
        Windows_h.C_LONG_LONG.withName("MaxUsn"),
        Windows_h.C_LONG_LONG.withName("MaximumSize"),
        Windows_h.C_LONG_LONG.withName("AllocationDelta"),
        Windows_h.C_SHORT.withName("MinSupportedMajorVersion"),
        Windows_h.C_SHORT.withName("MaxSupportedMajorVersion"),
        Windows_h.C_LONG.withName("Flags"),
        Windows_h.C_LONG_LONG.withName("RangeTrackChunkSize"),
        Windows_h.C_LONG_LONG.withName("RangeTrackFileSizeThreshold")
    ).withName("$anon$11690:9");

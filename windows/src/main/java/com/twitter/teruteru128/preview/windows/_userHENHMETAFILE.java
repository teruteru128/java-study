...
public class _userHENHMETAFILE {
    ...
    public static final class __MIDL_IWinTypes_0006 {
        ...
        public static int hInproc$get(MemorySegment seg) {
            return (int)constants$2356.const$0.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static int hInproc$get(MemorySegment seg, long index) {
            return (int)constants$2356.const$0.get(seg.asSlice(index*sizeof()));
        }
        ...
        public static MemorySegment hRemote$get(MemorySegment seg) {
            return (java.lang.foreign.MemorySegment)constants$2356.const$1.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static MemorySegment hRemote$get(MemorySegment seg, long index) {
            return (java.lang.foreign.MemorySegment)constants$2356.const$1.get(seg.asSlice(index*sizeof()));
        }
        ...
        public static long hInproc64$get(MemorySegment seg) {
            return (long)constants$2356.const$2.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static long hInproc64$get(MemorySegment seg, long index) {
            return (long)constants$2356.const$2.get(seg.asSlice(index*sizeof()));
        }

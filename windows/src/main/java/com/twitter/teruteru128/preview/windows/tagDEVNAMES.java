...
public class tagDEVNAMES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_SHORT.withName("wDriverOffset"),
        Windows_h.C_SHORT.withName("wDeviceOffset"),
        Windows_h.C_SHORT.withName("wOutputOffset"),
        Windows_h.C_SHORT.withName("wDefault")

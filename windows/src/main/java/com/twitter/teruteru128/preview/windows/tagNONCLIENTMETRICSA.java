...
public class tagNONCLIENTMETRICSA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("iBorderWidth"),
        Windows_h.C_INT.withName("iScrollWidth"),
        Windows_h.C_INT.withName("iScrollHeight"),
        Windows_h.C_INT.withName("iCaptionWidth"),
        Windows_h.C_INT.withName("iCaptionHeight"),
        tagLOGFONTA.layout().withName("lfCaptionFont"),
        Windows_h.C_INT.withName("iSmCaptionWidth"),
        Windows_h.C_INT.withName("iSmCaptionHeight"),
        tagLOGFONTA.layout().withName("lfSmCaptionFont"),
        Windows_h.C_INT.withName("iMenuWidth"),
        Windows_h.C_INT.withName("iMenuHeight"),
        tagLOGFONTA.layout().withName("lfMenuFont"),
        tagLOGFONTA.layout().withName("lfStatusFont"),
        tagLOGFONTA.layout().withName("lfMessageFont"),
        Windows_h.C_INT.withName("iPaddedBorderWidth")

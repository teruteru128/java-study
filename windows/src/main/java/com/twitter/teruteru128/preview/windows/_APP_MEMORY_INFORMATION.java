...
public class _APP_MEMORY_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("AvailableCommit"),
        Windows_h.C_LONG_LONG.withName("PrivateCommitUsage"),
        Windows_h.C_LONG_LONG.withName("PeakPrivateCommitUsage"),
        Windows_h.C_LONG_LONG.withName("TotalCommitUsage")

...
public class _CMSG_SIGNED_ENCODE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("cSigners"),
        Windows_h.C_POINTER.withName("rgSigners"),
        Windows_h.C_LONG.withName("cCertEncoded"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rgCertEncoded"),
        Windows_h.C_LONG.withName("cCrlEncoded"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rgCrlEncoded")

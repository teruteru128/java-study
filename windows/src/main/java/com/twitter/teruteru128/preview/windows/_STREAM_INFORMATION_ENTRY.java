    ...
    public static class _StreamInformation {
        ...
        public static class _DataStream {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                ...
                Windows_h.C_LONG_LONG.withName("Vdl")
        ...
        public static class _Reparse {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                Windows_h.C_SHORT.withName("Length"),
                Windows_h.C_SHORT.withName("Flags"),
                Windows_h.C_LONG.withName("ReparseDataSize"),
                Windows_h.C_LONG.withName("ReparseDataOffset")
            ).withName("_Reparse");
        ...
        public static class _Ea {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                Windows_h.C_SHORT.withName("Length"),
                Windows_h.C_SHORT.withName("Flags"),
                Windows_h.C_LONG.withName("EaSize"),
                Windows_h.C_LONG.withName("EaInformationOffset")
            ).withName("_Ea");

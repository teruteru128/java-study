...
public class CM_Power_Data_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("PD_Size"),
        Windows_h.C_INT.withName("PD_MostRecentPowerState"),
        Windows_h.C_LONG.withName("PD_Capabilities"),
        Windows_h.C_LONG.withName("PD_D1Latency"),
        Windows_h.C_LONG.withName("PD_D2Latency"),
        Windows_h.C_LONG.withName("PD_D3Latency"),
        MemoryLayout.sequenceLayout(7, Windows_h.C_INT).withName("PD_PowerStateMapping"),
        Windows_h.C_INT.withName("PD_DeepestSystemWake")

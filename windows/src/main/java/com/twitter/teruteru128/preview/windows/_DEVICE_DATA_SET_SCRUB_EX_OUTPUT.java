...
public class _DEVICE_DATA_SET_SCRUB_EX_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("BytesProcessed"),
        Windows_h.C_LONG_LONG.withName("BytesRepaired"),
        Windows_h.C_LONG_LONG.withName("BytesFailed"),
        _DEVICE_DATA_SET_RANGE.layout().withName("ParityExtent"),
        Windows_h.C_LONG_LONG.withName("BytesScrubbed")
    ...
    private static final OfLong BytesScrubbed$LAYOUT = (OfLong)$LAYOUT.select(groupElement("BytesScrubbed"));
     ...
     * }
     */
    public static final OfLong BytesScrubbed$layout() {
        return BytesScrubbed$LAYOUT;
    }

    private static final long BytesScrubbed$OFFSET = 40;
     ...
     * }
     */
    public static final long BytesScrubbed$offset() {
        return BytesScrubbed$OFFSET;
    }
     ...
     * }
     */
    public static long BytesScrubbed(MemorySegment struct) {
        return struct.get(BytesScrubbed$LAYOUT, BytesScrubbed$OFFSET);
    }
     ...
     * }
     */
    public static void BytesScrubbed(MemorySegment struct, long fieldValue) {
        struct.set(BytesScrubbed$LAYOUT, BytesScrubbed$OFFSET, fieldValue);
    }

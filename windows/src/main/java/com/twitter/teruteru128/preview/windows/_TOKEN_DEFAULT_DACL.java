...
public class _TOKEN_DEFAULT_DACL {
    ...
    public static MemorySegment DefaultDacl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$166.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment DefaultDacl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$166.const$3.get(seg.asSlice(index*sizeof()));
    }

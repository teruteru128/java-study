...
public class _CERT_BASIC_CONSTRAINTS_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("fPathLenConstraint"),
        Windows_h.C_LONG.withName("dwPathLenConstraint"),
        Windows_h.C_LONG.withName("cSubtreesConstraint"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rgSubtreesConstraint")

...
public class _SHELLEXECUTEINFOW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("fMask"),
        Windows_h.C_POINTER.withName("hwnd"),
        Windows_h.C_POINTER.withName("lpVerb"),
        Windows_h.C_POINTER.withName("lpFile"),
        Windows_h.C_POINTER.withName("lpParameters"),
        Windows_h.C_POINTER.withName("lpDirectory"),
        Windows_h.C_INT.withName("nShow"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("hInstApp"),
        Windows_h.C_POINTER.withName("lpIDList"),
        Windows_h.C_POINTER.withName("lpClass"),
        Windows_h.C_POINTER.withName("hkeyClass"),
        Windows_h.C_LONG.withName("dwHotKey"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("hIcon"),
            Windows_h.C_POINTER.withName("hMonitor")
        ).withName("$anon$484:5"),
        Windows_h.C_POINTER.withName("hProcess")
    ...
    private static final AddressLayout hIcon$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$484:5"), groupElement("hIcon"));
    ...
    private static final AddressLayout hMonitor$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$484:5"), groupElement("hMonitor"));

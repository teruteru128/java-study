...
public class DISPLAYCONFIG_VIDEO_SIGNAL_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("pixelRate"),
        ...
        MemoryLayout.unionLayout(
            ...
            Windows_h.C_INT.withName("videoStandard")
        ).withName("$anon$2854:5"),
        Windows_h.C_INT.withName("scanLineOrdering")
    ...
    private static final GroupLayout AdditionalSignalInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$2854:5"), groupElement("AdditionalSignalInfo"));
    ...
    private static final OfInt videoStandard$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2854:5"), groupElement("videoStandard"));

...
public class _CERT_REVOCATION_PARA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("pIssuerCert"),
        Windows_h.C_LONG.withName("cCertStore"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rgCertStore"),
        Windows_h.C_POINTER.withName("hCrlStore"),
        Windows_h.C_POINTER.withName("pftTimeToUse")

...
public class RPC_INTERFACE_TEMPLATEW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("IfSpec"),
        Windows_h.C_POINTER.withName("MgrTypeUuid"),
        Windows_h.C_POINTER.withName("MgrEpv"),
        Windows_h.C_INT.withName("Flags"),
        Windows_h.C_INT.withName("MaxCalls"),
        Windows_h.C_INT.withName("MaxRpcSize"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("IfCallback"),
        Windows_h.C_POINTER.withName("UuidVector"),
        Windows_h.C_POINTER.withName("Annotation"),
    ...
    public static class IfCallback {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(IfCallback.Function.class, "apply", $DESC);

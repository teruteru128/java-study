...
public class DISPLAYCONFIG_TARGET_DEVICE_NAME {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_SHORT.withName("edidManufactureId"),
        Windows_h.C_SHORT.withName("edidProductCodeId"),
        Windows_h.C_INT.withName("connectorInstance"),
        MemoryLayout.sequenceLayout(64, Windows_h.C_SHORT).withName("monitorFriendlyDeviceName"),
        MemoryLayout.sequenceLayout(128, Windows_h.C_SHORT).withName("monitorDevicePath")

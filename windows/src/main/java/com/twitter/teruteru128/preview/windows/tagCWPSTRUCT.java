...
public class tagCWPSTRUCT {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1141.const$5;
    }
    public static VarHandle lParam$VH() {
        return constants$1142.const$0;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long lParam$get(MemorySegment seg) {
        return (long)constants$1142.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lParam$set(MemorySegment seg, long x) {
        constants$1142.const$0.set(seg, x);
    }
    public static long lParam$get(MemorySegment seg, long index) {
        return (long)constants$1142.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void lParam$set(MemorySegment seg, long index, long x) {
        constants$1142.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle wParam$VH() {
        return constants$1142.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long wParam$get(MemorySegment seg) {
        return (long)constants$1142.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void wParam$set(MemorySegment seg, long x) {
        constants$1142.const$1.set(seg, x);
    }
    public static long wParam$get(MemorySegment seg, long index) {
        return (long)constants$1142.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void wParam$set(MemorySegment seg, long index, long x) {
        constants$1142.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle message$VH() {
        return constants$1142.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int message$get(MemorySegment seg) {
        return (int)constants$1142.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void message$set(MemorySegment seg, int x) {
        constants$1142.const$2.set(seg, x);
    }
    public static int message$get(MemorySegment seg, long index) {
        return (int)constants$1142.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void message$set(MemorySegment seg, long index, int x) {
        constants$1142.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle hwnd$VH() {
        return constants$1142.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment hwnd$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1142.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void hwnd$set(MemorySegment seg, MemorySegment x) {
        constants$1142.const$3.set(seg, x);
    }
    public static MemorySegment hwnd$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1142.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void hwnd$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1142.const$3.set(seg.asSlice(index*sizeof()), x);
    }

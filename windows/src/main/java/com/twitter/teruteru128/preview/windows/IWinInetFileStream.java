...
public class IWinInetFileStream {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$4140.const$2;
    }
    public static VarHandle lpVtbl$VH() {
        return constants$4140.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$4140.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        constants$4140.const$3.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$4140.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        constants$4140.const$3.set(seg.asSlice(index*sizeof()), x);
    }

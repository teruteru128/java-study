...
public class _JOBOBJECT_BASIC_PROCESS_ID_LIST {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("NumberOfAssignedProcesses"),
        Windows_h.C_LONG.withName("NumberOfProcessIdsInList"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_LONG_LONG).withName("ProcessIdList")

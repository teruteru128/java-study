...
public class tagWNDCLASSEXA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("style"),
        Windows_h.C_POINTER.withName("lpfnWndProc"),
        Windows_h.C_INT.withName("cbClsExtra"),
        Windows_h.C_INT.withName("cbWndExtra"),
        Windows_h.C_POINTER.withName("hInstance"),
        Windows_h.C_POINTER.withName("hIcon"),
        Windows_h.C_POINTER.withName("hCursor"),
        Windows_h.C_POINTER.withName("hbrBackground"),
        Windows_h.C_POINTER.withName("lpszMenuName"),
        Windows_h.C_POINTER.withName("lpszClassName"),
        Windows_h.C_POINTER.withName("hIconSm")

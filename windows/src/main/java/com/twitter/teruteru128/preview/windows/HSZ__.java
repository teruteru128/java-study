...
public class HSZ__ {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1525.const$1;
    }
    public static VarHandle unused$VH() {
        return constants$1525.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int unused$get(MemorySegment seg) {
        return (int)constants$1525.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void unused$set(MemorySegment seg, int x) {
        constants$1525.const$2.set(seg, x);
    }
    public static int unused$get(MemorySegment seg, long index) {
        return (int)constants$1525.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void unused$set(MemorySegment seg, long index, int x) {
        constants$1525.const$2.set(seg.asSlice(index*sizeof()), x);
    }

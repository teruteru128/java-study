...
public class _PERF_COUNTER_DEFINITION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("CounterNameTitleIndex"),
        Windows_h.C_LONG.withName("CounterNameTitle"),
        Windows_h.C_LONG.withName("CounterHelpTitleIndex"),
        Windows_h.C_LONG.withName("CounterHelpTitle"),
        Windows_h.C_LONG.withName("DefaultScale"),
        Windows_h.C_LONG.withName("DetailLevel"),
        Windows_h.C_LONG.withName("CounterType"),
        Windows_h.C_LONG.withName("CounterSize"),
        Windows_h.C_LONG.withName("CounterOffset")

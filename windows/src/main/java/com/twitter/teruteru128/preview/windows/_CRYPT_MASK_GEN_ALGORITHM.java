...
public class _CRYPT_MASK_GEN_ALGORITHM {
    ...
    public static MemorySegment pszObjId$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2046.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pszObjId$set(MemorySegment seg, MemorySegment x) {
        constants$2046.const$2.set(seg, x);
    }
    public static MemorySegment pszObjId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2046.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void pszObjId$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2046.const$2.set(seg.asSlice(index*sizeof()), x);
    }

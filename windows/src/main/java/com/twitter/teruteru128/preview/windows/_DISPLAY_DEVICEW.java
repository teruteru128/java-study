...
public class _DISPLAY_DEVICEW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, Windows_h.C_SHORT).withName("DeviceName"),
        MemoryLayout.sequenceLayout(128, Windows_h.C_SHORT).withName("DeviceString"),
        Windows_h.C_LONG.withName("StateFlags"),
        MemoryLayout.sequenceLayout(128, Windows_h.C_SHORT).withName("DeviceID"),
        MemoryLayout.sequenceLayout(128, Windows_h.C_SHORT).withName("DeviceKey")

...
final class constants$1613 {
    ...
    static final VarHandle const$0 = constants$1612.const$0.varHandle(MemoryLayout.PathElement.groupElement("wReserved1"));
    static final VarHandle const$1 = constants$1612.const$0.varHandle(MemoryLayout.PathElement.groupElement("dwSupport"));
    ...
    static final VarHandle const$3 = constants$1613.const$2.varHandle(MemoryLayout.PathElement.groupElement("wMid"));
    static final VarHandle const$4 = constants$1613.const$2.varHandle(MemoryLayout.PathElement.groupElement("wPid"));
    static final VarHandle const$5 = constants$1613.const$2.varHandle(MemoryLayout.PathElement.groupElement("vDriverVersion"));
}

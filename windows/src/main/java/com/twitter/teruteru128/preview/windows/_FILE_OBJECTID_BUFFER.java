...
public class _FILE_OBJECTID_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("ObjectId"),
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("BirthVolumeId"),
                MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("BirthObjectId"),
                MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("DomainId")
            ).withName("$anon$12373:9"),
            MemoryLayout.sequenceLayout(48, Windows_h.C_CHAR).withName("ExtendedInfo")
    ...
    private static final SequenceLayout BirthVolumeId$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$12372:5"), groupElement("$anon$12373:9"), groupElement("BirthVolumeId"));
    ...
    private static final SequenceLayout BirthObjectId$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$12372:5"), groupElement("$anon$12373:9"), groupElement("BirthObjectId"));
    ...
    private static final SequenceLayout DomainId$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$12372:5"), groupElement("$anon$12373:9"), groupElement("DomainId"));
    ...
    private static final SequenceLayout ExtendedInfo$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$12372:5"), groupElement("ExtendedInfo"));

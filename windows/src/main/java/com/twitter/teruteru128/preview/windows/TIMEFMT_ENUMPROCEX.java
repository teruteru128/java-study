...
public interface TIMEFMT_ENUMPROCEX {
    ...
    static MemorySegment allocate(TIMEFMT_ENUMPROCEX fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1446.const$5, fi, constants$39.const$3, scope);
    }
    static TIMEFMT_ENUMPROCEX ofAddress(MemorySegment addr, Arena arena) {

...
public interface WINSTAENUMPROCW {
    ...
    static MemorySegment allocate(WINSTAENUMPROCW fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1137.const$1, fi, constants$39.const$3, scope);
    }
    static WINSTAENUMPROCW ofAddress(MemorySegment addr, Arena arena) {

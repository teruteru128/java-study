...
final class constants$3905 {

    // Suppresses default constructor, ensuring non-instantiability.
    private constants$3905() {}
    static final MemorySegment const$0 = RuntimeHelper.lookupGlobalVariable("IID_IXMLDOMProcessingInstruction", constants$27.const$0);
    static final StructLayout const$1 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("get_target"),
        RuntimeHelper.POINTER.withName("get_data"),
        RuntimeHelper.POINTER.withName("put_data")
    ).withName("IXMLDOMProcessingInstructionVtbl");
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(IXMLDOMProcessingInstructionVtbl.QueryInterface.class, "apply", constants$37.const$3);
    static final VarHandle const$3 = constants$3905.const$1.varHandle(MemoryLayout.PathElement.groupElement("QueryInterface"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(IXMLDOMProcessingInstructionVtbl.AddRef.class, "apply", constants$18.const$5);
    static final VarHandle const$5 = constants$3905.const$1.varHandle(MemoryLayout.PathElement.groupElement("AddRef"));
}

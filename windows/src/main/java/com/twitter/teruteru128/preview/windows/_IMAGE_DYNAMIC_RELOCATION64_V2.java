...
public class _IMAGE_DYNAMIC_RELOCATION64_V2 {
    ...
    public static int HeaderSize$get(MemorySegment seg) {
        return (int)constants$420.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int HeaderSize$get(MemorySegment seg, long index) {
        return (int)constants$420.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int FixupInfoSize$get(MemorySegment seg) {
        return (int)constants$420.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void FixupInfoSize$set(MemorySegment seg, int x) {
        constants$420.const$3.set(seg, x);
    }
    public static int FixupInfoSize$get(MemorySegment seg, long index) {
        return (int)constants$420.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void FixupInfoSize$set(MemorySegment seg, long index, int x) {
        constants$420.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static long Symbol$get(MemorySegment seg) {
        return (long)constants$420.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long Symbol$get(MemorySegment seg, long index) {
        return (long)constants$420.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int SymbolGroup$get(MemorySegment seg) {
        return (int)constants$420.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int SymbolGroup$get(MemorySegment seg, long index) {
        return (int)constants$420.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int Flags$get(MemorySegment seg) {
        return (int)constants$421.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int Flags$get(MemorySegment seg, long index) {
        return (int)constants$421.const$0.get(seg.asSlice(index*sizeof()));
    }

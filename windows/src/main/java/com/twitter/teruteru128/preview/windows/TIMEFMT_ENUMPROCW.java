...
public interface TIMEFMT_ENUMPROCW {
    ...
    static MemorySegment allocate(TIMEFMT_ENUMPROCW fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1421.const$3, fi, constants$18.const$5, scope);
    }
    static TIMEFMT_ENUMPROCW ofAddress(MemorySegment addr, Arena arena) {

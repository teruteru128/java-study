...
public class _BIDI_REQUEST_CONTAINER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, _BIDI_REQUEST_DATA.layout()).withName("aData")
    ...
    public static void aData(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, aData(struct, index0), 0L, _BIDI_REQUEST_DATA.layout().byteSize());
    }

...
final class constants$3955 {

    // Suppresses default constructor, ensuring non-instantiability.
    private constants$3955() {}
    static final MemorySegment const$0 = RuntimeHelper.lookupGlobalVariable("IID_IXMLDOMNotation", constants$27.const$0);
    static final StructLayout const$1 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("get_publicId"),
        RuntimeHelper.POINTER.withName("get_systemId")
    ).withName("IXMLDOMNotationVtbl");
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(IXMLDOMNotationVtbl.QueryInterface.class, "apply", constants$37.const$3);
    static final VarHandle const$3 = constants$3955.const$1.varHandle(MemoryLayout.PathElement.groupElement("QueryInterface"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(IXMLDOMNotationVtbl.AddRef.class, "apply", constants$18.const$5);
    static final VarHandle const$5 = constants$3955.const$1.varHandle(MemoryLayout.PathElement.groupElement("AddRef"));
}

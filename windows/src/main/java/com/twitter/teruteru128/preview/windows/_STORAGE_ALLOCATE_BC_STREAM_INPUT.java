...
public class _STORAGE_ALLOCATE_BC_STREAM_INPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("RequestsPerPeriod"),
        Windows_h.C_LONG.withName("Period"),
        Windows_h.C_CHAR.withName("RetryFailures"),
        Windows_h.C_CHAR.withName("Discardable"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("Reserved1"),
        Windows_h.C_LONG.withName("AccessType"),
        Windows_h.C_LONG.withName("AccessMode")

...
public interface LOCALE_ENUMPROCEX {
    ...
    static MemorySegment allocate(LOCALE_ENUMPROCEX fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1447.const$1, fi, constants$509.const$1, scope);
    }
    static LOCALE_ENUMPROCEX ofAddress(MemorySegment addr, Arena arena) {

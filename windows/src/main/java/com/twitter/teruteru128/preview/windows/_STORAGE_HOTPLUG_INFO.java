...
public class _STORAGE_HOTPLUG_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_CHAR.withName("MediaRemovable"),
        Windows_h.C_CHAR.withName("MediaHotplug"),
        Windows_h.C_CHAR.withName("DeviceHotplug"),
        Windows_h.C_CHAR.withName("WriteCacheEnableOverride")

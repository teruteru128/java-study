...
public class IDataFilter {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$4310.const$3;
    }
    public static VarHandle lpVtbl$VH() {
        return constants$4310.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$4310.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        constants$4310.const$4.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$4310.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        constants$4310.const$4.set(seg.asSlice(index*sizeof()), x);
    }

...
public class _SSL_F12_EXTRA_CERT_CHAIN_POLICY_STATUS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("dwErrorLevel"),
        Windows_h.C_LONG.withName("dwErrorCategory"),
        Windows_h.C_LONG.withName("dwReserved"),
        MemoryLayout.sequenceLayout(256, Windows_h.C_SHORT).withName("wszErrorText")

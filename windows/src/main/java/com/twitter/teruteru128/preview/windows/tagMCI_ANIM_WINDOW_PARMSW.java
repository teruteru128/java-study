...
public class tagMCI_ANIM_WINDOW_PARMSW {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1583.const$2;
    }
    public static VarHandle dwCallback$VH() {
        return constants$1583.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static long dwCallback$get(MemorySegment seg) {
        return (long)constants$1583.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwCallback$set(MemorySegment seg, long x) {
        constants$1583.const$3.set(seg, x);
    }
    public static long dwCallback$get(MemorySegment seg, long index) {
        return (long)constants$1583.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void dwCallback$set(MemorySegment seg, long index, long x) {
        constants$1583.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle hWnd$VH() {
        return constants$1583.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment hWnd$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1583.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void hWnd$set(MemorySegment seg, MemorySegment x) {
        constants$1583.const$4.set(seg, x);
    }
    public static MemorySegment hWnd$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1583.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void hWnd$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1583.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle nCmdShow$VH() {
        return constants$1583.const$5;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int nCmdShow$get(MemorySegment seg) {
        return (int)constants$1583.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void nCmdShow$set(MemorySegment seg, int x) {
        constants$1583.const$5.set(seg, x);
    }
    public static int nCmdShow$get(MemorySegment seg, long index) {
        return (int)constants$1583.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void nCmdShow$set(MemorySegment seg, long index, int x) {
        constants$1583.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle lpstrText$VH() {
        return constants$1584.const$0;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpstrText$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1584.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpstrText$set(MemorySegment seg, MemorySegment x) {
        constants$1584.const$0.set(seg, x);
    }
    public static MemorySegment lpstrText$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1584.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void lpstrText$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1584.const$0.set(seg.asSlice(index*sizeof()), x);
    }

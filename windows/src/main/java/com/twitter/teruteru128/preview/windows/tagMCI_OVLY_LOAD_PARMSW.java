...
public class tagMCI_OVLY_LOAD_PARMSW {
    ...
    public static long dwCallback$get(MemorySegment seg) {
        return (long)constants$1591.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwCallback$set(MemorySegment seg, long x) {
        constants$1591.const$2.set(seg, x);
    }
    public static long dwCallback$get(MemorySegment seg, long index) {
        return (long)constants$1591.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void dwCallback$set(MemorySegment seg, long index, long x) {
        constants$1591.const$2.set(seg.asSlice(index*sizeof()), x);
    }

...
/**
 * {@snippet :
 * int (*PFN_CERT_STORE_PROV_FREE_FIND_CERT)(void* hStoreProv,struct _CERT_CONTEXT* pCertContext,void* pvStoreProvFindInfo,unsigned long dwFlags);
 * }
 */
public interface PFN_CERT_STORE_PROV_FREE_FIND_CERT {
    ...
    static MemorySegment allocate(PFN_CERT_STORE_PROV_FREE_FIND_CERT fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$2133.const$2, fi, constants$607.const$3, scope);
    }
    static PFN_CERT_STORE_PROV_FREE_FIND_CERT ofAddress(MemorySegment addr, Arena arena) {

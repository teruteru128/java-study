...
public class tagMCI_PLAY_PARMS {
    ...
    public static long dwCallback$get(MemorySegment seg) {
        return (long)constants$1559.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwCallback$set(MemorySegment seg, long x) {
        constants$1559.const$1.set(seg, x);
    }
    public static long dwCallback$get(MemorySegment seg, long index) {
        return (long)constants$1559.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void dwCallback$set(MemorySegment seg, long index, long x) {
        constants$1559.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle dwFrom$VH() {
        return constants$1559.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwFrom$get(MemorySegment seg) {
        return (int)constants$1559.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwFrom$set(MemorySegment seg, int x) {
        constants$1559.const$2.set(seg, x);
    }
    public static int dwFrom$get(MemorySegment seg, long index) {
        return (int)constants$1559.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void dwFrom$set(MemorySegment seg, long index, int x) {
        constants$1559.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int dwTo$get(MemorySegment seg) {
        return (int)constants$1559.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwTo$get(MemorySegment seg, long index) {
        return (int)constants$1559.const$3.get(seg.asSlice(index*sizeof()));
    }

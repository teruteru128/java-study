 ...
 * }
 */
public class tagMCI_SEEK_PARMS {
    ...
    public static long dwCallback$get(MemorySegment seg) {
        return (long)constants$1559.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long dwCallback$get(MemorySegment seg, long index) {
        return (long)constants$1559.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int dwTo$get(MemorySegment seg) {
        return (int)constants$1560.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwTo$get(MemorySegment seg, long index) {
        return (int)constants$1560.const$0.get(seg.asSlice(index*sizeof()));
    }

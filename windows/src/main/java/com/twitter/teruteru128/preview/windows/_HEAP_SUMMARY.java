...
public class _HEAP_SUMMARY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG_LONG.withName("cbAllocated"),
        Windows_h.C_LONG_LONG.withName("cbCommitted"),
        Windows_h.C_LONG_LONG.withName("cbReserved"),
        Windows_h.C_LONG_LONG.withName("cbMaxReserve")

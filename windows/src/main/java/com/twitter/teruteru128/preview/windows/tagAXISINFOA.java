...
public class tagAXISINFOA {
    ...
    public static int axMinValue$get(MemorySegment seg) {
        return (int)constants$1025.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int axMinValue$get(MemorySegment seg, long index) {
        return (int)constants$1025.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int axMaxValue$get(MemorySegment seg) {
        return (int)constants$1025.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int axMaxValue$get(MemorySegment seg, long index) {
        return (int)constants$1025.const$3.get(seg.asSlice(index*sizeof()));
    }

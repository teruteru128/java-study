...
public class tagPELARRAY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("paXCount"),
        Windows_h.C_LONG.withName("paYCount"),
        Windows_h.C_LONG.withName("paXExt"),
        Windows_h.C_LONG.withName("paYExt"),
        Windows_h.C_CHAR.withName("paRGBs"),

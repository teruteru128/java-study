...
public class _STORAGE_PHYSICAL_TOPOLOGY_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("NodeCount"),
    ...
    private static final long NodeCount$OFFSET = 8;
    ...
    private static final SequenceLayout Node$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("Node"));
     ...
     * }
     */
    public static final SequenceLayout Node$layout() {
        return Node$LAYOUT;
    }

    private static final long Node$OFFSET = 16;
    ...
    private static long[] Node$DIMS = { 1 };
     ...
     * }
     */
    public static long[] Node$dimensions() {
        return Node$DIMS;
    }
    private static final MethodHandle Node$ELEM_HANDLE = Node$LAYOUT.sliceHandle(sequenceElement());
     ...
     * }
     */
    public static MemorySegment Node(MemorySegment struct, long index0) {
        try {
            return (MemorySegment)Node$ELEM_HANDLE.invokeExact(struct, 0L, index0);
        } catch (Throwable ex$) {
     ...
     * }
     */
    public static void Node(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, Node(struct, index0), 0L, _STORAGE_PHYSICAL_NODE_DATA.layout().byteSize());
    }

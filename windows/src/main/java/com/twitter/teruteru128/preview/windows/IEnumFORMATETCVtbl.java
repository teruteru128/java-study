 ...
 *     HRESULT (*QueryInterface)(IEnumFORMATETC *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IEnumFORMATETC *) __attribute__((stdcall));
 *     ULONG (*Release)(IEnumFORMATETC *) __attribute__((stdcall));
 *     HRESULT (*Next)(IEnumFORMATETC *, ULONG, FORMATETC *, ULONG *) __attribute__((stdcall));
 *     HRESULT (*Skip)(IEnumFORMATETC *, ULONG) __attribute__((stdcall));
 *     HRESULT (*Reset)(IEnumFORMATETC *) __attribute__((stdcall));
 *     HRESULT (*Clone)(IEnumFORMATETC *, IEnumFORMATETC **) __attribute__((stdcall));
 * }
 * }
 */

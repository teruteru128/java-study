...
public interface CS_TYPE_LOCAL_SIZE_ROUTINE {
    ...
    static MemorySegment allocate(CS_TYPE_LOCAL_SIZE_ROUTINE fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$2284.const$1, fi, constants$2283.const$4, scope);
    }
    static CS_TYPE_LOCAL_SIZE_ROUTINE ofAddress(MemorySegment addr, Arena arena) {

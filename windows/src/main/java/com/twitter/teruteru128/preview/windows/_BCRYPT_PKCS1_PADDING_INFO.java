...
public class _BCRYPT_PKCS1_PADDING_INFO {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1940.const$2;
    }
    public static VarHandle pszAlgId$VH() {
        return constants$1940.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pszAlgId$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1940.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pszAlgId$set(MemorySegment seg, MemorySegment x) {
        constants$1940.const$3.set(seg, x);
    }
    public static MemorySegment pszAlgId$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1940.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void pszAlgId$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1940.const$3.set(seg.asSlice(index*sizeof()), x);
    }

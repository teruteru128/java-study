...
public class _ENCRYPTED_DATA_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("StartingFileOffset"),
        Windows_h.C_LONG.withName("OutputBufferOffset"),
        Windows_h.C_LONG.withName("BytesWithinFileSize"),
        Windows_h.C_LONG.withName("BytesWithinValidDataLength"),
        Windows_h.C_SHORT.withName("CompressionFormat"),
        Windows_h.C_CHAR.withName("DataUnitShift"),
        Windows_h.C_CHAR.withName("ChunkShift"),
        Windows_h.C_CHAR.withName("ClusterShift"),
        Windows_h.C_CHAR.withName("EncryptionFormat"),
        Windows_h.C_SHORT.withName("NumberOfDataBlocks"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_LONG).withName("DataBlockSize")

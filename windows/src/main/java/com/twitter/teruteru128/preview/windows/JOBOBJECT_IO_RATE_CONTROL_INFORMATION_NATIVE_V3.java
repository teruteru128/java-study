...
public class JOBOBJECT_IO_RATE_CONTROL_INFORMATION_NATIVE_V3 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("MaxIops"),
        Windows_h.C_LONG_LONG.withName("MaxBandwidth"),
        Windows_h.C_LONG_LONG.withName("ReservationIops"),
        Windows_h.C_POINTER.withName("VolumeName"),
        Windows_h.C_LONG.withName("BaseIoSize"),
        Windows_h.C_INT.withName("ControlFlags"),
        Windows_h.C_SHORT.withName("VolumeNameLength"),
        MemoryLayout.paddingLayout(6),
        Windows_h.C_LONG_LONG.withName("CriticalReservationIops"),
        Windows_h.C_LONG_LONG.withName("ReservationBandwidth"),
        Windows_h.C_LONG_LONG.withName("CriticalReservationBandwidth"),
        Windows_h.C_LONG_LONG.withName("MaxTimePercent"),
        Windows_h.C_LONG_LONG.withName("ReservationTimePercent"),
        Windows_h.C_LONG_LONG.withName("CriticalReservationTimePercent"),
        Windows_h.C_LONG_LONG.withName("SoftMaxIops"),
        Windows_h.C_LONG_LONG.withName("SoftMaxBandwidth"),
        Windows_h.C_LONG_LONG.withName("SoftMaxTimePercent"),
        Windows_h.C_LONG_LONG.withName("LimitExcessNotifyIops"),
        Windows_h.C_LONG_LONG.withName("LimitExcessNotifyBandwidth"),
        Windows_h.C_LONG_LONG.withName("LimitExcessNotifyTimePercent")

...
public class _SSL_HPKP_HEADER_EXTRA_CERT_CHAIN_POLICY_PARA {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2226.const$0;
    }
    public static VarHandle cbSize$VH() {
        return constants$2226.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cbSize$get(MemorySegment seg) {
        return (int)constants$2226.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cbSize$set(MemorySegment seg, int x) {
        constants$2226.const$1.set(seg, x);
    }
    public static int cbSize$get(MemorySegment seg, long index) {
        return (int)constants$2226.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void cbSize$set(MemorySegment seg, long index, int x) {
        constants$2226.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle dwReserved$VH() {
        return constants$2226.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int dwReserved$get(MemorySegment seg) {
        return (int)constants$2226.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwReserved$set(MemorySegment seg, int x) {
        constants$2226.const$2.set(seg, x);
    }
    public static int dwReserved$get(MemorySegment seg, long index) {
        return (int)constants$2226.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void dwReserved$set(MemorySegment seg, long index, int x) {
        constants$2226.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pwszServerName$VH() {
        return constants$2226.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pwszServerName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2226.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pwszServerName$set(MemorySegment seg, MemorySegment x) {
        constants$2226.const$3.set(seg, x);
    }
    public static MemorySegment pwszServerName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2226.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void pwszServerName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2226.const$3.set(seg.asSlice(index*sizeof()), x);
    }

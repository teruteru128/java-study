...
public class _WIN32_FIND_DATAA {
    ...
    public static int dwFileAttributes$get(MemorySegment seg) {
        return (int)constants$555.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwFileAttributes$get(MemorySegment seg, long index) {
        return (int)constants$555.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int nFileSizeHigh$get(MemorySegment seg) {
        return (int)constants$555.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int nFileSizeHigh$get(MemorySegment seg, long index) {
        return (int)constants$555.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int nFileSizeLow$get(MemorySegment seg) {
        return (int)constants$555.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int nFileSizeLow$get(MemorySegment seg, long index) {
        return (int)constants$555.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int dwReserved0$get(MemorySegment seg) {
        return (int)constants$555.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwReserved0$get(MemorySegment seg, long index) {
        return (int)constants$555.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int dwReserved1$get(MemorySegment seg) {
        return (int)constants$555.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwReserved1$get(MemorySegment seg, long index) {
        return (int)constants$555.const$4.get(seg.asSlice(index*sizeof()));
    }

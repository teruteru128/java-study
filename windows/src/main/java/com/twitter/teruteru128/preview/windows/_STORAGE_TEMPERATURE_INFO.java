...
public class _STORAGE_TEMPERATURE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_SHORT.withName("Index"),
        Windows_h.C_SHORT.withName("Temperature"),
        Windows_h.C_SHORT.withName("OverThreshold"),
        Windows_h.C_SHORT.withName("UnderThreshold"),
        Windows_h.C_CHAR.withName("OverThresholdChangable"),
        Windows_h.C_CHAR.withName("UnderThresholdChangable"),
        Windows_h.C_CHAR.withName("EventGenerated"),

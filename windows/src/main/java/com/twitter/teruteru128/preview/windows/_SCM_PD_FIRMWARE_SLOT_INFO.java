...
public class _SCM_PD_FIRMWARE_SLOT_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_CHAR.withName("SlotNumber"),
        MemoryLayout.paddingLayout(1),
        MemoryLayout.sequenceLayout(6, Windows_h.C_CHAR).withName("Reserved1"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("Revision")

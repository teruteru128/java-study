...
public class _CHANGER_ELEMENT_STATUS {
    ...
    public static int Flags$get(MemorySegment seg) {
        return (int)constants$2568.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Flags$set(MemorySegment seg, int x) {
        constants$2568.const$0.set(seg, x);
    }
    public static int Flags$get(MemorySegment seg, long index) {
        return (int)constants$2568.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void Flags$set(MemorySegment seg, long index, int x) {
        constants$2568.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle ExceptionCode$VH() {
        return constants$2568.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int ExceptionCode$get(MemorySegment seg) {
        return (int)constants$2568.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void ExceptionCode$set(MemorySegment seg, int x) {
        constants$2568.const$1.set(seg, x);
    }
    public static int ExceptionCode$get(MemorySegment seg, long index) {
        return (int)constants$2568.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void ExceptionCode$set(MemorySegment seg, long index, int x) {
        constants$2568.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static byte TargetId$get(MemorySegment seg) {
        return (byte)constants$2568.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void TargetId$set(MemorySegment seg, byte x) {
        constants$2568.const$2.set(seg, x);
    }
    public static byte TargetId$get(MemorySegment seg, long index) {
        return (byte)constants$2568.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void TargetId$set(MemorySegment seg, long index, byte x) {
        constants$2568.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static byte Lun$get(MemorySegment seg) {
        return (byte)constants$2568.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte Lun$get(MemorySegment seg, long index) {
        return (byte)constants$2568.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short Reserved$get(MemorySegment seg) {
        return (short)constants$2568.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Reserved$set(MemorySegment seg, short x) {
        constants$2568.const$4.set(seg, x);
    }
    public static short Reserved$get(MemorySegment seg, long index) {
        return (short)constants$2568.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void Reserved$set(MemorySegment seg, long index, short x) {
        constants$2568.const$4.set(seg.asSlice(index*sizeof()), x);
    }

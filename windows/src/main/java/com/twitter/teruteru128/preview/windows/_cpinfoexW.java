...
public class _cpinfoexW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_INT.withName("MaxCharSize"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("DefaultChar"),
        MemoryLayout.sequenceLayout(12, Windows_h.C_CHAR).withName("LeadByte"),
        Windows_h.C_SHORT.withName("UnicodeDefaultChar"),
        Windows_h.C_INT.withName("CodePage"),
        MemoryLayout.sequenceLayout(260, Windows_h.C_SHORT).withName("CodePageName")
    ).withName("_cpinfoexW");

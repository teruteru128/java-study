 ...
 *     HRESULT (*QueryInterface)(IXMLDOMCharacterData *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IXMLDOMCharacterData *) __attribute__((stdcall));
 *     ULONG (*Release)(IXMLDOMCharacterData *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfoCount)(IXMLDOMCharacterData *, UINT *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfo)(IXMLDOMCharacterData *, UINT, LCID, ITypeInfo **) __attribute__((stdcall));
 *     HRESULT (*GetIDsOfNames)(IXMLDOMCharacterData *, const IID *const, LPOLESTR *, UINT, LCID, DISPID *) __attribute__((stdcall));
 *     HRESULT (*Invoke)(IXMLDOMCharacterData *, DISPID, const IID *const, LCID, WORD, DISPPARAMS *, VARIANT *, EXCEPINFO *, UINT *) __attribute__((stdcall));
 *     HRESULT (*get_nodeName)(IXMLDOMCharacterData *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_nodeValue)(IXMLDOMCharacterData *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_nodeValue)(IXMLDOMCharacterData *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_nodeType)(IXMLDOMCharacterData *, DOMNodeType *) __attribute__((stdcall));
 *     HRESULT (*get_parentNode)(IXMLDOMCharacterData *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_childNodes)(IXMLDOMCharacterData *, IXMLDOMNodeList **) __attribute__((stdcall));
 *     HRESULT (*get_firstChild)(IXMLDOMCharacterData *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_lastChild)(IXMLDOMCharacterData *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_previousSibling)(IXMLDOMCharacterData *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nextSibling)(IXMLDOMCharacterData *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_attributes)(IXMLDOMCharacterData *, IXMLDOMNamedNodeMap **) __attribute__((stdcall));
 *     HRESULT (*insertBefore)(IXMLDOMCharacterData *, IXMLDOMNode *, VARIANT, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*replaceChild)(IXMLDOMCharacterData *, IXMLDOMNode *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*removeChild)(IXMLDOMCharacterData *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*appendChild)(IXMLDOMCharacterData *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*hasChildNodes)(IXMLDOMCharacterData *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_ownerDocument)(IXMLDOMCharacterData *, IXMLDOMDocument **) __attribute__((stdcall));
 *     HRESULT (*cloneNode)(IXMLDOMCharacterData *, VARIANT_BOOL, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nodeTypeString)(IXMLDOMCharacterData *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_text)(IXMLDOMCharacterData *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*put_text)(IXMLDOMCharacterData *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_specified)(IXMLDOMCharacterData *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_definition)(IXMLDOMCharacterData *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nodeTypedValue)(IXMLDOMCharacterData *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_nodeTypedValue)(IXMLDOMCharacterData *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_dataType)(IXMLDOMCharacterData *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_dataType)(IXMLDOMCharacterData *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_xml)(IXMLDOMCharacterData *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*transformNode)(IXMLDOMCharacterData *, IXMLDOMNode *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*selectNodes)(IXMLDOMCharacterData *, BSTR, IXMLDOMNodeList **) __attribute__((stdcall));
 *     HRESULT (*selectSingleNode)(IXMLDOMCharacterData *, BSTR, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_parsed)(IXMLDOMCharacterData *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_namespaceURI)(IXMLDOMCharacterData *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_prefix)(IXMLDOMCharacterData *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_baseName)(IXMLDOMCharacterData *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*transformNodeToObject)(IXMLDOMCharacterData *, IXMLDOMNode *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_data)(IXMLDOMCharacterData *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*put_data)(IXMLDOMCharacterData *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_length)(IXMLDOMCharacterData *, long *) __attribute__((stdcall));
 *     HRESULT (*substringData)(IXMLDOMCharacterData *, long, long, BSTR *) __attribute__((stdcall));
 *     HRESULT (*appendData)(IXMLDOMCharacterData *, BSTR) __attribute__((stdcall));
 *     HRESULT (*insertData)(IXMLDOMCharacterData *, long, BSTR) __attribute__((stdcall));
 *     HRESULT (*deleteData)(IXMLDOMCharacterData *, long, long) __attribute__((stdcall));
 *     HRESULT (*replaceData)(IXMLDOMCharacterData *, long, long, BSTR) __attribute__((stdcall));
 * }
 * }
 */

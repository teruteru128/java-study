...
public class joyinfo_tag {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.align(Windows_h.C_INT, 1).withName("wXpos"),
        Windows_h.align(Windows_h.C_INT, 1).withName("wYpos"),
        Windows_h.align(Windows_h.C_INT, 1).withName("wZpos"),
        Windows_h.align(Windows_h.C_INT, 1).withName("wButtons")

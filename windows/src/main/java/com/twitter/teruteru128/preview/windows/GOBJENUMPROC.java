...
public interface GOBJENUMPROC {
    ...
    static MemorySegment allocate(GOBJENUMPROC fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$994.const$3, fi, constants$39.const$3, scope);
    }
    static GOBJENUMPROC ofAddress(MemorySegment addr, Arena arena) {

...
public class tagEMRGLSRECORD {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1110.const$3;
    }
    public static MemorySegment emr$slice(MemorySegment seg) {
        return seg.asSlice(0, 8);
    }
    public static VarHandle cbData$VH() {
        return constants$1110.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int cbData$get(MemorySegment seg) {
        return (int)constants$1110.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cbData$set(MemorySegment seg, int x) {
        constants$1110.const$4.set(seg, x);
    }
    public static int cbData$get(MemorySegment seg, long index) {
        return (int)constants$1110.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void cbData$set(MemorySegment seg, long index, int x) {
        constants$1110.const$4.set(seg.asSlice(index*sizeof()), x);
    }

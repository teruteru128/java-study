...
public class _CRYPT_X942_OTHER_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_POINTER.withName("pszContentEncryptionObjId"),
        MemoryLayout.sequenceLayout(4, Windows_h.C_CHAR).withName("rgbCounter"),
        MemoryLayout.sequenceLayout(4, Windows_h.C_CHAR).withName("rgbKeyLength"),

...
public class _IMAGE_SECTION_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(8, Windows_h.C_CHAR).withName("Name"),
        _IMAGE_SECTION_HEADER.Misc.layout().withName("Misc"),
        Windows_h.C_LONG.withName("VirtualAddress"),
        Windows_h.C_LONG.withName("SizeOfRawData"),
        Windows_h.C_LONG.withName("PointerToRawData"),
        Windows_h.C_LONG.withName("PointerToRelocations"),
        Windows_h.C_LONG.withName("PointerToLinenumbers"),
    ...
    public static class Misc {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            Windows_h.C_LONG.withName("PhysicalAddress"),
            Windows_h.C_LONG.withName("VirtualSize")
        ).withName("$anon$18422:5");

...
public interface LPENCLAVE_TARGET_FUNCTION {
    ...
    static MemorySegment allocate(LPENCLAVE_TARGET_FUNCTION fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$250.const$5, fi, constants$33.const$3, scope);
    }
    static LPENCLAVE_TARGET_FUNCTION ofAddress(MemorySegment addr, Arena arena) {

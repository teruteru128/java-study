...
public class _IDEREGS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("bFeaturesReg"),
        Windows_h.C_CHAR.withName("bSectorCountReg"),
        Windows_h.C_CHAR.withName("bSectorNumberReg"),
        Windows_h.C_CHAR.withName("bCylLowReg"),
        Windows_h.C_CHAR.withName("bCylHighReg"),
        Windows_h.C_CHAR.withName("bDriveHeadReg"),
        Windows_h.C_CHAR.withName("bCommandReg"),

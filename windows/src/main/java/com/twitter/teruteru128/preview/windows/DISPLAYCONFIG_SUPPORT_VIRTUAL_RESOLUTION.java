 ...
 *     union {
 *         struct {
 *              *             UINT32 disableMonitorVirtualResolution;
 *             UINT32 reserved;
 *         };
 *         UINT32 value;
 *     };
...
public class DISPLAYCONFIG_SUPPORT_VIRTUAL_RESOLUTION {
    ...
    public static int value$get(MemorySegment seg) {
        return (int)constants$966.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int value$get(MemorySegment seg, long index) {
        return (int)constants$966.const$4.get(seg.asSlice(index*sizeof()));
    }

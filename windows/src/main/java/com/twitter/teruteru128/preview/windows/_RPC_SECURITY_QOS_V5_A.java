...
public class _RPC_SECURITY_QOS_V5_A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("Capabilities"),
        Windows_h.C_LONG.withName("IdentityTracking"),
        Windows_h.C_LONG.withName("ImpersonationType"),
        Windows_h.C_LONG.withName("AdditionalSecurityInfoType"),
        MemoryLayout.paddingLayout(4),
        _RPC_SECURITY_QOS_V5_A.u.layout().withName("u"),
        Windows_h.C_POINTER.withName("Sid"),
        Windows_h.C_INT.withName("EffectiveOnly"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("ServerSecurityDescriptor")
    ...
    public static class u {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("HttpCredentials")
        ).withName("$anon$1927:3");
    ...
    private static final AddressLayout ServerSecurityDescriptor$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("ServerSecurityDescriptor"));
     ...
     * }
     */
    public static final AddressLayout ServerSecurityDescriptor$layout() {
        return ServerSecurityDescriptor$LAYOUT;
    }

    private static final long ServerSecurityDescriptor$OFFSET = 48;
     ...
     * }
     */
    public static final long ServerSecurityDescriptor$offset() {
        return ServerSecurityDescriptor$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment ServerSecurityDescriptor(MemorySegment struct) {
        return struct.get(ServerSecurityDescriptor$LAYOUT, ServerSecurityDescriptor$OFFSET);
    }
     ...
     * }
     */
    public static void ServerSecurityDescriptor(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(ServerSecurityDescriptor$LAYOUT, ServerSecurityDescriptor$OFFSET, fieldValue);
    }

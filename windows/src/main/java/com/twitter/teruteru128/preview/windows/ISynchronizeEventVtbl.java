 ...
 * HRESULT (*QueryInterface)(ISynchronizeEvent*,const IID*,void**);
    ...
    public interface QueryInterface {
        ...
        static MemorySegment allocate(QueryInterface fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3118.const$5, fi, constants$37.const$3, scope);
        }
 ...
 * ULONG (*AddRef)(ISynchronizeEvent*);
    ...
    public interface AddRef {
        ...
        static MemorySegment allocate(AddRef fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3119.const$1, fi, constants$18.const$5, scope);
        }
 ...
 * ULONG (*Release)(ISynchronizeEvent*);
    ...
    public interface Release {
        ...
        static MemorySegment allocate(Release fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3119.const$3, fi, constants$18.const$5, scope);
        }
 ...
 * HRESULT (*GetHandle)(ISynchronizeEvent*,HANDLE*);
    ...
    public interface GetHandle {
        ...
        static MemorySegment allocate(GetHandle fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3119.const$5, fi, constants$34.const$0, scope);
        }
 ...
 * HRESULT (*SetEventHandle)(ISynchronizeEvent*,HANDLE*);
    ...
    public interface SetEventHandle {
        ...
        int apply(java.lang.foreign.MemorySegment _x0, java.lang.foreign.MemorySegment _x1);
        static MemorySegment allocate(SetEventHandle fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3120.const$1, fi, constants$34.const$0, scope);
        }
        static SetEventHandle ofAddress(MemorySegment addr, Arena arena) {
            MemorySegment symbol = addr.reinterpret(arena, null);
            return (java.lang.foreign.MemorySegment __x0, java.lang.foreign.MemorySegment __x1) -> {
                try {
                    return (int)constants$92.const$2.invokeExact(symbol, __x0, __x1);
    ...
    public static MemorySegment SetEventHandle$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3120.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void SetEventHandle$set(MemorySegment seg, MemorySegment x) {
        constants$3120.const$2.set(seg, x);
    }
    public static MemorySegment SetEventHandle$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3120.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void SetEventHandle$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3120.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    public static SetEventHandle SetEventHandle(MemorySegment segment, Arena scope) {

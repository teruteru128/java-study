...
public class _TRANSACTION_PROPERTIES_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("IsolationLevel"),
        Windows_h.C_LONG.withName("IsolationFlags"),
        _LARGE_INTEGER.layout().withName("Timeout"),
        Windows_h.C_LONG.withName("Outcome"),
        Windows_h.C_LONG.withName("DescriptionLength"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_SHORT).withName("Description"),

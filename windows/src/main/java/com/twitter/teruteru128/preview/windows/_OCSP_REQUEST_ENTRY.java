...
public class _OCSP_REQUEST_ENTRY {
    ...
    public static int cExtension$get(MemorySegment seg) {
        return (int)constants$2066.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void cExtension$set(MemorySegment seg, int x) {
        constants$2066.const$3.set(seg, x);
    }
    public static int cExtension$get(MemorySegment seg, long index) {
        return (int)constants$2066.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void cExtension$set(MemorySegment seg, long index, int x) {
        constants$2066.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle rgExtension$VH() {
        return constants$2066.const$4;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment rgExtension$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2066.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void rgExtension$set(MemorySegment seg, MemorySegment x) {
        constants$2066.const$4.set(seg, x);
    }
    public static MemorySegment rgExtension$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2066.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void rgExtension$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2066.const$4.set(seg.asSlice(index*sizeof()), x);
    }

...
public class _FILE_ID_BOTH_DIR_INFO {
    ...
    public static int NextEntryOffset$get(MemorySegment seg) {
        return (int)constants$870.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int FileIndex$get(MemorySegment seg) {
        return (int)constants$870.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void FileIndex$set(MemorySegment seg, int x) {
        constants$870.const$5.set(seg, x);
    }
    public static int FileIndex$get(MemorySegment seg, long index) {
        return (int)constants$870.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void FileIndex$set(MemorySegment seg, long index, int x) {
        constants$870.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int FileAttributes$get(MemorySegment seg) {
        return (int)constants$871.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void FileAttributes$set(MemorySegment seg, int x) {
        constants$871.const$0.set(seg, x);
    }
    public static int FileAttributes$get(MemorySegment seg, long index) {
        return (int)constants$871.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void FileAttributes$set(MemorySegment seg, long index, int x) {
        constants$871.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int FileNameLength$get(MemorySegment seg) {
        return (int)constants$871.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void FileNameLength$set(MemorySegment seg, int x) {
        constants$871.const$1.set(seg, x);
    }
    public static int FileNameLength$get(MemorySegment seg, long index) {
        return (int)constants$871.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void FileNameLength$set(MemorySegment seg, long index, int x) {
        constants$871.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static byte ShortNameLength$get(MemorySegment seg) {
        return (byte)constants$871.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte ShortNameLength$get(MemorySegment seg, long index) {
        return (byte)constants$871.const$3.get(seg.asSlice(index*sizeof()));
    }

...
public class _SCM_PD_PASSTHROUGH_OUTPUT {
    ...
    public static int Version$get(MemorySegment seg) {
        return (int)constants$2529.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int Version$get(MemorySegment seg, long index) {
        return (int)constants$2529.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int Size$get(MemorySegment seg) {
        return (int)constants$2529.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int Size$get(MemorySegment seg, long index) {
        return (int)constants$2529.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int DataSize$get(MemorySegment seg) {
        return (int)constants$2529.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int DataSize$get(MemorySegment seg, long index) {
        return (int)constants$2529.const$2.get(seg.asSlice(index*sizeof()));
    }

...
public class PPM_WMI_PERF_STATES {
    ...
    public static byte BusyAdjThreshold$get(MemorySegment seg) {
        return (byte)constants$315.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte BusyAdjThreshold$get(MemorySegment seg, long index) {
        return (byte)constants$315.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte PolicyType$get(MemorySegment seg) {
        return (byte)constants$316.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte PolicyType$get(MemorySegment seg, long index) {
        return (byte)constants$316.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte Type$get(MemorySegment seg) {
        return (byte)constants$316.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte Type$get(MemorySegment seg, long index) {
        return (byte)constants$316.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte Reserved$get(MemorySegment seg) {
        return (byte)constants$316.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte Reserved$get(MemorySegment seg, long index) {
        return (byte)constants$316.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long TargetProcessors$get(MemorySegment seg) {
        return (long)constants$316.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long TargetProcessors$get(MemorySegment seg, long index) {
        return (long)constants$316.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int FeedbackHandler$get(MemorySegment seg) {
        return (int)constants$317.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int FeedbackHandler$get(MemorySegment seg, long index) {
        return (int)constants$317.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int Reserved1$get(MemorySegment seg) {
        return (int)constants$317.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int Reserved1$get(MemorySegment seg, long index) {
        return (int)constants$317.const$4.get(seg.asSlice(index*sizeof()));
    }

...
public class _DOC_INFO_1W {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$2886.const$0;
    }
    public static VarHandle pDocName$VH() {
        return constants$2886.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pDocName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2886.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pDocName$set(MemorySegment seg, MemorySegment x) {
        constants$2886.const$1.set(seg, x);
    }
    public static MemorySegment pDocName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2886.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void pDocName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2886.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pOutputFile$VH() {
        return constants$2886.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pOutputFile$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2886.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pOutputFile$set(MemorySegment seg, MemorySegment x) {
        constants$2886.const$2.set(seg, x);
    }
    public static MemorySegment pOutputFile$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2886.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void pOutputFile$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2886.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle pDatatype$VH() {
        return constants$2886.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment pDatatype$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2886.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pDatatype$set(MemorySegment seg, MemorySegment x) {
        constants$2886.const$3.set(seg, x);
    }
    public static MemorySegment pDatatype$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2886.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void pDatatype$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2886.const$3.set(seg.asSlice(index*sizeof()), x);
    }

...
public class _STORAGE_GET_BC_PROPERTIES_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("MaximumRequestsPerPeriod"),
        Windows_h.C_LONG.withName("MinimumPeriod"),
        Windows_h.C_LONG_LONG.withName("MaximumRequestSize"),
        Windows_h.C_LONG.withName("EstimatedTimePerRequest"),
        Windows_h.C_LONG.withName("NumOutStandingRequests"),
        Windows_h.C_LONG_LONG.withName("RequestSize")

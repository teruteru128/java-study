...
public class _CMC_TAGGED_ATTRIBUTE {
    ...
    public static int dwBodyPartID$get(MemorySegment seg) {
        return (int)constants$2047.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwBodyPartID$set(MemorySegment seg, int x) {
        constants$2047.const$4.set(seg, x);
    }
    public static int dwBodyPartID$get(MemorySegment seg, long index) {
        return (int)constants$2047.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void dwBodyPartID$set(MemorySegment seg, long index, int x) {
        constants$2047.const$4.set(seg.asSlice(index*sizeof()), x);
    }

...
public class BITMAPV4HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("bV4Size"),
        Windows_h.C_LONG.withName("bV4Width"),
        Windows_h.C_LONG.withName("bV4Height"),
        Windows_h.C_SHORT.withName("bV4Planes"),
        Windows_h.C_SHORT.withName("bV4BitCount"),
        Windows_h.C_LONG.withName("bV4V4Compression"),
        Windows_h.C_LONG.withName("bV4SizeImage"),
        Windows_h.C_LONG.withName("bV4XPelsPerMeter"),
        Windows_h.C_LONG.withName("bV4YPelsPerMeter"),
        Windows_h.C_LONG.withName("bV4ClrUsed"),
        Windows_h.C_LONG.withName("bV4ClrImportant"),
        Windows_h.C_LONG.withName("bV4RedMask"),
        Windows_h.C_LONG.withName("bV4GreenMask"),
        Windows_h.C_LONG.withName("bV4BlueMask"),
        Windows_h.C_LONG.withName("bV4AlphaMask"),
        Windows_h.C_LONG.withName("bV4CSType"),
        tagICEXYZTRIPLE.layout().withName("bV4Endpoints"),
        Windows_h.C_LONG.withName("bV4GammaRed"),
        Windows_h.C_LONG.withName("bV4GammaGreen"),
        Windows_h.C_LONG.withName("bV4GammaBlue")
    ).withName("$anon$837:9");

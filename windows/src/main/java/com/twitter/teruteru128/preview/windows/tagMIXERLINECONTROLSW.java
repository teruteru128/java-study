...
public class tagMIXERLINECONTROLSW {
    ...
    private static final OfInt dwControlID$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2234:5"), groupElement("dwControlID"));
    ...
    private static final OfInt dwControlType$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2234:5"), groupElement("dwControlType"));

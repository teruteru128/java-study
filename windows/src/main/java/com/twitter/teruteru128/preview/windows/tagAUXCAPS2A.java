...
public class tagAUXCAPS2A {
    ...
    public static short wMid$get(MemorySegment seg) {
        return (short)constants$1653.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short wMid$get(MemorySegment seg, long index) {
        return (short)constants$1653.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short wPid$get(MemorySegment seg) {
        return (short)constants$1653.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short wPid$get(MemorySegment seg, long index) {
        return (short)constants$1653.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int vDriverVersion$get(MemorySegment seg) {
        return (int)constants$1653.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int vDriverVersion$get(MemorySegment seg, long index) {
        return (int)constants$1653.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short wTechnology$get(MemorySegment seg) {
        return (short)constants$1654.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short wTechnology$get(MemorySegment seg, long index) {
        return (short)constants$1654.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short wReserved1$get(MemorySegment seg) {
        return (short)constants$1654.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short wReserved1$get(MemorySegment seg, long index) {
        return (short)constants$1654.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int dwSupport$get(MemorySegment seg) {
        return (int)constants$1654.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwSupport$get(MemorySegment seg, long index) {
        return (int)constants$1654.const$2.get(seg.asSlice(index*sizeof()));
    }

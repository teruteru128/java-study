...
public class _currencyfmtA {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$1413.const$2;
    }
    public static VarHandle NumDigits$VH() {
        return constants$1413.const$3;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int NumDigits$get(MemorySegment seg) {
        return (int)constants$1413.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void NumDigits$set(MemorySegment seg, int x) {
        constants$1413.const$3.set(seg, x);
    }
    public static int NumDigits$get(MemorySegment seg, long index) {
        return (int)constants$1413.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void NumDigits$set(MemorySegment seg, long index, int x) {
        constants$1413.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int LeadingZero$get(MemorySegment seg) {
        return (int)constants$1413.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void LeadingZero$set(MemorySegment seg, int x) {
        constants$1413.const$4.set(seg, x);
    }
    public static int LeadingZero$get(MemorySegment seg, long index) {
        return (int)constants$1413.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void LeadingZero$set(MemorySegment seg, long index, int x) {
        constants$1413.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static MemorySegment lpDecimalSep$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1414.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpDecimalSep$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1414.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment lpThousandSep$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1414.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpThousandSep$set(MemorySegment seg, MemorySegment x) {
        constants$1414.const$1.set(seg, x);
    }
    public static MemorySegment lpThousandSep$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1414.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void lpThousandSep$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1414.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int NegativeOrder$get(MemorySegment seg) {
        return (int)constants$1414.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int NegativeOrder$get(MemorySegment seg, long index) {
        return (int)constants$1414.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment lpCurrencySymbol$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1414.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment lpCurrencySymbol$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1414.const$4.get(seg.asSlice(index*sizeof()));
    }

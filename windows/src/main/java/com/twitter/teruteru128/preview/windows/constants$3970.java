...
final class constants$3970 {

    // Suppresses default constructor, ensuring non-instantiability.
    private constants$3970() {}
    static final MethodHandle const$0 = RuntimeHelper.upcallHandle(IXMLDOMNotationVtbl.get_systemId.class, "apply", constants$34.const$0);
    static final VarHandle const$1 = constants$3955.const$1.varHandle(MemoryLayout.PathElement.groupElement("get_systemId"));
    static final StructLayout const$2 = MemoryLayout.structLayout(
        RuntimeHelper.POINTER.withName("lpVtbl")
    ).withName("IXMLDOMNotation");
    static final VarHandle const$3 = constants$3970.const$2.varHandle(MemoryLayout.PathElement.groupElement("lpVtbl"));
    static final MemorySegment const$4 = RuntimeHelper.lookupGlobalVariable("IID_IXMLDOMEntity", constants$27.const$0);
    static final StructLayout const$5 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("get_notationName")

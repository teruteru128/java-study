...
public class tagAUXCAPSA {
    ...
    public static short wMid$get(MemorySegment seg) {
        return (short)constants$1651.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short wMid$get(MemorySegment seg, long index) {
        return (short)constants$1651.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short wPid$get(MemorySegment seg) {
        return (short)constants$1651.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void wPid$set(MemorySegment seg, short x) {
        constants$1651.const$2.set(seg, x);
    }
    public static short wPid$get(MemorySegment seg, long index) {
        return (short)constants$1651.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void wPid$set(MemorySegment seg, long index, short x) {
        constants$1651.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int vDriverVersion$get(MemorySegment seg) {
        return (int)constants$1651.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int vDriverVersion$get(MemorySegment seg, long index) {
        return (int)constants$1651.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short wTechnology$get(MemorySegment seg) {
        return (short)constants$1651.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void wTechnology$set(MemorySegment seg, short x) {
        constants$1651.const$4.set(seg, x);
    }
    public static short wTechnology$get(MemorySegment seg, long index) {
        return (short)constants$1651.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void wTechnology$set(MemorySegment seg, long index, short x) {
        constants$1651.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static short wReserved1$get(MemorySegment seg) {
        return (short)constants$1651.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short wReserved1$get(MemorySegment seg, long index) {
        return (short)constants$1651.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int dwSupport$get(MemorySegment seg) {
        return (int)constants$1652.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwSupport$set(MemorySegment seg, int x) {
        constants$1652.const$0.set(seg, x);
    }
    public static int dwSupport$get(MemorySegment seg, long index) {
        return (int)constants$1652.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void dwSupport$set(MemorySegment seg, long index, int x) {
        constants$1652.const$0.set(seg.asSlice(index*sizeof()), x);
    }

...
public interface RpcServerInterfaceGroupCreateA$IdleCallbackFn {
    ...
    static MemorySegment allocate(RpcServerInterfaceGroupCreateA$IdleCallbackFn fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1778.const$0, fi, constants$605.const$2, scope);
    }
    static RpcServerInterfaceGroupCreateA$IdleCallbackFn ofAddress(MemorySegment addr, Arena arena) {

...
public class _DOC_INFO_3W {
    ...
    public static MemorySegment pDocName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2893.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pDocName$set(MemorySegment seg, MemorySegment x) {
        constants$2893.const$4.set(seg, x);
    }
    public static MemorySegment pDocName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2893.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void pDocName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2893.const$4.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static MemorySegment pDatatype$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2894.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void pDatatype$set(MemorySegment seg, MemorySegment x) {
        constants$2894.const$0.set(seg, x);
    }
    public static MemorySegment pDatatype$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2894.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void pDatatype$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2894.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int dwFlags$get(MemorySegment seg) {
        return (int)constants$2894.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int dwFlags$get(MemorySegment seg, long index) {
        return (int)constants$2894.const$1.get(seg.asSlice(index*sizeof()));
    }

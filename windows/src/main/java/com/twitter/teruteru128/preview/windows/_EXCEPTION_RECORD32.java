...
public class _EXCEPTION_RECORD32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("ExceptionRecord"),
        Windows_h.C_LONG.withName("ExceptionAddress"),
        Windows_h.C_LONG.withName("NumberParameters"),
        MemoryLayout.sequenceLayout(15, Windows_h.C_LONG).withName("ExceptionInformation")

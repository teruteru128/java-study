...
public class IReleaseMarshalBuffers {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$3137.const$1;
    }
    public static VarHandle lpVtbl$VH() {
        return constants$3137.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpVtbl$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3137.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpVtbl$set(MemorySegment seg, MemorySegment x) {
        constants$3137.const$2.set(seg, x);
    }
    public static MemorySegment lpVtbl$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3137.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void lpVtbl$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3137.const$2.set(seg.asSlice(index*sizeof()), x);
    }

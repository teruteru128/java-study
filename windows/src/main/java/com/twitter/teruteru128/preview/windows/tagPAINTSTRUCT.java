...
public class tagPAINTSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("fErase"),
        tagRECT.layout().withName("rcPaint"),
        Windows_h.C_INT.withName("fRestore"),
        Windows_h.C_INT.withName("fIncUpdate"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("rgbReserved"),

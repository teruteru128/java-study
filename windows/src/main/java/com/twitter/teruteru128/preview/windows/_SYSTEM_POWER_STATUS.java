...
public class _SYSTEM_POWER_STATUS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("ACLineStatus"),
        Windows_h.C_CHAR.withName("BatteryFlag"),
        Windows_h.C_CHAR.withName("BatteryLifePercent"),
        Windows_h.C_CHAR.withName("SystemStatusFlag"),
        Windows_h.C_LONG.withName("BatteryLifeTime"),
        Windows_h.C_LONG.withName("BatteryFullLifeTime")

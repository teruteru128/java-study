...
public class _GET_CHANGER_PARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_SHORT.withName("NumberTransportElements"),
        Windows_h.C_SHORT.withName("NumberStorageElements"),
        Windows_h.C_SHORT.withName("NumberCleanerSlots"),
        Windows_h.C_SHORT.withName("NumberIEElements"),
        Windows_h.C_SHORT.withName("NumberDataTransferElements"),
        Windows_h.C_SHORT.withName("NumberOfDoors"),
        Windows_h.C_SHORT.withName("FirstSlotNumber"),
        Windows_h.C_SHORT.withName("FirstDriveNumber"),
        Windows_h.C_SHORT.withName("FirstTransportNumber"),
        Windows_h.C_SHORT.withName("FirstIEPortNumber"),
        Windows_h.C_SHORT.withName("FirstCleanerSlotAddress"),
        Windows_h.C_SHORT.withName("MagazineSize"),
        Windows_h.C_LONG.withName("DriveCleanTimeout"),
        Windows_h.C_LONG.withName("Features0"),
        Windows_h.C_LONG.withName("Features1"),
        Windows_h.C_CHAR.withName("MoveFromTransport"),
        Windows_h.C_CHAR.withName("MoveFromSlot"),
        Windows_h.C_CHAR.withName("MoveFromIePort"),
        Windows_h.C_CHAR.withName("MoveFromDrive"),
        Windows_h.C_CHAR.withName("ExchangeFromTransport"),
        Windows_h.C_CHAR.withName("ExchangeFromSlot"),
        Windows_h.C_CHAR.withName("ExchangeFromIePort"),
        Windows_h.C_CHAR.withName("ExchangeFromDrive"),
        Windows_h.C_CHAR.withName("LockUnlockCapabilities"),
        Windows_h.C_CHAR.withName("PositionCapabilities"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("Reserved1"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_LONG).withName("Reserved2")

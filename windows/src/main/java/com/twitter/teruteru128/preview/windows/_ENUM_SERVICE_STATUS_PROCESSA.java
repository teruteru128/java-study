...
public class _ENUM_SERVICE_STATUS_PROCESSA {
    ...
    public static MemoryLayout $LAYOUT() {
        return constants$4491.const$5;
    }
    public static VarHandle lpServiceName$VH() {
        return constants$4492.const$0;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpServiceName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$4492.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpServiceName$set(MemorySegment seg, MemorySegment x) {
        constants$4492.const$0.set(seg, x);
    }
    public static MemorySegment lpServiceName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$4492.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void lpServiceName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$4492.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    public static VarHandle lpDisplayName$VH() {
        return constants$4492.const$1;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment lpDisplayName$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$4492.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void lpDisplayName$set(MemorySegment seg, MemorySegment x) {
        constants$4492.const$1.set(seg, x);
    }
    public static MemorySegment lpDisplayName$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$4492.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void lpDisplayName$set(MemorySegment seg, long index, MemorySegment x) {
        constants$4492.const$1.set(seg.asSlice(index*sizeof()), x);
    }

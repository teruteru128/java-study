...
public class _CMC_TAGGED_CONTENT_INFO {
    ...
    public static int dwBodyPartID$get(MemorySegment seg) {
        return (int)constants$2048.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dwBodyPartID$set(MemorySegment seg, int x) {
        constants$2048.const$5.set(seg, x);
    }
    public static int dwBodyPartID$get(MemorySegment seg, long index) {
        return (int)constants$2048.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void dwBodyPartID$set(MemorySegment seg, long index, int x) {
        constants$2048.const$5.set(seg.asSlice(index*sizeof()), x);
    }
    public static MemorySegment EncodedContentInfo$slice(MemorySegment seg) {

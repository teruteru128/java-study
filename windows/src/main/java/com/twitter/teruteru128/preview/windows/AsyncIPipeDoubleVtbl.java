 ...
 * HRESULT (*QueryInterface)(AsyncIPipeDouble*,const IID*,void**);
    ...
    public interface QueryInterface {
        ...
        static MemorySegment allocate(QueryInterface fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3157.const$5, fi, constants$37.const$3, scope);
        }
    ...
    public static MemorySegment QueryInterface$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3158.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void QueryInterface$set(MemorySegment seg, MemorySegment x) {
        constants$3158.const$0.set(seg, x);
    }
    public static MemorySegment QueryInterface$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3158.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void QueryInterface$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3158.const$0.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * ULONG (*AddRef)(AsyncIPipeDouble*);
    ...
    public interface AddRef {
        ...
        static MemorySegment allocate(AddRef fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3158.const$1, fi, constants$18.const$5, scope);
        }
    ...
    public static MemorySegment AddRef$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3158.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void AddRef$set(MemorySegment seg, MemorySegment x) {
        constants$3158.const$2.set(seg, x);
    }
    public static MemorySegment AddRef$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3158.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void AddRef$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3158.const$2.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * ULONG (*Release)(AsyncIPipeDouble*);
    ...
    public interface Release {
        ...
        static MemorySegment allocate(Release fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3158.const$3, fi, constants$18.const$5, scope);
        }
    ...
    public static MemorySegment Release$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3158.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Release$set(MemorySegment seg, MemorySegment x) {
        constants$3158.const$4.set(seg, x);
    }
    public static MemorySegment Release$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3158.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void Release$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3158.const$4.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * HRESULT (*Begin_Pull)(AsyncIPipeDouble*,ULONG);
    ...
    public interface Begin_Pull {
        ...
        static MemorySegment allocate(Begin_Pull fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3158.const$5, fi, constants$65.const$2, scope);
        }
    ...
    public static MemorySegment Begin_Pull$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3159.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Begin_Pull$set(MemorySegment seg, MemorySegment x) {
        constants$3159.const$0.set(seg, x);
    }
    public static MemorySegment Begin_Pull$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3159.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void Begin_Pull$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3159.const$0.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * HRESULT (*Finish_Pull)(AsyncIPipeDouble*,DOUBLE*,ULONG*);
    ...
    public interface Finish_Pull {
        ...
        static MemorySegment allocate(Finish_Pull fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3159.const$1, fi, constants$37.const$3, scope);
        }
    ...
    public static MemorySegment Finish_Pull$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3159.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Finish_Pull$set(MemorySegment seg, MemorySegment x) {
        constants$3159.const$2.set(seg, x);
    }
    public static MemorySegment Finish_Pull$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3159.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void Finish_Pull$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3159.const$2.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * HRESULT (*Begin_Push)(AsyncIPipeDouble*,DOUBLE*,ULONG);
    ...
    public interface Begin_Push {
        ...
        static MemorySegment allocate(Begin_Push fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3159.const$3, fi, constants$570.const$5, scope);
        }
    ...
    public static MemorySegment Begin_Push$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3159.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Begin_Push$set(MemorySegment seg, MemorySegment x) {
        constants$3159.const$4.set(seg, x);
    }
    public static MemorySegment Begin_Push$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3159.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void Begin_Push$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3159.const$4.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * HRESULT (*Finish_Push)(AsyncIPipeDouble*);
    ...
    public interface Finish_Push {
        ...
        static MemorySegment allocate(Finish_Push fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$3159.const$5, fi, constants$18.const$5, scope);
        }
    ...
    public static MemorySegment Finish_Push$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$3160.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Finish_Push$set(MemorySegment seg, MemorySegment x) {
        constants$3160.const$0.set(seg, x);
    }
    public static MemorySegment Finish_Push$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$3160.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void Finish_Push$set(MemorySegment seg, long index, MemorySegment x) {
        constants$3160.const$0.set(seg.asSlice(index*sizeof()), x);
    }

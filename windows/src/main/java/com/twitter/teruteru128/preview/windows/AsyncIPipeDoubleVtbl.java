 ...
 *     HRESULT (*QueryInterface)(AsyncIPipeDouble *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(AsyncIPipeDouble *) __attribute__((stdcall));
 *     ULONG (*Release)(AsyncIPipeDouble *) __attribute__((stdcall));
 *     HRESULT (*Begin_Pull)(AsyncIPipeDouble *, ULONG) __attribute__((stdcall));
 *     HRESULT (*Finish_Pull)(AsyncIPipeDouble *, DOUBLE *, ULONG *) __attribute__((stdcall));
 *     HRESULT (*Begin_Push)(AsyncIPipeDouble *, DOUBLE *, ULONG) __attribute__((stdcall));
 *     HRESULT (*Finish_Push)(AsyncIPipeDouble *) __attribute__((stdcall));
 * }
 * }
 */

 ...
 *     HRESULT (*QueryInterface)(IInternetPriority *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IInternetPriority *) __attribute__((stdcall));
 *     ULONG (*Release)(IInternetPriority *) __attribute__((stdcall));
 *     HRESULT (*SetPriority)(IInternetPriority *, LONG) __attribute__((stdcall));
 *     HRESULT (*GetPriority)(IInternetPriority *, LONG *) __attribute__((stdcall));
 * }
 * }
 */
public class IInternetPriorityVtbl {
    ...
    private static final long SetPriority$OFFSET = 24;

...
public interface PFN_CMSG_EXPORT_KEY_TRANS {
    ...
    static MemorySegment allocate(PFN_CMSG_EXPORT_KEY_TRANS fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$2112.const$1, fi, constants$691.const$2, scope);
    }
    static PFN_CMSG_EXPORT_KEY_TRANS ofAddress(MemorySegment addr, Arena arena) {

...
public class _CERT_CHAIN_CONTEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("cChain"),
        Windows_h.C_POINTER.withName("rgpChain"),
        Windows_h.C_LONG.withName("cLowerQualityChainContext"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rgpLowerQualityChainContext"),
        Windows_h.C_INT.withName("fHasRevocationFreshnessTime"),
        Windows_h.C_LONG.withName("dwRevocationFreshnessTime"),
        Windows_h.C_LONG.withName("dwCreateFlags"),

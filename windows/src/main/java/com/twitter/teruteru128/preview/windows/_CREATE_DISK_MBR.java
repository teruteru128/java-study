 ...
 * }
 */
public class _CREATE_DISK_MBR {

    public static MemoryLayout $LAYOUT() {
        return constants$2540.const$1;
    }
    public static VarHandle Signature$VH() {
        return constants$2540.const$2;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static int Signature$get(MemorySegment seg) {
        return (int)constants$2540.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void Signature$set(MemorySegment seg, int x) {
        constants$2540.const$2.set(seg, x);
    }
    public static int Signature$get(MemorySegment seg, long index) {
        return (int)constants$2540.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void Signature$set(MemorySegment seg, long index, int x) {
        constants$2540.const$2.set(seg.asSlice(index*sizeof()), x);
    }

...
public class _SLIST_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.structLayout(
            ...
            Windows_h.C_LONG_LONG.withName("Region")
        ).withName("$anon$21049:5"),
    ...
    private static final OfLong Alignment$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$21049:5"), groupElement("Alignment"));
    ...
    private static final OfLong Region$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$21049:5"), groupElement("Region"));

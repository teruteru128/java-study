...
public class tagMIXERLINECONTROLSA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ).withName("$anon$2223:5"),
        Windows_h.align(Windows_h.C_LONG, 1).withName("cControls"),
        Windows_h.align(Windows_h.C_LONG, 1).withName("cbmxctrl"),
        Windows_h.align(Windows_h.C_POINTER, 1).withName("pamxctrl")
    ...
    private static final OfInt dwControlID$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2223:5"), groupElement("dwControlID"));
    ...
    private static final OfInt dwControlType$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2223:5"), groupElement("dwControlType"));

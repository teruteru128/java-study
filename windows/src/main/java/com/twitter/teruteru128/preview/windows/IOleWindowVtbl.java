 ...
 *     HRESULT (*QueryInterface)(IOleWindow *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IOleWindow *) __attribute__((stdcall));
 *     ULONG (*Release)(IOleWindow *) __attribute__((stdcall));
 *     HRESULT (*GetWindow)(IOleWindow *, HWND *) __attribute__((stdcall));
 *     HRESULT (*ContextSensitiveHelp)(IOleWindow *, BOOL) __attribute__((stdcall));
 * }
 * }
 */

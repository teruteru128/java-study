...
public class _ENCLAVE_INIT_INFO_VBS_BASIC {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("FamilyId"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("ImageId"),
        Windows_h.C_LONG_LONG.withName("EnclaveSize"),
        Windows_h.C_LONG.withName("EnclaveSvn"),
        Windows_h.C_LONG.withName("Reserved"),
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("SignatureInfoHandle"),
            Windows_h.C_LONG_LONG.withName("Unused")
        ).withName("$anon$14112:5")
    ...
    private static final AddressLayout SignatureInfoHandle$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$14112:5"), groupElement("SignatureInfoHandle"));
    ...
    private static final OfLong Unused$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$14112:5"), groupElement("Unused"));

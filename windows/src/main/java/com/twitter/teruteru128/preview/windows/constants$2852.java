...
final class constants$2852 {
    ...
    static final VarHandle const$0 = constants$2848.const$4.varHandle(MemoryLayout.PathElement.groupElement("Size"));
    static final VarHandle const$1 = constants$2848.const$4.varHandle(MemoryLayout.PathElement.groupElement("Time"));
    static final VarHandle const$2 = constants$2848.const$4.varHandle(MemoryLayout.PathElement.groupElement("PagesPrinted"));
    static final VarHandle const$3 = constants$2848.const$4.varHandle(MemoryLayout.PathElement.groupElement("SizeHigh"));
    ...
    static final VarHandle const$5 = constants$2852.const$4.varHandle(MemoryLayout.PathElement.groupElement("JobId"));
}

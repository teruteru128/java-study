...
public class _REASSIGN_BLOCKS_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.align(Windows_h.C_SHORT, 1).withName("Reserved"),
        Windows_h.align(Windows_h.C_SHORT, 1).withName("Count"),
        MemoryLayout.sequenceLayout(1, Windows_h.align(_LARGE_INTEGER.layout(), 1)).withName("BlockNumber")

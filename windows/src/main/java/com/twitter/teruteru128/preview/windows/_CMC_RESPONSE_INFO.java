...
public class _CMC_RESPONSE_INFO {
    ...
    public static int cTaggedAttribute$get(MemorySegment seg) {
        return (int)constants$2051.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int cTaggedAttribute$get(MemorySegment seg, long index) {
        return (int)constants$2051.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment rgTaggedAttribute$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2051.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment rgTaggedAttribute$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2051.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int cTaggedContentInfo$get(MemorySegment seg) {
        return (int)constants$2051.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment rgTaggedContentInfo$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2051.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int cTaggedOtherMsg$get(MemorySegment seg) {
        return (int)constants$2051.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment rgTaggedOtherMsg$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2052.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void rgTaggedOtherMsg$set(MemorySegment seg, MemorySegment x) {
        constants$2052.const$0.set(seg, x);
    }
    public static MemorySegment rgTaggedOtherMsg$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2052.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void rgTaggedOtherMsg$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2052.const$0.set(seg.asSlice(index*sizeof()), x);
    }

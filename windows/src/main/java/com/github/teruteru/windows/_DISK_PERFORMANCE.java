...
public class _DISK_PERFORMANCE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("ReadCount"),
        Windows_h.C_LONG.withName("WriteCount"),
        Windows_h.C_LONG.withName("QueueDepth"),
        Windows_h.C_LONG.withName("SplitCount"),
        _LARGE_INTEGER.layout().withName("QueryTime"),
        Windows_h.C_LONG.withName("StorageDeviceNumber"),
        MemoryLayout.sequenceLayout(8, Windows_h.C_SHORT).withName("StorageManagerName"),

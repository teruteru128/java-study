...
public class _DRIVERSTATUS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("bDriverError"),
        Windows_h.C_CHAR.withName("bIDEError"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("bReserved"),
        MemoryLayout.sequenceLayout(2, Windows_h.align(Windows_h.C_LONG, 1)).withName("dwReserved")

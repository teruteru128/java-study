...
public class _CERT_ID {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("dwIdChoice"),
    ...
    private static final GroupLayout IssuerSerialNumber$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6667:5"), groupElement("IssuerSerialNumber"));
    ...
    private static final GroupLayout KeyId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6667:5"), groupElement("KeyId"));
    ...
    private static final GroupLayout HashId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$6667:5"), groupElement("HashId"));

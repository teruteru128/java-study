...
public class tagRID_DEVICE_INFO {
    ...
    private static final GroupLayout mouse$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$15173:5"), groupElement("mouse"));
    ...
    private static final GroupLayout keyboard$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$15173:5"), groupElement("keyboard"));
    ...
    private static final GroupLayout hid$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$15173:5"), groupElement("hid"));

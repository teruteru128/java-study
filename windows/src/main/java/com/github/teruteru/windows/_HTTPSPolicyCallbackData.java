...
public class _HTTPSPolicyCallbackData {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ).withName("$anon$20182:5"),
        Windows_h.C_LONG.withName("dwAuthType"),
        Windows_h.C_LONG.withName("fdwChecks"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("pwszServerName")
    ...
    private static final OfInt cbStruct$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20182:5"), groupElement("cbStruct"));
    ...
    private static final OfInt cbSize$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20182:5"), groupElement("cbSize"));

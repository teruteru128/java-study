...
public class _CTL_VERIFY_USAGE_PARA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("cCtlStore"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rghCtlStore"),
        Windows_h.C_LONG.withName("cSignerStore"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rghSignerStore")

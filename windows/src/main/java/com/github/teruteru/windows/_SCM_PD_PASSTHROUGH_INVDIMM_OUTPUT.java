...
public class _SCM_PD_PASSTHROUGH_INVDIMM_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_SHORT.withName("GeneralStatus"),
        Windows_h.C_SHORT.withName("ExtendedStatus"),
        Windows_h.C_LONG.withName("OutputDataLength"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_CHAR).withName("OutputData"),

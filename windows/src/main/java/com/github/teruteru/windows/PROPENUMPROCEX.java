...
public class PROPENUMPROCEX {
    ...
    private static final MethodHandle UP$MH = Windows_h.upcallHandle(PROPENUMPROCEX.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PROPENUMPROCEX.Function fi, Arena arena) {

...
public class tagSERIALKEYSW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("lpszActivePort"),
        Windows_h.C_POINTER.withName("lpszPort"),
        Windows_h.C_INT.withName("iBaudRate"),
        Windows_h.C_INT.withName("iPortState"),
        Windows_h.C_INT.withName("iActive"),

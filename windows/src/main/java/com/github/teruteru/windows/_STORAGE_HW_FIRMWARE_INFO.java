...
public class _STORAGE_HW_FIRMWARE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_CHAR.withName("PendingActivateSlot"),
        Windows_h.C_CHAR.withName("FirmwareShared"),
        MemoryLayout.sequenceLayout(3, Windows_h.C_CHAR).withName("Reserved"),
        Windows_h.C_LONG.withName("ImagePayloadAlignment"),
        Windows_h.C_LONG.withName("ImagePayloadMaxSize"),

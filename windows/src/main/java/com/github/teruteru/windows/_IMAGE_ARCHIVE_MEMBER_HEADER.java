...
public class _IMAGE_ARCHIVE_MEMBER_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("Name"),
        MemoryLayout.sequenceLayout(12, Windows_h.C_CHAR).withName("Date"),
        MemoryLayout.sequenceLayout(6, Windows_h.C_CHAR).withName("UserID"),
        MemoryLayout.sequenceLayout(6, Windows_h.C_CHAR).withName("GroupID"),
        MemoryLayout.sequenceLayout(8, Windows_h.C_CHAR).withName("Mode"),
        MemoryLayout.sequenceLayout(10, Windows_h.C_CHAR).withName("Size"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("EndHeader")

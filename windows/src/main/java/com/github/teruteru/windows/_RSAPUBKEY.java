...
public class _RSAPUBKEY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("pubexp")
    ).withName("_RSAPUBKEY");
    ...
    private static final OfInt pubexp$LAYOUT = (OfInt)$LAYOUT.select(groupElement("pubexp"));
     ...
     * }
     */
    public static final OfInt pubexp$layout() {
        return pubexp$LAYOUT;
    }

    private static final long pubexp$OFFSET = 8;
     ...
     * }
     */
    public static final long pubexp$offset() {
        return pubexp$OFFSET;
    }
     ...
     * }
     */
    public static int pubexp(MemorySegment struct) {
        return struct.get(pubexp$LAYOUT, pubexp$OFFSET);
    }
     ...
     * }
     */
    public static void pubexp(MemorySegment struct, int fieldValue) {
        struct.set(pubexp$LAYOUT, pubexp$OFFSET, fieldValue);
    }

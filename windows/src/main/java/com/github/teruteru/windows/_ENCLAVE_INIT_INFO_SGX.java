...
public class _ENCLAVE_INIT_INFO_SGX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(1808, Windows_h.C_CHAR).withName("SigStruct"),
        MemoryLayout.sequenceLayout(240, Windows_h.C_CHAR).withName("Reserved1"),
        MemoryLayout.sequenceLayout(304, Windows_h.C_CHAR).withName("EInitToken"),
        MemoryLayout.sequenceLayout(1744, Windows_h.C_CHAR).withName("Reserved2")

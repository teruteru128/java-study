...
public class SYSTEM_POWER_CAPABILITIES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("PowerButtonPresent"),
        Windows_h.C_CHAR.withName("SleepButtonPresent"),
        Windows_h.C_CHAR.withName("LidPresent"),
        Windows_h.C_CHAR.withName("SystemS1"),
        Windows_h.C_CHAR.withName("SystemS2"),
        Windows_h.C_CHAR.withName("SystemS3"),
        Windows_h.C_CHAR.withName("SystemS4"),
        Windows_h.C_CHAR.withName("SystemS5"),
        Windows_h.C_CHAR.withName("HiberFilePresent"),
        Windows_h.C_CHAR.withName("FullWake"),
        Windows_h.C_CHAR.withName("VideoDimPresent"),
        Windows_h.C_CHAR.withName("ApmPresent"),
        Windows_h.C_CHAR.withName("UpsPresent"),
        Windows_h.C_CHAR.withName("ThermalControl"),
        Windows_h.C_CHAR.withName("ProcessorThrottle"),
        Windows_h.C_CHAR.withName("ProcessorMinThrottle"),
        Windows_h.C_CHAR.withName("ProcessorMaxThrottle"),
        Windows_h.C_CHAR.withName("FastSystemS4"),
        Windows_h.C_CHAR.withName("Hiberboot"),
        Windows_h.C_CHAR.withName("WakeAlarmPresent"),
        Windows_h.C_CHAR.withName("AoAc"),
        Windows_h.C_CHAR.withName("DiskSpinDown"),
        Windows_h.C_CHAR.withName("HiberFileType"),
        Windows_h.C_CHAR.withName("AoAcConnectivitySupported"),
        MemoryLayout.sequenceLayout(6, Windows_h.C_CHAR).withName("spare3"),
        Windows_h.C_CHAR.withName("SystemBatteriesPresent"),
        Windows_h.C_CHAR.withName("BatteriesAreShortTerm"),
        MemoryLayout.sequenceLayout(3, BATTERY_REPORTING_SCALE.layout()).withName("BatteryScale"),
        Windows_h.C_INT.withName("AcOnLineWake"),
        Windows_h.C_INT.withName("SoftLidWake"),
        Windows_h.C_INT.withName("RtcWake"),
        Windows_h.C_INT.withName("MinDeviceWakeState"),
        Windows_h.C_INT.withName("DefaultLowLatencyWake")
    ).withName("$anon$17876:9");

...
public class _CRYPT_SIGN_MESSAGE_PARA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("dwMsgEncodingType"),
        Windows_h.C_POINTER.withName("pSigningCert"),
        _CRYPT_ALGORITHM_IDENTIFIER.layout().withName("HashAlgorithm"),
        Windows_h.C_POINTER.withName("pvHashAuxInfo"),
        Windows_h.C_LONG.withName("cMsgCert"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rgpMsgCert"),
        Windows_h.C_LONG.withName("cMsgCrl"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rgpMsgCrl"),
        ...
        Windows_h.C_LONG.withName("dwInnerContentType")

...
public class tagENHMETAHEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("iType"),
        Windows_h.C_LONG.withName("nSize"),
        _RECTL.layout().withName("rclBounds"),
        _RECTL.layout().withName("rclFrame"),
        Windows_h.C_LONG.withName("dSignature"),
        Windows_h.C_LONG.withName("nVersion"),
        Windows_h.C_LONG.withName("nBytes"),
        Windows_h.C_LONG.withName("nRecords"),
        Windows_h.C_SHORT.withName("nHandles"),
        Windows_h.C_SHORT.withName("sReserved"),
        Windows_h.C_LONG.withName("nDescription"),
        Windows_h.C_LONG.withName("offDescription"),
        Windows_h.C_LONG.withName("nPalEntries"),
        tagSIZE.layout().withName("szlDevice"),
        tagSIZE.layout().withName("szlMillimeters"),
        Windows_h.C_LONG.withName("cbPixelFormat"),
        Windows_h.C_LONG.withName("offPixelFormat"),
        Windows_h.C_LONG.withName("bOpenGL"),

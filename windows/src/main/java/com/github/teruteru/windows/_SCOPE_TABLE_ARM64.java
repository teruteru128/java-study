...
public class _SCOPE_TABLE_ARM64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, _SCOPE_TABLE_ARM64.ScopeRecord.layout()).withName("ScopeRecord")
    ...
    public static void ScopeRecord(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, ScopeRecord(struct, index0), 0L, _SCOPE_TABLE_ARM64.ScopeRecord.layout().byteSize());
    }

 ...
 *     HRESULT (*QueryInterface)(IBindProtocol *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IBindProtocol *) __attribute__((stdcall));
 *     ULONG (*Release)(IBindProtocol *) __attribute__((stdcall));
 *     HRESULT (*CreateBinding)(IBindProtocol *, LPCWSTR, IBindCtx *, IBinding **) __attribute__((stdcall));
 * }
 * }
 */
public class IBindProtocolVtbl {
    ...
    private static final long CreateBinding$OFFSET = 24;

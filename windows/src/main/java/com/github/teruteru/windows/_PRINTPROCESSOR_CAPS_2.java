...
public class _PRINTPROCESSOR_CAPS_2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("dwLevel"),
        Windows_h.C_LONG.withName("dwNupOptions"),
        Windows_h.C_LONG.withName("dwPageOrderFlags"),
        Windows_h.C_LONG.withName("dwNumberOfCopies"),
        Windows_h.C_LONG.withName("dwDuplexHandlingCaps"),
        Windows_h.C_LONG.withName("dwNupDirectionCaps"),
        Windows_h.C_LONG.withName("dwNupBorderCaps"),
        Windows_h.C_LONG.withName("dwBookletHandlingCaps"),
        Windows_h.C_LONG.withName("dwScalingCaps")

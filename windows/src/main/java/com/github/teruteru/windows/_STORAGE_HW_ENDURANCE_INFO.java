...
public class _STORAGE_HW_ENDURANCE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("ValidFields"),
        Windows_h.C_LONG.withName("GroupId"),
        _STORAGE_HW_ENDURANCE_INFO.Flags.layout().withName("Flags"),
        Windows_h.C_LONG.withName("LifePercentage"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("BytesReadCount"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("ByteWriteCount")

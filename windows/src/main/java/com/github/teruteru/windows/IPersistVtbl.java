 ...
 * {@snippet lang=c :
 * struct IPersistVtbl {
 *     HRESULT (*QueryInterface)(IPersist *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IPersist *) __attribute__((stdcall));
 *     ULONG (*Release)(IPersist *) __attribute__((stdcall));
 *     HRESULT (*GetClassID)(IPersist *, CLSID *) __attribute__((stdcall));
 * }
 * }
 */

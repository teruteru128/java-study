...
public class _STORAGE_ADAPTER_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("MaximumTransferLength"),
        Windows_h.C_LONG.withName("MaximumPhysicalPages"),
        Windows_h.C_LONG.withName("AlignmentMask"),
        Windows_h.C_CHAR.withName("AdapterUsesPio"),
        Windows_h.C_CHAR.withName("AdapterScansDown"),
        Windows_h.C_CHAR.withName("CommandQueueing"),
        Windows_h.C_CHAR.withName("AcceleratedTransfer"),
        Windows_h.C_CHAR.withName("BusType"),
        MemoryLayout.paddingLayout(1),
        Windows_h.C_SHORT.withName("BusMajorVersion"),
        Windows_h.C_SHORT.withName("BusMinorVersion"),
        Windows_h.C_CHAR.withName("SrbType"),
        Windows_h.C_CHAR.withName("AddressType")

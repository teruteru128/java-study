...
public class _EXTENDED_ENCRYPTED_DATA_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("ExtendedCode"),
    ...
    private static final OfInt ExtendedCode$LAYOUT = (OfInt)$LAYOUT.select(groupElement("ExtendedCode"));
     ...
     * }
     */
    public static final OfInt ExtendedCode$layout() {
        return ExtendedCode$LAYOUT;
    }

    private static final long ExtendedCode$OFFSET = 0;
     ...
     * }
     */
    public static final long ExtendedCode$offset() {
        return ExtendedCode$OFFSET;
    }
     ...
     * }
     */
    public static int ExtendedCode(MemorySegment struct) {
        return struct.get(ExtendedCode$LAYOUT, ExtendedCode$OFFSET);
    }
     ...
     * }
     */
    public static void ExtendedCode(MemorySegment struct, int fieldValue) {
        struct.set(ExtendedCode$LAYOUT, ExtendedCode$OFFSET, fieldValue);
    }

...
public class _DCB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("DCBlength"),
        Windows_h.C_LONG.withName("BaudRate"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_SHORT.withName("wReserved"),
        Windows_h.C_SHORT.withName("XonLim"),
        Windows_h.C_SHORT.withName("XoffLim"),
        Windows_h.C_CHAR.withName("ByteSize"),
        Windows_h.C_CHAR.withName("Parity"),
        Windows_h.C_CHAR.withName("StopBits"),
        Windows_h.C_CHAR.withName("XonChar"),
        Windows_h.C_CHAR.withName("XoffChar"),
        Windows_h.C_CHAR.withName("ErrorChar"),
        Windows_h.C_CHAR.withName("EofChar"),
        Windows_h.C_CHAR.withName("EvtChar"),

...
public class _CONSOLE_SCREEN_BUFFER_INFOEX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_SHORT.withName("wAttributes"),
        _SMALL_RECT.layout().withName("srWindow"),
        _COORD.layout().withName("dwMaximumWindowSize"),
        Windows_h.C_SHORT.withName("wPopupAttributes"),
        Windows_h.C_INT.withName("bFullscreenSupported"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_LONG).withName("ColorTable")

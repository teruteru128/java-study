 ...
 *     HRESULT (*QueryInterface)(IProgressNotify *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IProgressNotify *) __attribute__((stdcall));
 *     ULONG (*Release)(IProgressNotify *) __attribute__((stdcall));
 *     HRESULT (*OnProgress)(IProgressNotify *, DWORD, DWORD, BOOL, BOOL) __attribute__((stdcall));
 * }
 * }
 */
public class IProgressNotifyVtbl {
    ...
    private static final long OnProgress$OFFSET = 24;

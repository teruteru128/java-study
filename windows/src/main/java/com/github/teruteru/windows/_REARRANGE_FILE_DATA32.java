...
public class _REARRANGE_FILE_DATA32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("SourceStartingOffset"),
        Windows_h.C_LONG_LONG.withName("TargetOffset"),
        Windows_h.C_INT.withName("SourceFileHandle"),
    ...
    private static final OfInt SourceFileHandle$LAYOUT = (OfInt)$LAYOUT.select(groupElement("SourceFileHandle"));
     ...
     * }
     */
    public static final OfInt SourceFileHandle$layout() {
     ...
     * }
     */
    public static int SourceFileHandle(MemorySegment struct) {
     ...
     * }
     */
    public static void SourceFileHandle(MemorySegment struct, int fieldValue) {

...
public class _RPC_MESSAGE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("DataRepresentation"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("Buffer"),
        Windows_h.C_INT.withName("BufferLength"),
        Windows_h.C_INT.withName("ProcNum"),
        Windows_h.C_POINTER.withName("TransferSyntax"),
        Windows_h.C_POINTER.withName("RpcInterfaceInformation"),
        Windows_h.C_POINTER.withName("ReservedForRuntime"),
        Windows_h.C_POINTER.withName("ManagerEpv"),
        Windows_h.C_POINTER.withName("ImportContext"),
        Windows_h.C_LONG.withName("RpcFlags"),
        MemoryLayout.paddingLayout(4)

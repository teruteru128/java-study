...
public class tagLOCALESIGNATURE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(4, Windows_h.C_LONG).withName("lsUsb"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_LONG).withName("lsCsbDefault"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_LONG).withName("lsCsbSupported")

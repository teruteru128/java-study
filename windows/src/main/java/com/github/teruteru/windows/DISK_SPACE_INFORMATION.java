...
public class DISK_SPACE_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("ActualTotalAllocationUnits"),
        Windows_h.C_LONG_LONG.withName("ActualAvailableAllocationUnits"),
        Windows_h.C_LONG_LONG.withName("ActualPoolUnavailableAllocationUnits"),
        Windows_h.C_LONG_LONG.withName("CallerTotalAllocationUnits"),
        Windows_h.C_LONG_LONG.withName("CallerAvailableAllocationUnits"),
        Windows_h.C_LONG_LONG.withName("CallerPoolUnavailableAllocationUnits"),
        Windows_h.C_LONG_LONG.withName("UsedAllocationUnits"),
        Windows_h.C_LONG_LONG.withName("TotalReservedAllocationUnits"),
        Windows_h.C_LONG_LONG.withName("VolumeStorageReserveAllocationUnits"),
        Windows_h.C_LONG_LONG.withName("AvailableCommittedAllocationUnits"),
        Windows_h.C_LONG_LONG.withName("PoolAvailableAllocationUnits"),
        Windows_h.C_LONG.withName("SectorsPerAllocationUnit"),
        Windows_h.C_LONG.withName("BytesPerSector")

...
public class _FILE_RENAME_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            Windows_h.C_CHAR.withName("ReplaceIfExists"),
            Windows_h.C_LONG.withName("Flags")
        ).withName("$anon$8897:5"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("RootDirectory"),
    ...
    private static final OfByte ReplaceIfExists$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$8897:5"), groupElement("ReplaceIfExists"));
    ...
    private static final OfInt Flags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$8897:5"), groupElement("Flags"));

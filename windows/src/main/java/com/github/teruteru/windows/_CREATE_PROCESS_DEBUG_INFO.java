...
public class _CREATE_PROCESS_DEBUG_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_POINTER.withName("hFile"),
        Windows_h.C_POINTER.withName("hProcess"),
        Windows_h.C_POINTER.withName("hThread"),
        Windows_h.C_POINTER.withName("lpBaseOfImage"),
        Windows_h.C_LONG.withName("dwDebugInfoFileOffset"),
        Windows_h.C_LONG.withName("nDebugInfoSize"),
        Windows_h.C_POINTER.withName("lpThreadLocalBase"),
        Windows_h.C_POINTER.withName("lpStartAddress"),
        Windows_h.C_POINTER.withName("lpImageName"),
        Windows_h.C_SHORT.withName("fUnicode"),

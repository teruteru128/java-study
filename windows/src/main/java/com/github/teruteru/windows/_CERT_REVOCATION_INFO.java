...
public class _CERT_REVOCATION_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("dwRevocationResult"),
        Windows_h.C_POINTER.withName("pszRevocationOid"),
        Windows_h.C_POINTER.withName("pvOidSpecificInfo"),
        Windows_h.C_INT.withName("fHasFreshnessTime"),
        Windows_h.C_LONG.withName("dwFreshnessTime"),
        Windows_h.C_POINTER.withName("pCrlInfo")

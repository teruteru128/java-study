...
public class _FILE_QUERY_ON_DISK_VOL_INFO_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_SHORT.withName("FsFormatMajVersion"),
        Windows_h.C_SHORT.withName("FsFormatMinVersion"),
        MemoryLayout.sequenceLayout(12, Windows_h.C_SHORT).withName("FsFormatName"),
        MemoryLayout.paddingLayout(4),
        _LARGE_INTEGER.layout().withName("FormatTime"),
        _LARGE_INTEGER.layout().withName("LastUpdateTime"),
        MemoryLayout.sequenceLayout(34, Windows_h.C_SHORT).withName("CopyrightInfo"),
        MemoryLayout.sequenceLayout(34, Windows_h.C_SHORT).withName("AbstractInfo"),
        MemoryLayout.sequenceLayout(34, Windows_h.C_SHORT).withName("FormattingImplementationInfo"),
        MemoryLayout.sequenceLayout(34, Windows_h.C_SHORT).withName("LastModifyingImplementationInfo")

...
public class _IMAGE_TLS_DIRECTORY32 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("StartAddressOfRawData"),
        Windows_h.C_LONG.withName("EndAddressOfRawData"),
        Windows_h.C_LONG.withName("AddressOfIndex"),
        Windows_h.C_LONG.withName("AddressOfCallBacks"),
        Windows_h.C_LONG.withName("SizeOfZeroFill"),
        MemoryLayout.unionLayout(
            Windows_h.C_LONG.withName("Characteristics"),
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(4)
            ).withName("$anon$19375:9")
        ).withName("$anon$19373:5")
    ...
    private static final OfInt Characteristics$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$19373:5"), groupElement("Characteristics"));

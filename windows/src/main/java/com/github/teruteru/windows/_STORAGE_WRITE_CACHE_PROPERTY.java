...
public class _STORAGE_WRITE_CACHE_PROPERTY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("WriteCacheType"),
        Windows_h.C_INT.withName("WriteCacheEnabled"),
        Windows_h.C_INT.withName("WriteCacheChangeable"),
        Windows_h.C_INT.withName("WriteThroughSupported"),
        Windows_h.C_CHAR.withName("FlushCacheSupported"),
        Windows_h.C_CHAR.withName("UserDefinedPowerProtection"),
        Windows_h.C_CHAR.withName("NVCacheEnabled"),

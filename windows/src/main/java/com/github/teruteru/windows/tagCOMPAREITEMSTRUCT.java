...
public class tagCOMPAREITEMSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("hwndItem"),
        Windows_h.C_INT.withName("itemID1"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_LONG_LONG.withName("itemData1"),
        Windows_h.C_INT.withName("itemID2"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_LONG_LONG.withName("itemData2"),
        Windows_h.C_LONG.withName("dwLocaleId"),
        MemoryLayout.paddingLayout(4)

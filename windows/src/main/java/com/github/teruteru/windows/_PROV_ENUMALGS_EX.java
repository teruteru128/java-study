...
public class _PROV_ENUMALGS_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_INT.withName("aiAlgid"),
        Windows_h.C_LONG.withName("dwDefaultLen"),
        Windows_h.C_LONG.withName("dwMinLen"),
        Windows_h.C_LONG.withName("dwMaxLen"),
        Windows_h.C_LONG.withName("dwProtocols"),
        Windows_h.C_LONG.withName("dwNameLen"),
        MemoryLayout.sequenceLayout(20, Windows_h.C_CHAR).withName("szName"),
        Windows_h.C_LONG.withName("dwLongNameLen"),
        MemoryLayout.sequenceLayout(40, Windows_h.C_CHAR).withName("szLongName")

...
public class tagPROPSPEC {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("ulKind"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            Windows_h.C_LONG.withName("propid"),
            Windows_h.C_POINTER.withName("lpwstr")
        ).withName("$anon$452:43")
    ...
    private static final OfInt propid$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$452:43"), groupElement("propid"));
    ...
    private static final AddressLayout lpwstr$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$452:43"), groupElement("lpwstr"));

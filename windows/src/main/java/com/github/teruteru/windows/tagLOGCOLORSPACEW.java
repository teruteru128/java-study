...
public class tagLOGCOLORSPACEW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("lcsSignature"),
        Windows_h.C_LONG.withName("lcsVersion"),
        Windows_h.C_LONG.withName("lcsSize"),
        Windows_h.C_LONG.withName("lcsCSType"),
        Windows_h.C_LONG.withName("lcsIntent"),
        tagICEXYZTRIPLE.layout().withName("lcsEndpoints"),
        Windows_h.C_LONG.withName("lcsGammaRed"),
        Windows_h.C_LONG.withName("lcsGammaGreen"),
        Windows_h.C_LONG.withName("lcsGammaBlue"),
        MemoryLayout.sequenceLayout(260, Windows_h.C_SHORT).withName("lcsFilename")

...
public class tagRECONVERTSTRING {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("dwStrLen"),
        Windows_h.C_LONG.withName("dwStrOffset"),
        Windows_h.C_LONG.withName("dwCompStrLen"),
        Windows_h.C_LONG.withName("dwCompStrOffset"),
        Windows_h.C_LONG.withName("dwTargetStrLen"),
        Windows_h.C_LONG.withName("dwTargetStrOffset")

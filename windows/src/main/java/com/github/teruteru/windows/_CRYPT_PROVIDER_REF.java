...
public class _CRYPT_PROVIDER_REF {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("pszFunction"),
        Windows_h.C_POINTER.withName("pszProvider"),
        Windows_h.C_LONG.withName("cProperties"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rgpProperties"),
        Windows_h.C_POINTER.withName("pUM"),
        Windows_h.C_POINTER.withName("pKM")

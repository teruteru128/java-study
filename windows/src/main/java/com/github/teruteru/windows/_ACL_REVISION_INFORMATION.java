...
public class _ACL_REVISION_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("AclRevision")
    ...
    private static final OfInt AclRevision$LAYOUT = (OfInt)$LAYOUT.select(groupElement("AclRevision"));
     ...
     * }
     */
    public static final OfInt AclRevision$layout() {
     ...
     * }
     */
    public static int AclRevision(MemorySegment struct) {
     ...
     * }
     */
    public static void AclRevision(MemorySegment struct, int fieldValue) {

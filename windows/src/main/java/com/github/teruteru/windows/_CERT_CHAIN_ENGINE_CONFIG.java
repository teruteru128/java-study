...
public class _CERT_CHAIN_ENGINE_CONFIG {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("hRestrictedRoot"),
        Windows_h.C_POINTER.withName("hRestrictedTrust"),
        Windows_h.C_POINTER.withName("hRestrictedOther"),
        Windows_h.C_LONG.withName("cAdditionalStore"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rghAdditionalStore"),
        Windows_h.C_LONG.withName("dwFlags"),
        Windows_h.C_LONG.withName("dwUrlRetrievalTimeout"),
        Windows_h.C_LONG.withName("MaximumCachedCertificates"),
        Windows_h.C_LONG.withName("CycleDetectionModulus"),
        Windows_h.C_POINTER.withName("hExclusiveRoot"),
        Windows_h.C_POINTER.withName("hExclusiveTrustedPeople"),
        Windows_h.C_LONG.withName("dwExclusiveFlags"),
        MemoryLayout.paddingLayout(4)

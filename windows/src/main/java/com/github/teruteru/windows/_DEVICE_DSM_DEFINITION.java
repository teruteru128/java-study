...
public class _DEVICE_DSM_DEFINITION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_CHAR.withName("SingleRange"),
        MemoryLayout.paddingLayout(3),
        Windows_h.C_LONG.withName("ParameterBlockAlignment"),
        Windows_h.C_LONG.withName("ParameterBlockLength"),
        Windows_h.C_CHAR.withName("HasOutput"),
        MemoryLayout.paddingLayout(3),
        Windows_h.C_LONG.withName("OutputBlockAlignment"),
        Windows_h.C_LONG.withName("OutputBlockLength")

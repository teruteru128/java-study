...
public class tagEMRLINETO {
    ...
    private static final GroupLayout ptl$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("ptl"));
     ...
     * }
     */
    public static final GroupLayout ptl$layout() {
        return ptl$LAYOUT;
    }

    private static final long ptl$OFFSET = 8;
     ...
     * }
     */
    public static final long ptl$offset() {
        return ptl$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment ptl(MemorySegment struct) {
        return struct.asSlice(ptl$OFFSET, ptl$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void ptl(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, ptl$OFFSET, ptl$LAYOUT.byteSize());
    }

...
public class _VIRTUALIZATION_INSTANCE_INFO_INPUT_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_SHORT.withName("HeaderSize"),
        MemoryLayout.paddingLayout(2),
        Windows_h.C_LONG.withName("Flags"),
        Windows_h.C_LONG.withName("NotificationInfoSize"),
        Windows_h.C_SHORT.withName("NotificationInfoOffset"),
        Windows_h.C_SHORT.withName("ProviderMajorVersion")

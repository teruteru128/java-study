...
public class _KEY_EVENT_RECORD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_INT.withName("bKeyDown"),
        Windows_h.C_SHORT.withName("wRepeatCount"),
        Windows_h.C_SHORT.withName("wVirtualKeyCode"),
        Windows_h.C_SHORT.withName("wVirtualScanCode"),

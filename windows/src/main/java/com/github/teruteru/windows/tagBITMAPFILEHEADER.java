...
public class tagBITMAPFILEHEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_SHORT.withName("bfType"),
        Windows_h.align(Windows_h.C_LONG, 2).withName("bfSize"),
        Windows_h.C_SHORT.withName("bfReserved1"),
        Windows_h.C_SHORT.withName("bfReserved2"),
        Windows_h.align(Windows_h.C_LONG, 2).withName("bfOffBits")

...
public class _CERT_SYSTEM_STORE_RELOCATE_PARA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("hKeyBase"),
            Windows_h.C_POINTER.withName("pvBase")
        ).withName("$anon$9485:5"),
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("pvSystemStore"),
            Windows_h.C_POINTER.withName("pszSystemStore"),
            Windows_h.C_POINTER.withName("pwszSystemStore")
        ).withName("$anon$9489:5")
    ...
    private static final AddressLayout hKeyBase$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9485:5"), groupElement("hKeyBase"));
    ...
    private static final AddressLayout pvBase$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9485:5"), groupElement("pvBase"));
    ...
    private static final AddressLayout pvSystemStore$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9489:5"), groupElement("pvSystemStore"));
    ...
    private static final AddressLayout pszSystemStore$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9489:5"), groupElement("pszSystemStore"));
    ...
    private static final AddressLayout pwszSystemStore$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$9489:5"), groupElement("pwszSystemStore"));

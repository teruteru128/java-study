...
public class ARRAY_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("Dimension"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("BufferConformanceMark"),
        Windows_h.C_POINTER.withName("BufferVarianceMark"),
        Windows_h.C_POINTER.withName("MaxCountArray"),
        Windows_h.C_POINTER.withName("OffsetArray"),
        Windows_h.C_POINTER.withName("ActualCountArray")
    ).withName("$anon$564:9");

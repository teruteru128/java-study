...
public class _CHANGER_ELEMENT_STATUS_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(36, Windows_h.C_CHAR).withName("PrimaryVolumeID"),
        MemoryLayout.sequenceLayout(36, Windows_h.C_CHAR).withName("AlternateVolumeID"),
        MemoryLayout.sequenceLayout(8, Windows_h.C_CHAR).withName("VendorIdentification"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("ProductIdentification"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("SerialNumber")

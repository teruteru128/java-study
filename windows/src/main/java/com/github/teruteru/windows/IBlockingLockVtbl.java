 ...
 *     HRESULT (*QueryInterface)(IBlockingLock *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IBlockingLock *) __attribute__((stdcall));
 *     ULONG (*Release)(IBlockingLock *) __attribute__((stdcall));
 *     HRESULT (*Lock)(IBlockingLock *, DWORD) __attribute__((stdcall));
 *     HRESULT (*Unlock)(IBlockingLock *) __attribute__((stdcall));
 * }
 * }
 */
public class IBlockingLockVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("Lock"),
        Windows_h.C_POINTER.withName("Unlock")
    ...
    public static class Lock {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(Lock.Function.class, "apply", $DESC);
    ...
    public static class Unlock {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(Unlock.Function.class, "apply", $DESC);
    ...
    private static final long Unlock$OFFSET = 32;

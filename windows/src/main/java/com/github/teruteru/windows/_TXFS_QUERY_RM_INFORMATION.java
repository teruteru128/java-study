...
public class _TXFS_QUERY_RM_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("BytesRequired"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_LONG_LONG.withName("TailLsn"),
        Windows_h.C_LONG_LONG.withName("CurrentLsn"),
        Windows_h.C_LONG_LONG.withName("ArchiveTailLsn"),
        Windows_h.C_LONG_LONG.withName("LogContainerSize"),
        _LARGE_INTEGER.layout().withName("HighestVirtualClock"),
        Windows_h.C_LONG.withName("LogContainerCount"),
        Windows_h.C_LONG.withName("LogContainerCountMax"),
        Windows_h.C_LONG.withName("LogContainerCountMin"),
        Windows_h.C_LONG.withName("LogGrowthIncrement"),
        Windows_h.C_LONG.withName("LogAutoShrinkPercentage"),
        Windows_h.C_LONG.withName("Flags"),
        Windows_h.C_SHORT.withName("LoggingMode"),
        Windows_h.C_SHORT.withName("Reserved"),
        Windows_h.C_LONG.withName("RmState"),
        Windows_h.C_LONG_LONG.withName("LogCapacity"),
        Windows_h.C_LONG_LONG.withName("LogFree"),
        Windows_h.C_LONG_LONG.withName("TopsSize"),
        Windows_h.C_LONG_LONG.withName("TopsUsed"),
        Windows_h.C_LONG_LONG.withName("TransactionCount"),
        Windows_h.C_LONG_LONG.withName("OnePCCount"),
        Windows_h.C_LONG_LONG.withName("TwoPCCount"),
        Windows_h.C_LONG_LONG.withName("NumberLogFileFull"),
        Windows_h.C_LONG_LONG.withName("OldestTransactionAge"),
        _GUID.layout().withName("RMName"),
        Windows_h.C_LONG.withName("TmLogPathOffset"),
        MemoryLayout.paddingLayout(4)

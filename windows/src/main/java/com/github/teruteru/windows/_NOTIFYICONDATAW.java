...
public class _NOTIFYICONDATAW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("uID"),
        Windows_h.C_INT.withName("uFlags"),
        Windows_h.C_INT.withName("uCallbackMessage"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("hIcon"),
        MemoryLayout.sequenceLayout(128, Windows_h.C_SHORT).withName("szTip"),
        Windows_h.C_LONG.withName("dwState"),
        Windows_h.C_LONG.withName("dwStateMask"),
        MemoryLayout.sequenceLayout(256, Windows_h.C_SHORT).withName("szInfo"),
        MemoryLayout.unionLayout(
            Windows_h.C_INT.withName("uTimeout"),
            Windows_h.C_INT.withName("uVersion")
        ).withName("$anon$1057:5"),
        MemoryLayout.sequenceLayout(64, Windows_h.C_SHORT).withName("szInfoTitle"),
        Windows_h.C_LONG.withName("dwInfoFlags"),
        _GUID.layout().withName("guidItem"),
        Windows_h.C_POINTER.withName("hBalloonIcon")
     ...
     * }
     */
    public static short szTip(MemorySegment struct, long index0) {
        return (short)szTip$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void szTip(MemorySegment struct, long index0, short fieldValue) {
    ...
    private static final long dwState$OFFSET = 296;
    ...
    private static final long dwStateMask$OFFSET = 300;
    ...
    private static final long szInfo$OFFSET = 304;
     ...
     * }
     */
    public static short szInfo(MemorySegment struct, long index0) {
        return (short)szInfo$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void szInfo(MemorySegment struct, long index0, short fieldValue) {
        szInfo$ELEM_HANDLE.set(struct, 0L, index0, fieldValue);
    }

    private static final OfInt uTimeout$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1057:5"), groupElement("uTimeout"));
    ...
    private static final long uTimeout$OFFSET = 816;
    ...
    private static final OfInt uVersion$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1057:5"), groupElement("uVersion"));
    ...
    private static final long uVersion$OFFSET = 816;
    ...
    private static final long szInfoTitle$OFFSET = 820;
     ...
     * }
     */
    public static short szInfoTitle(MemorySegment struct, long index0) {
        return (short)szInfoTitle$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void szInfoTitle(MemorySegment struct, long index0, short fieldValue) {
    ...
    private static final long dwInfoFlags$OFFSET = 948;
    ...
    private static final long guidItem$OFFSET = 952;
    ...
    private static final long hBalloonIcon$OFFSET = 968;

...
public class _JOBOBJECT_IO_ATTRIBUTION_STATS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("IoCount"),
        Windows_h.C_LONG_LONG.withName("TotalNonOverlappedQueueTime"),
        Windows_h.C_LONG_LONG.withName("TotalNonOverlappedServiceTime"),
        Windows_h.C_LONG_LONG.withName("TotalSize")

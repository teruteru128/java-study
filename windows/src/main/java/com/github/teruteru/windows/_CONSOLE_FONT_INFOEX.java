...
public class _CONSOLE_FONT_INFOEX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("nFont"),
        _COORD.layout().withName("dwFontSize"),
        Windows_h.C_INT.withName("FontFamily"),
        Windows_h.C_INT.withName("FontWeight"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_SHORT).withName("FaceName")

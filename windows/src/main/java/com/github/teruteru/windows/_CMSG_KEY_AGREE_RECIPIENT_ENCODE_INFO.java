...
public class _CMSG_KEY_AGREE_RECIPIENT_ENCODE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("pvKeyWrapAuxInfo"),
        Windows_h.C_LONG_LONG.withName("hCryptProv"),
        Windows_h.C_LONG.withName("dwKeySpec"),
        Windows_h.C_LONG.withName("dwKeyChoice"),
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("pEphemeralAlgorithm"),
            Windows_h.C_POINTER.withName("pSenderId")
        ).withName("$anon$6948:5"),
    ...
    private static final AddressLayout pEphemeralAlgorithm$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$6948:5"), groupElement("pEphemeralAlgorithm"));
    ...
    private static final AddressLayout pSenderId$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$6948:5"), groupElement("pSenderId"));

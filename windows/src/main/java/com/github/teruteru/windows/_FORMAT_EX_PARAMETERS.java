...
public class _FORMAT_EX_PARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("StartCylinderNumber"),
        Windows_h.C_LONG.withName("EndCylinderNumber"),
        Windows_h.C_LONG.withName("StartHeadNumber"),
        Windows_h.C_LONG.withName("EndHeadNumber"),
        Windows_h.C_SHORT.withName("FormatGapLength"),
        Windows_h.C_SHORT.withName("SectorsPerTrack"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_SHORT).withName("SectorNumber"),

...
public class _ADMINISTRATOR_POWER_POLICY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("MinVideoTimeout"),
        Windows_h.C_LONG.withName("MaxVideoTimeout"),
        Windows_h.C_LONG.withName("MinSpindownTimeout"),
        Windows_h.C_LONG.withName("MaxSpindownTimeout")

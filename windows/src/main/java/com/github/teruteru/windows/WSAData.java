...
public class WSAData {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_SHORT.withName("wVersion"),
        Windows_h.C_SHORT.withName("wHighVersion"),
        Windows_h.C_SHORT.withName("iMaxSockets"),
        Windows_h.C_SHORT.withName("iMaxUdpDg"),
        Windows_h.C_POINTER.withName("lpVendorInfo"),
        MemoryLayout.sequenceLayout(257, Windows_h.C_CHAR).withName("szDescription"),
        MemoryLayout.sequenceLayout(129, Windows_h.C_CHAR).withName("szSystemStatus"),

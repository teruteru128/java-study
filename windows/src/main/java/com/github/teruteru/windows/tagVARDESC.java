...
public class tagVARDESC {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("memid"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("lpstrSchema"),
        MemoryLayout.unionLayout(
            Windows_h.C_LONG.withName("oInst"),
            Windows_h.C_POINTER.withName("lpvarValue")
        ).withName("$anon$880:36"),
        tagELEMDESC.layout().withName("elemdescVar"),
        Windows_h.C_SHORT.withName("wVarFlags"),
        MemoryLayout.paddingLayout(2),
        Windows_h.C_INT.withName("varkind")
    ).withName("tagVARDESC");
    ...
    private static final OfInt oInst$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$880:36"), groupElement("oInst"));
    ...
    private static final AddressLayout lpvarValue$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$880:36"), groupElement("lpvarValue"));

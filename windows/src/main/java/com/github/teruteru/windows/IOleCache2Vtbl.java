...
public class IOleCache2Vtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("UpdateCache"),
        Windows_h.C_POINTER.withName("DiscardCache")
    ...
    public static class UpdateCache {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(UpdateCache.Function.class, "apply", $DESC);
    ...
    public static class DiscardCache {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(DiscardCache.Function.class, "apply", $DESC);

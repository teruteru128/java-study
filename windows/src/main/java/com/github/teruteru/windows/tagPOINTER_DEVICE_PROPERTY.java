...
public class tagPOINTER_DEVICE_PROPERTY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_INT.withName("logicalMin"),
        Windows_h.C_INT.withName("logicalMax"),
        Windows_h.C_INT.withName("physicalMin"),
        Windows_h.C_INT.withName("physicalMax"),
        Windows_h.C_INT.withName("unit"),
        Windows_h.C_INT.withName("unitExponent"),
        Windows_h.C_SHORT.withName("usagePageId"),
        Windows_h.C_SHORT.withName("usageId")

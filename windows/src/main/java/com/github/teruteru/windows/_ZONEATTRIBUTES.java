...
public class _ZONEATTRIBUTES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(260, Windows_h.C_SHORT).withName("szDisplayName"),
        MemoryLayout.sequenceLayout(200, Windows_h.C_SHORT).withName("szDescription"),
        MemoryLayout.sequenceLayout(260, Windows_h.C_SHORT).withName("szIconPath"),
        Windows_h.C_LONG.withName("dwTemplateMinLevel"),
        Windows_h.C_LONG.withName("dwTemplateRecommended"),
        Windows_h.C_LONG.withName("dwTemplateCurrentLevel"),

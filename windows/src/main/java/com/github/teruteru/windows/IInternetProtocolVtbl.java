 ...
 *     HRESULT (*QueryInterface)(IInternetProtocol *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IInternetProtocol *) __attribute__((stdcall));
 *     ULONG (*Release)(IInternetProtocol *) __attribute__((stdcall));
 *     HRESULT (*Start)(IInternetProtocol *, LPCWSTR, IInternetProtocolSink *, IInternetBindInfo *, DWORD, HANDLE_PTR) __attribute__((stdcall));
 *     HRESULT (*Continue)(IInternetProtocol *, PROTOCOLDATA *) __attribute__((stdcall));
 *     HRESULT (*Abort)(IInternetProtocol *, HRESULT, DWORD) __attribute__((stdcall));
 *     HRESULT (*Terminate)(IInternetProtocol *, DWORD) __attribute__((stdcall));
 *     HRESULT (*Suspend)(IInternetProtocol *) __attribute__((stdcall));
 *     HRESULT (*Resume)(IInternetProtocol *) __attribute__((stdcall));
 *     HRESULT (*Read)(IInternetProtocol *, void *, ULONG, ULONG *) __attribute__((stdcall));
 *     HRESULT (*Seek)(IInternetProtocol *, LARGE_INTEGER, DWORD, ULARGE_INTEGER *) __attribute__((stdcall));
 *     HRESULT (*LockRequest)(IInternetProtocol *, DWORD) __attribute__((stdcall));
 *     HRESULT (*UnlockRequest)(IInternetProtocol *) __attribute__((stdcall));
 * }
 * }
 */

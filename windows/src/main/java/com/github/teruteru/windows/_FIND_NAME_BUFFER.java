...
public class _FIND_NAME_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("length"),
        Windows_h.C_CHAR.withName("access_control"),
        Windows_h.C_CHAR.withName("frame_control"),
        MemoryLayout.sequenceLayout(6, Windows_h.C_CHAR).withName("destination_addr"),
        MemoryLayout.sequenceLayout(6, Windows_h.C_CHAR).withName("source_addr"),
        MemoryLayout.sequenceLayout(18, Windows_h.C_CHAR).withName("routing_info")

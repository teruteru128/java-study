...
public class _ENCRYPTION_KEY_CTRL_INPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("HeaderSize"),
        Windows_h.C_LONG.withName("StructureSize"),
        Windows_h.C_SHORT.withName("KeyOffset"),
        Windows_h.C_SHORT.withName("KeySize"),
        Windows_h.C_LONG.withName("DplLock"),
        Windows_h.C_LONG_LONG.withName("DplUserId"),
        Windows_h.C_LONG_LONG.withName("DplCredentialId")

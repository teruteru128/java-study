...
public class _CERT_STRONG_SIGN_PARA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("dwInfoChoice"),
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("pvInfo"),
            Windows_h.C_POINTER.withName("pSerializedInfo"),
            Windows_h.C_POINTER.withName("pszOID")
        ).withName("$anon$6535:5")
    ...
    private static final AddressLayout pvInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$6535:5"), groupElement("pvInfo"));
    ...
    private static final AddressLayout pSerializedInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$6535:5"), groupElement("pSerializedInfo"));
    ...
    private static final AddressLayout pszOID$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$6535:5"), groupElement("pszOID"));

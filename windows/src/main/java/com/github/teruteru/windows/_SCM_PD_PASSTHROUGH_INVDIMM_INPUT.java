...
public class _SCM_PD_PASSTHROUGH_INVDIMM_INPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("Opcode"),
        Windows_h.C_LONG.withName("OpcodeParametersLength"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_CHAR).withName("OpcodeParameters"),

...
public class _ULARGE_INTEGER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        MemoryLayout.structLayout(
            Windows_h.C_LONG.withName("LowPart"),
            Windows_h.C_LONG.withName("HighPart")
        ).withName("$anon$895:5"),
        _ULARGE_INTEGER.u.layout().withName("u"),
        Windows_h.C_LONG_LONG.withName("QuadPart")
    ...
    private static final OfInt LowPart$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$895:5"), groupElement("LowPart"));
    ...
    private static final OfInt HighPart$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$895:5"), groupElement("HighPart"));

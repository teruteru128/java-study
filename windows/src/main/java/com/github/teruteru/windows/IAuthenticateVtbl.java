 ...
 *     HRESULT (*QueryInterface)(IAuthenticate *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IAuthenticate *) __attribute__((stdcall));
 *     ULONG (*Release)(IAuthenticate *) __attribute__((stdcall));
 *     HRESULT (*Authenticate)(IAuthenticate *, HWND *, LPWSTR *, LPWSTR *) __attribute__((stdcall));
 * }
 * }
 */

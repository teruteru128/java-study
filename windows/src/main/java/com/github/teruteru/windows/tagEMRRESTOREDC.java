...
public class tagEMRRESTOREDC {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("iRelative")
    ...
    private static final OfInt iRelative$LAYOUT = (OfInt)$LAYOUT.select(groupElement("iRelative"));
     ...
     * }
     */
    public static final OfInt iRelative$layout() {
        return iRelative$LAYOUT;
    }

    private static final long iRelative$OFFSET = 8;
     ...
     * }
     */
    public static final long iRelative$offset() {
        return iRelative$OFFSET;
    }
     ...
     * }
     */
    public static int iRelative(MemorySegment struct) {
        return struct.get(iRelative$LAYOUT, iRelative$OFFSET);
    }
     ...
     * }
     */
    public static void iRelative(MemorySegment struct, int fieldValue) {
        struct.set(iRelative$LAYOUT, iRelative$OFFSET, fieldValue);
    }

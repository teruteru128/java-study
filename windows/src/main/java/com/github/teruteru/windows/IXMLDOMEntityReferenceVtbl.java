 ...
 *     HRESULT (*QueryInterface)(IXMLDOMEntityReference *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IXMLDOMEntityReference *) __attribute__((stdcall));
 *     ULONG (*Release)(IXMLDOMEntityReference *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfoCount)(IXMLDOMEntityReference *, UINT *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfo)(IXMLDOMEntityReference *, UINT, LCID, ITypeInfo **) __attribute__((stdcall));
 *     HRESULT (*GetIDsOfNames)(IXMLDOMEntityReference *, const IID *const, LPOLESTR *, UINT, LCID, DISPID *) __attribute__((stdcall));
 *     HRESULT (*Invoke)(IXMLDOMEntityReference *, DISPID, const IID *const, LCID, WORD, DISPPARAMS *, VARIANT *, EXCEPINFO *, UINT *) __attribute__((stdcall));
 *     HRESULT (*get_nodeName)(IXMLDOMEntityReference *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_nodeValue)(IXMLDOMEntityReference *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_nodeValue)(IXMLDOMEntityReference *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_nodeType)(IXMLDOMEntityReference *, DOMNodeType *) __attribute__((stdcall));
 *     HRESULT (*get_parentNode)(IXMLDOMEntityReference *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_childNodes)(IXMLDOMEntityReference *, IXMLDOMNodeList **) __attribute__((stdcall));
 *     HRESULT (*get_firstChild)(IXMLDOMEntityReference *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_lastChild)(IXMLDOMEntityReference *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_previousSibling)(IXMLDOMEntityReference *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nextSibling)(IXMLDOMEntityReference *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_attributes)(IXMLDOMEntityReference *, IXMLDOMNamedNodeMap **) __attribute__((stdcall));
 *     HRESULT (*insertBefore)(IXMLDOMEntityReference *, IXMLDOMNode *, VARIANT, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*replaceChild)(IXMLDOMEntityReference *, IXMLDOMNode *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*removeChild)(IXMLDOMEntityReference *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*appendChild)(IXMLDOMEntityReference *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*hasChildNodes)(IXMLDOMEntityReference *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_ownerDocument)(IXMLDOMEntityReference *, IXMLDOMDocument **) __attribute__((stdcall));
 *     HRESULT (*cloneNode)(IXMLDOMEntityReference *, VARIANT_BOOL, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nodeTypeString)(IXMLDOMEntityReference *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_text)(IXMLDOMEntityReference *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*put_text)(IXMLDOMEntityReference *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_specified)(IXMLDOMEntityReference *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_definition)(IXMLDOMEntityReference *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nodeTypedValue)(IXMLDOMEntityReference *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_nodeTypedValue)(IXMLDOMEntityReference *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_dataType)(IXMLDOMEntityReference *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_dataType)(IXMLDOMEntityReference *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_xml)(IXMLDOMEntityReference *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*transformNode)(IXMLDOMEntityReference *, IXMLDOMNode *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*selectNodes)(IXMLDOMEntityReference *, BSTR, IXMLDOMNodeList **) __attribute__((stdcall));
 *     HRESULT (*selectSingleNode)(IXMLDOMEntityReference *, BSTR, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_parsed)(IXMLDOMEntityReference *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_namespaceURI)(IXMLDOMEntityReference *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_prefix)(IXMLDOMEntityReference *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_baseName)(IXMLDOMEntityReference *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*transformNodeToObject)(IXMLDOMEntityReference *, IXMLDOMNode *, VARIANT) __attribute__((stdcall));
 * }
 * }
 */

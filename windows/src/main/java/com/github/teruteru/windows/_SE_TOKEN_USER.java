...
public class _SE_TOKEN_USER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ).withName("$anon$11571:5"),
        MemoryLayout.unionLayout(
            _SID.layout().withName("Sid"),
            MemoryLayout.sequenceLayout(68, Windows_h.C_CHAR).withName("Buffer")
        ).withName("$anon$11576:5"),
    ...
    private static final GroupLayout TokenUser$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$11571:5"), groupElement("TokenUser"));
    ...
    private static final GroupLayout User$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$11571:5"), groupElement("User"));
    ...
    private static final GroupLayout Sid$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$11576:5"), groupElement("Sid"));
    ...
    private static final SequenceLayout Buffer$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$11576:5"), groupElement("Buffer"));

...
public class _SERVERSILO_BASIC_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("ServiceSessionId"),
        Windows_h.C_INT.withName("State"),
        Windows_h.C_LONG.withName("ExitStatus"),
        Windows_h.C_CHAR.withName("IsDownlevelContainer"),
        MemoryLayout.paddingLayout(3),
        Windows_h.C_POINTER.withName("ApiSetSchema"),
        Windows_h.C_POINTER.withName("HostApiSetSchema")

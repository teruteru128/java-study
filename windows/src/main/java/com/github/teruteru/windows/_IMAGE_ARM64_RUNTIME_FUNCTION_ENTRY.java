...
public class _IMAGE_ARM64_RUNTIME_FUNCTION_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$19935:9")
        ).withName("$anon$19933:5")
    ...
    private static final OfInt UnwindData$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$19933:5"), groupElement("UnwindData"));

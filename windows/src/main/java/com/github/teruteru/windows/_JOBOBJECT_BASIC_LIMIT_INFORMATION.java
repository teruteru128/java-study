...
public class _JOBOBJECT_BASIC_LIMIT_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("ActiveProcessLimit"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_LONG_LONG.withName("Affinity"),
        Windows_h.C_LONG.withName("PriorityClass"),
        Windows_h.C_LONG.withName("SchedulingClass")

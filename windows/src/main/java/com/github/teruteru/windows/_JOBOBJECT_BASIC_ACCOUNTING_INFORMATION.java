...
public class _JOBOBJECT_BASIC_ACCOUNTING_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("TotalPageFaultCount"),
        Windows_h.C_LONG.withName("TotalProcesses"),
        Windows_h.C_LONG.withName("ActiveProcesses"),
        Windows_h.C_LONG.withName("TotalTerminatedProcesses")

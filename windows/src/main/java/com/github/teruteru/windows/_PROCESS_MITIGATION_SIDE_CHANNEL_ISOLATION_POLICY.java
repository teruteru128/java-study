 ...
 * }
 */
public class _PROCESS_MITIGATION_SIDE_CHANNEL_ISOLATION_POLICY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$12664:9")
        ).withName("$anon$12662:5")
    ...
    private static final OfInt Flags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12662:5"), groupElement("Flags"));

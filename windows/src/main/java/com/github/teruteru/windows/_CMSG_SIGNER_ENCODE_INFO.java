...
public class _CMSG_SIGNER_ENCODE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("cAuthAttr"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rgAuthAttr"),
        Windows_h.C_LONG.withName("cUnauthAttr"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rgUnauthAttr")
    ...
    private static final OfLong hCryptProv$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$6734:5"), groupElement("hCryptProv"));
    ...
    private static final OfLong hNCryptKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$6734:5"), groupElement("hNCryptKey"));

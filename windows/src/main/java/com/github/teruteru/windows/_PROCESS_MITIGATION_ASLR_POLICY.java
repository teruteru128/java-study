 ...
 * }
 */
public class _PROCESS_MITIGATION_ASLR_POLICY {
    ...
    private static final OfInt Flags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12490:5"), groupElement("Flags"));

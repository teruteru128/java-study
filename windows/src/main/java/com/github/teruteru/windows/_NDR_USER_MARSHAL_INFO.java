...
public class _NDR_USER_MARSHAL_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("InformationLevel"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            _NDR_USER_MARSHAL_INFO_LEVEL1.layout().withName("Level1")
        ).withName("$anon$3113:5")
    ...
    private static final GroupLayout Level1$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$3113:5"), groupElement("Level1"));

...
public class tagELEMDESC {
    ...
    private static final GroupLayout idldesc$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$733:5"), groupElement("idldesc"));
    ...
    private static final GroupLayout paramdesc$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$733:5"), groupElement("paramdesc"));

...
public class _SCM_PD_MANAGEMENT_STATUS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("Health"),
        Windows_h.C_LONG.withName("NumberOfOperationalStatus"),
        Windows_h.C_LONG.withName("NumberOfAdditionalReasons"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_INT).withName("OperationalStatus"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_INT).withName("AdditionalReasons")
    ...
    private static final VarHandle AdditionalReasons$ELEM_HANDLE = AdditionalReasons$LAYOUT.varHandle(sequenceElement());
     ...
     * }
     */
    public static int AdditionalReasons(MemorySegment struct, long index0) {
        return (int)AdditionalReasons$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void AdditionalReasons(MemorySegment struct, long index0, int fieldValue) {
        AdditionalReasons$ELEM_HANDLE.set(struct, 0L, index0, fieldValue);
    }

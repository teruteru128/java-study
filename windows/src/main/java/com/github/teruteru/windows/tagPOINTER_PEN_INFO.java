...
public class tagPOINTER_PEN_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("penFlags"),
        Windows_h.C_INT.withName("penMask"),
        Windows_h.C_INT.withName("pressure"),
        Windows_h.C_INT.withName("rotation"),
        Windows_h.C_INT.withName("tiltX"),
        Windows_h.C_INT.withName("tiltY")

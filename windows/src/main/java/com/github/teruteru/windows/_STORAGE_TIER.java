...
public class _STORAGE_TIER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(256, Windows_h.C_SHORT).withName("Name"),
        MemoryLayout.sequenceLayout(256, Windows_h.C_SHORT).withName("Description"),
        Windows_h.C_LONG_LONG.withName("Flags"),
        Windows_h.C_LONG_LONG.withName("ProvisionedCapacity"),
        Windows_h.C_INT.withName("MediaType"),
        Windows_h.C_INT.withName("Class")

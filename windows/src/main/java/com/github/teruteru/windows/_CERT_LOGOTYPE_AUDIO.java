...
public class _CERT_LOGOTYPE_AUDIO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("pLogotypeAudioInfo")
    ...
    private static final AddressLayout pLogotypeAudioInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("pLogotypeAudioInfo"));
     ...
     * }
     */
    public static final AddressLayout pLogotypeAudioInfo$layout() {
        return pLogotypeAudioInfo$LAYOUT;
    }

    private static final long pLogotypeAudioInfo$OFFSET = 24;
     ...
     * }
     */
    public static final long pLogotypeAudioInfo$offset() {
        return pLogotypeAudioInfo$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment pLogotypeAudioInfo(MemorySegment struct) {
        return struct.get(pLogotypeAudioInfo$LAYOUT, pLogotypeAudioInfo$OFFSET);
    }
     ...
     * }
     */
    public static void pLogotypeAudioInfo(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(pLogotypeAudioInfo$LAYOUT, pLogotypeAudioInfo$OFFSET, fieldValue);
    }

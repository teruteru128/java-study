...
public class _IMAGE_FUNCTION_ENTRY64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.align(Windows_h.C_LONG_LONG, 4).withName("StartingAddress"),
        Windows_h.align(Windows_h.C_LONG_LONG, 4).withName("EndingAddress"),
        MemoryLayout.unionLayout(
            Windows_h.align(Windows_h.C_LONG_LONG, 4).withName("EndOfPrologue"),
            Windows_h.align(Windows_h.C_LONG_LONG, 4).withName("UnwindInfoAddress")
        ).withName("$anon$20188:5")
    ...
    private static final OfLong EndOfPrologue$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$20188:5"), groupElement("EndOfPrologue"));
    ...
    private static final OfLong UnwindInfoAddress$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$20188:5"), groupElement("UnwindInfoAddress"));

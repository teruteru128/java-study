...
public class _PROPSHEETHEADERW_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("hwndParent"),
        Windows_h.C_POINTER.withName("hInstance"),
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("hIcon"),
            Windows_h.C_POINTER.withName("pszIcon")
        ).withName("$anon$526:5"),
        Windows_h.C_POINTER.withName("pszCaption"),
        Windows_h.C_INT.withName("nPages"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            Windows_h.C_INT.withName("nStartPage"),
            Windows_h.C_POINTER.withName("pStartPage")
        ).withName("$anon$526:5"),
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("ppsp"),
            Windows_h.C_POINTER.withName("phpage")
        ).withName("$anon$526:5"),
        Windows_h.C_POINTER.withName("pfnCallback"),
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("hbmWatermark"),
            Windows_h.C_POINTER.withName("pszbmWatermark")
        ).withName("$anon$527:5"),
        Windows_h.C_POINTER.withName("hplWatermark"),
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("hbmHeader"),
            Windows_h.C_POINTER.withName("pszbmHeader")
        ).withName("$anon$533:5")
    ...
    private static final AddressLayout hIcon$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$526:5"), groupElement("hIcon"));
    ...
    private static final AddressLayout pszIcon$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$526:5"), groupElement("pszIcon"));
    ...
    private static final OfInt nStartPage$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$526:5"), groupElement("nStartPage"));
    ...
    private static final AddressLayout pStartPage$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$526:5"), groupElement("pStartPage"));
    ...
    private static final AddressLayout ppsp$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$526:5"), groupElement("ppsp"));
    ...
    private static final AddressLayout phpage$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$526:5"), groupElement("phpage"));
    ...
    private static final AddressLayout hbmWatermark$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$527:5"), groupElement("hbmWatermark"));
    ...
    private static final AddressLayout pszbmWatermark$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$527:5"), groupElement("pszbmWatermark"));
    ...
    private static final AddressLayout hbmHeader$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$533:5"), groupElement("hbmHeader"));
    ...
    private static final AddressLayout pszbmHeader$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$533:5"), groupElement("pszbmHeader"));

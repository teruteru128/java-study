...
public class _DEVICE_POWER_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_CHAR.withName("DeviceAttentionSupported"),
        Windows_h.C_CHAR.withName("AsynchronousNotificationSupported"),
        Windows_h.C_CHAR.withName("IdlePowerManagementEnabled"),
        Windows_h.C_CHAR.withName("D3ColdEnabled"),
        Windows_h.C_CHAR.withName("D3ColdSupported"),
        Windows_h.C_CHAR.withName("NoVerifyDuringIdlePower"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("Reserved"),
        Windows_h.C_LONG.withName("IdleTimeoutInMS")

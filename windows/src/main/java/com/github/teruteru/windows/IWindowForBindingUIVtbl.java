 ...
 *     HRESULT (*QueryInterface)(IWindowForBindingUI *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IWindowForBindingUI *) __attribute__((stdcall));
 *     ULONG (*Release)(IWindowForBindingUI *) __attribute__((stdcall));
 *     HRESULT (*GetWindow)(IWindowForBindingUI *, const GUID *const, HWND *) __attribute__((stdcall));
 * }
 * }
 */

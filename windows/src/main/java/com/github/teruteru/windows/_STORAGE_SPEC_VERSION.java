...
public class _STORAGE_SPEC_VERSION {
    ...
    public static class MinorVersion {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                Windows_h.C_CHAR.withName("SubMinor"),
                Windows_h.C_CHAR.withName("Minor")
            ).withName("$anon$2532:13"),
            Windows_h.C_SHORT.withName("AsUshort")
        ).withName("$anon$2531:9");
        ...
        private static final OfByte SubMinor$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$2532:13"), groupElement("SubMinor"));
        ...
        private static final OfByte Minor$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$2532:13"), groupElement("Minor"));
    ...
    private static final GroupLayout MinorVersion$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$2530:5"), groupElement("MinorVersion"));
    ...
    private static final OfShort MajorVersion$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2530:5"), groupElement("MajorVersion"));

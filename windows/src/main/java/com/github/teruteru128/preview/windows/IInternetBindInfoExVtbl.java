 ...
 *     HRESULT (*QueryInterface)(IInternetBindInfoEx *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IInternetBindInfoEx *) __attribute__((stdcall));
 *     ULONG (*Release)(IInternetBindInfoEx *) __attribute__((stdcall));
 *     HRESULT (*GetBindInfo)(IInternetBindInfoEx *, DWORD *, BINDINFO *) __attribute__((stdcall));
 *     HRESULT (*GetBindString)(IInternetBindInfoEx *, ULONG, LPOLESTR *, ULONG, ULONG *) __attribute__((stdcall));
 *     HRESULT (*GetBindInfoEx)(IInternetBindInfoEx *, DWORD *, BINDINFO *, DWORD *, DWORD *) __attribute__((stdcall));
 * }
 * }
 */
public class IInternetBindInfoExVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("GetBindInfo"),
        Windows_h.C_POINTER.withName("GetBindString"),
        Windows_h.C_POINTER.withName("GetBindInfoEx")
    ...
    public static class GetBindInfo {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(GetBindInfo.Function.class, "apply", $DESC);
    ...
    private static final long GetBindInfo$OFFSET = 24;
     ...
     * }
     */
    public static class GetBindString {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(GetBindString.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(GetBindString.Function fi, Arena arena) {
            return Linker.nativeLinker().upcallStub(UP$MH.bindTo(fi), $DESC, arena);
        }
    ...
    private static final AddressLayout GetBindString$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("GetBindString"));
     ...
     * }
     */
    public static final AddressLayout GetBindString$layout() {
        return GetBindString$LAYOUT;
    }

    private static final long GetBindString$OFFSET = 32;
     ...
     * }
     */
    public static final long GetBindString$offset() {
        return GetBindString$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment GetBindString(MemorySegment struct) {
        return struct.get(GetBindString$LAYOUT, GetBindString$OFFSET);
    }
     ...
     * }
     */
    public static void GetBindString(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(GetBindString$LAYOUT, GetBindString$OFFSET, fieldValue);
    }
    ...
    public static class GetBindInfoEx {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(GetBindInfoEx.Function.class, "apply", $DESC);
    ...
    private static final long GetBindInfoEx$OFFSET = 40;

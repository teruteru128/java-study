...
public class _CERT_USAGE_MATCH {
    ...
    private static final GroupLayout Usage$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("Usage"));
     ...
     * }
     */
    public static final GroupLayout Usage$layout() {
        return Usage$LAYOUT;
    }

    private static final long Usage$OFFSET = 8;
    ...
    public static MemorySegment Usage(MemorySegment struct) {
        return struct.asSlice(Usage$OFFSET, Usage$LAYOUT.byteSize());
    }
    ...
    public static void Usage(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, Usage$OFFSET, Usage$LAYOUT.byteSize());
    }

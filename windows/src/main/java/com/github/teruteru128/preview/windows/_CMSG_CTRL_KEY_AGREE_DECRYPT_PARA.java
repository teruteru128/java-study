...
public class _CMSG_CTRL_KEY_AGREE_DECRYPT_PARA {
    ...
    private static final OfLong hCryptProv$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$8091:5"), groupElement("hCryptProv"));
    ...
    private static final OfLong hNCryptKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$8091:5"), groupElement("hNCryptKey"));

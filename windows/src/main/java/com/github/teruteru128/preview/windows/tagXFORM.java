...
public class tagXFORM {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_FLOAT.withName("eM11"),
        Windows_h.C_FLOAT.withName("eM12"),
        Windows_h.C_FLOAT.withName("eM21"),
        Windows_h.C_FLOAT.withName("eM22"),
        Windows_h.C_FLOAT.withName("eDx"),
        Windows_h.C_FLOAT.withName("eDy")
    ).withName("tagXFORM");

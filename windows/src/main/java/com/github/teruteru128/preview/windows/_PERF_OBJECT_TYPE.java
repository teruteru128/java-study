...
public class _PERF_OBJECT_TYPE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("TotalByteLength"),
        Windows_h.C_LONG.withName("DefinitionLength"),
        Windows_h.C_LONG.withName("HeaderLength"),
        Windows_h.C_LONG.withName("ObjectNameTitleIndex"),
        Windows_h.C_LONG.withName("ObjectNameTitle"),
        Windows_h.C_LONG.withName("ObjectHelpTitleIndex"),
        Windows_h.C_LONG.withName("ObjectHelpTitle"),
        Windows_h.C_LONG.withName("DetailLevel"),
        Windows_h.C_LONG.withName("NumCounters"),
        Windows_h.C_LONG.withName("DefaultCounter"),
        Windows_h.C_LONG.withName("NumInstances"),
        Windows_h.C_LONG.withName("CodePage"),

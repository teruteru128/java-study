...
public class USN_RECORD_V2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("RecordLength"),
        Windows_h.C_SHORT.withName("MajorVersion"),
        Windows_h.C_SHORT.withName("MinorVersion"),
        Windows_h.C_LONG_LONG.withName("FileReferenceNumber"),
        Windows_h.C_LONG_LONG.withName("ParentFileReferenceNumber"),
        Windows_h.C_LONG_LONG.withName("Usn"),
        _LARGE_INTEGER.layout().withName("TimeStamp"),
        Windows_h.C_LONG.withName("Reason"),
        Windows_h.C_LONG.withName("SourceInfo"),
        Windows_h.C_LONG.withName("SecurityId"),
        Windows_h.C_LONG.withName("FileAttributes"),
        Windows_h.C_SHORT.withName("FileNameLength"),
        Windows_h.C_SHORT.withName("FileNameOffset"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_SHORT).withName("FileName"),
        MemoryLayout.paddingLayout(2)
    ).withName("$anon$11560:9");

...
public class _PSFEATURE_CUSTPAPER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("lOrientation"),
        Windows_h.C_LONG.withName("lWidth"),
        Windows_h.C_LONG.withName("lHeight"),
        Windows_h.C_LONG.withName("lWidthOffset"),
        Windows_h.C_LONG.withName("lHeightOffset")

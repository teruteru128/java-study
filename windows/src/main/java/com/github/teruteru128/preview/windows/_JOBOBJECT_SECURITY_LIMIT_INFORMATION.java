...
public class _JOBOBJECT_SECURITY_LIMIT_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("SecurityLimitFlags"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("JobToken"),
        Windows_h.C_POINTER.withName("SidsToDisable"),
        Windows_h.C_POINTER.withName("PrivilegesToDelete"),

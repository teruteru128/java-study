...
public class _CMSG_KEY_AGREE_ENCRYPT_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ).withName("$anon$8617:5"),
        Windows_h.C_LONG.withName("cKeyAgreeKeyEncryptInfo"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rgpKeyAgreeKeyEncryptInfo"),
    ...
    private static final GroupLayout OriginatorCertId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$8617:5"), groupElement("OriginatorCertId"));
    ...
    private static final GroupLayout OriginatorPublicKeyInfo$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$8617:5"), groupElement("OriginatorPublicKeyInfo"));

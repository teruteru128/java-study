...
public class tagRAWMOUSE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_SHORT.withName("usFlags"),
        MemoryLayout.paddingLayout(2),
        MemoryLayout.unionLayout(
            Windows_h.C_LONG.withName("ulButtons"),
            MemoryLayout.structLayout(
                Windows_h.C_SHORT.withName("usButtonFlags"),
                Windows_h.C_SHORT.withName("usButtonData")
            ).withName("$anon$14935:9")
        ).withName("$anon$14933:5"),
        Windows_h.C_LONG.withName("ulRawButtons"),
        Windows_h.C_LONG.withName("lLastX"),
        Windows_h.C_LONG.withName("lLastY"),
        Windows_h.C_LONG.withName("ulExtraInformation")
    ...
    private static final OfInt ulButtons$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$14933:5"), groupElement("ulButtons"));
    ...
    private static final OfShort usButtonFlags$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$14933:5"), groupElement("$anon$14935:9"), groupElement("usButtonFlags"));
    ...
    private static final OfShort usButtonData$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$14933:5"), groupElement("$anon$14935:9"), groupElement("usButtonData"));

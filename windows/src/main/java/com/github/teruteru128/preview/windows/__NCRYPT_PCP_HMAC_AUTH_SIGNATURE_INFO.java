...
public class __NCRYPT_PCP_HMAC_AUTH_SIGNATURE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("iExpiration"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("pabNonce"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("pabPolicyRef"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("pabHMAC")

...
public class _UMS_SYSTEM_THREAD_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            ...
            ).withName("$anon$1584:9"),
            Windows_h.C_LONG.withName("ThreadUmsFlags")
        ).withName("$anon$1583:5")
    ...
    private static final OfInt ThreadUmsFlags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$1583:5"), groupElement("ThreadUmsFlags"));

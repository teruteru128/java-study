...
public class _OFSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("cBytes"),
        Windows_h.C_CHAR.withName("fFixedDisk"),
        Windows_h.C_SHORT.withName("nErrCode"),
        Windows_h.C_SHORT.withName("Reserved1"),
        Windows_h.C_SHORT.withName("Reserved2"),
        MemoryLayout.sequenceLayout(128, Windows_h.C_CHAR).withName("szPathName")
    ).withName("_OFSTRUCT");

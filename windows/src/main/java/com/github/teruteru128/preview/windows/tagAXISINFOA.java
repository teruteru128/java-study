...
public class tagAXISINFOA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("axMinValue"),
        Windows_h.C_LONG.withName("axMaxValue"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("axAxisName")
     ...
     * }
     */
    public static byte axAxisName(MemorySegment struct, long index0) {
        return (byte)axAxisName$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void axAxisName(MemorySegment struct, long index0, byte fieldValue) {

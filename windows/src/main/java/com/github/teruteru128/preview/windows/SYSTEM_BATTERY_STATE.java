...
public class SYSTEM_BATTERY_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("AcOnLine"),
        Windows_h.C_CHAR.withName("BatteryPresent"),
        Windows_h.C_CHAR.withName("Charging"),
        Windows_h.C_CHAR.withName("Discharging"),
        MemoryLayout.sequenceLayout(3, Windows_h.C_CHAR).withName("Spare1"),
        Windows_h.C_CHAR.withName("Tag"),
        Windows_h.C_LONG.withName("MaxCapacity"),
        Windows_h.C_LONG.withName("RemainingCapacity"),
        Windows_h.C_LONG.withName("Rate"),
        Windows_h.C_LONG.withName("EstimatedTime"),
        Windows_h.C_LONG.withName("DefaultAlert1"),
        Windows_h.C_LONG.withName("DefaultAlert2")
    ).withName("$anon$17933:9");

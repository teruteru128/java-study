...
public class _CHANGER_PRODUCT_DATA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(8, Windows_h.C_CHAR).withName("VendorId"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("ProductId"),
        MemoryLayout.sequenceLayout(4, Windows_h.C_CHAR).withName("Revision"),

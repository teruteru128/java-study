...
public class tagNEWTEXTMETRICW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("tmHeight"),
        Windows_h.C_LONG.withName("tmAscent"),
        Windows_h.C_LONG.withName("tmDescent"),
        Windows_h.C_LONG.withName("tmInternalLeading"),
        Windows_h.C_LONG.withName("tmExternalLeading"),
        Windows_h.C_LONG.withName("tmAveCharWidth"),
        Windows_h.C_LONG.withName("tmMaxCharWidth"),
        Windows_h.C_LONG.withName("tmWeight"),
        Windows_h.C_LONG.withName("tmOverhang"),
        Windows_h.C_LONG.withName("tmDigitizedAspectX"),
        Windows_h.C_LONG.withName("tmDigitizedAspectY"),
        Windows_h.C_SHORT.withName("tmFirstChar"),
        Windows_h.C_SHORT.withName("tmLastChar"),
        Windows_h.C_SHORT.withName("tmDefaultChar"),
        Windows_h.C_SHORT.withName("tmBreakChar"),
        Windows_h.C_CHAR.withName("tmItalic"),
        Windows_h.C_CHAR.withName("tmUnderlined"),
        Windows_h.C_CHAR.withName("tmStruckOut"),
        Windows_h.C_CHAR.withName("tmPitchAndFamily"),
        Windows_h.C_CHAR.withName("tmCharSet"),
        MemoryLayout.paddingLayout(3),
        Windows_h.C_LONG.withName("ntmFlags"),
        Windows_h.C_INT.withName("ntmSizeEM"),
        Windows_h.C_INT.withName("ntmCellHeight"),
        Windows_h.C_INT.withName("ntmAvgWidth")

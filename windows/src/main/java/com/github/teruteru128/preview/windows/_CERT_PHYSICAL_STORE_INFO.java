...
public class _CERT_PHYSICAL_STORE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("pszOpenStoreProvider"),
        Windows_h.C_LONG.withName("dwOpenEncodingType"),
        Windows_h.C_LONG.withName("dwOpenFlags"),
        _CRYPTOAPI_BLOB.layout().withName("OpenParameters"),
        Windows_h.C_LONG.withName("dwFlags"),
        Windows_h.C_LONG.withName("dwPriority")

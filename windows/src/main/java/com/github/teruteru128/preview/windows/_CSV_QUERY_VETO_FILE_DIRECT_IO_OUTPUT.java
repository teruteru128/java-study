...
public class _CSV_QUERY_VETO_FILE_DIRECT_IO_OUTPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("VetoedFromAltitudeIntegral"),
        Windows_h.C_LONG_LONG.withName("VetoedFromAltitudeDecimal"),
        MemoryLayout.sequenceLayout(256, Windows_h.C_SHORT).withName("Reason")

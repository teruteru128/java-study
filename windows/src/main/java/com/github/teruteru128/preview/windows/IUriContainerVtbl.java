 ...
 *     HRESULT (*QueryInterface)(IUriContainer *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IUriContainer *) __attribute__((stdcall));
 *     ULONG (*Release)(IUriContainer *) __attribute__((stdcall));
 *     HRESULT (*GetIUri)(IUriContainer *, IUri **) __attribute__((stdcall));
 * }
 * }
 */
public class IUriContainerVtbl {
    ...
    private static final long GetIUri$OFFSET = 24;

 ...
 *     HRESULT (*QueryInterface)(IEnumSTATDATA *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IEnumSTATDATA *) __attribute__((stdcall));
 *     ULONG (*Release)(IEnumSTATDATA *) __attribute__((stdcall));
 *     HRESULT (*Next)(IEnumSTATDATA *, ULONG, STATDATA *, ULONG *) __attribute__((stdcall));
 *     HRESULT (*Skip)(IEnumSTATDATA *, ULONG) __attribute__((stdcall));
 *     HRESULT (*Reset)(IEnumSTATDATA *) __attribute__((stdcall));
 *     HRESULT (*Clone)(IEnumSTATDATA *, IEnumSTATDATA **) __attribute__((stdcall));
 * }
 * }
 */

...
public class tagENUMLOGFONTEXW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(64, Windows_h.C_SHORT).withName("elfFullName"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_SHORT).withName("elfStyle"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_SHORT).withName("elfScript")
    ...
    private static final SequenceLayout elfScript$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("elfScript"));
     ...
     * }
     */
    public static final SequenceLayout elfScript$layout() {
        return elfScript$LAYOUT;
    }

    private static final long elfScript$OFFSET = 284;
     ...
     * }
     */
    public static final long elfScript$offset() {
        return elfScript$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment elfScript(MemorySegment struct) {
        return struct.asSlice(elfScript$OFFSET, elfScript$LAYOUT.byteSize());
    }
     ...
     * }
     */
    public static void elfScript(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, elfScript$OFFSET, elfScript$LAYOUT.byteSize());
    }

    private static long[] elfScript$DIMS = { 32 };
     ...
     * }
     */
    public static long[] elfScript$dimensions() {
        return elfScript$DIMS;
    }
    private static final VarHandle elfScript$ELEM_HANDLE = elfScript$LAYOUT.varHandle(sequenceElement());
     ...
     * }
     */
    public static short elfScript(MemorySegment struct, long index0) {
        return (short)elfScript$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void elfScript(MemorySegment struct, long index0, short fieldValue) {
        elfScript$ELEM_HANDLE.set(struct, 0L, index0, fieldValue);
    }

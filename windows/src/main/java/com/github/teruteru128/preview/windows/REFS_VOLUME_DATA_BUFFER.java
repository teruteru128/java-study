...
public class REFS_VOLUME_DATA_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("ByteCount"),
        Windows_h.C_LONG.withName("MajorVersion"),
        Windows_h.C_LONG.withName("MinorVersion"),
        ...
        Windows_h.C_LONG.withName("BytesPerCluster"),
        _LARGE_INTEGER.layout().withName("MaximumSizeOfResidentFile"),
        Windows_h.C_SHORT.withName("FastTierDataFillRatio"),
        Windows_h.C_SHORT.withName("SlowTierDataFillRatio"),
        Windows_h.C_LONG.withName("DestagesFastTierToSlowTierRate"),
        MemoryLayout.sequenceLayout(9, _LARGE_INTEGER.layout()).withName("Reserved")
    ).withName("$anon$11205:9");

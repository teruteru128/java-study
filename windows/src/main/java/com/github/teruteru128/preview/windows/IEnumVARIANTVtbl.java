 ...
 *     HRESULT (*QueryInterface)(IEnumVARIANT *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IEnumVARIANT *) __attribute__((stdcall));
 *     ULONG (*Release)(IEnumVARIANT *) __attribute__((stdcall));
 *     HRESULT (*Next)(IEnumVARIANT *, ULONG, VARIANT *, ULONG *) __attribute__((stdcall));
 *     HRESULT (*Skip)(IEnumVARIANT *, ULONG) __attribute__((stdcall));
 *     HRESULT (*Reset)(IEnumVARIANT *) __attribute__((stdcall));
 *     HRESULT (*Clone)(IEnumVARIANT *, IEnumVARIANT **) __attribute__((stdcall));
 * }
 * }
 */

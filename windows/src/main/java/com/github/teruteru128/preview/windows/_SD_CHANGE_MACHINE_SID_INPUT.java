...
public class _SD_CHANGE_MACHINE_SID_INPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_SHORT.withName("CurrentMachineSIDOffset"),
        Windows_h.C_SHORT.withName("CurrentMachineSIDLength"),
        Windows_h.C_SHORT.withName("NewMachineSIDOffset"),
        Windows_h.C_SHORT.withName("NewMachineSIDLength")

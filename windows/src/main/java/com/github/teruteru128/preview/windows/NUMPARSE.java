...
public class NUMPARSE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_INT.withName("cDig"),
        Windows_h.C_LONG.withName("dwInFlags"),
        Windows_h.C_LONG.withName("dwOutFlags"),
        Windows_h.C_INT.withName("cchUsed"),
        Windows_h.C_INT.withName("nBaseShift"),
        Windows_h.C_INT.withName("nPwr10")
    ).withName("$anon$735:9");

...
public class _HMAC_Info {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_INT.withName("HashAlgid"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("pbInnerString"),
        Windows_h.C_LONG.withName("cbInnerString"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("pbOuterString"),
        Windows_h.C_LONG.withName("cbOuterString"),
        MemoryLayout.paddingLayout(4)
    ).withName("_HMAC_Info");

...
public class tagUPDATELAYEREDWINDOWINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("hdcDst"),
        Windows_h.C_POINTER.withName("pptDst"),
        Windows_h.C_POINTER.withName("psize"),
        Windows_h.C_POINTER.withName("hdcSrc"),
        Windows_h.C_POINTER.withName("pptSrc"),
        Windows_h.C_LONG.withName("crKey"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("pblend"),
        Windows_h.C_LONG.withName("dwFlags"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("prcDirty")

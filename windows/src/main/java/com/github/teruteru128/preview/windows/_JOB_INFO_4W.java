...
public class _JOB_INFO_4W {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("SizeHigh")
    ...
    private static final OfInt SizeHigh$LAYOUT = (OfInt)$LAYOUT.select(groupElement("SizeHigh"));
     ...
     * }
     */
    public static final OfInt SizeHigh$layout() {
        return SizeHigh$LAYOUT;
    }

    private static final long SizeHigh$OFFSET = 156;
     ...
     * }
     */
    public static final long SizeHigh$offset() {
        return SizeHigh$OFFSET;
    }
     ...
     * }
     */
    public static int SizeHigh(MemorySegment struct) {
        return struct.get(SizeHigh$LAYOUT, SizeHigh$OFFSET);
    }
     ...
     * }
     */
    public static void SizeHigh(MemorySegment struct, int fieldValue) {
        struct.set(SizeHigh$LAYOUT, SizeHigh$OFFSET, fieldValue);
    }

...
public class _CERT_LOGOTYPE_EXT_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("cCommunityLogo"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rgCommunityLogo"),
        Windows_h.C_POINTER.withName("pIssuerLogo"),
        Windows_h.C_POINTER.withName("pSubjectLogo"),
        Windows_h.C_LONG.withName("cOtherLogo"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("rgOtherLogo")

...
public class _STORAGE_QUERY_DEPENDENT_VOLUME_LEV2_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("EntryLength"),
        Windows_h.C_LONG.withName("DependencyTypeFlags"),
        Windows_h.C_LONG.withName("ProviderSpecificFlags"),
        _VIRTUAL_STORAGE_TYPE.layout().withName("VirtualStorageType"),
        Windows_h.C_LONG.withName("AncestorLevel"),
        Windows_h.C_LONG.withName("HostVolumeNameOffset"),
        Windows_h.C_LONG.withName("HostVolumeNameSize"),
        Windows_h.C_LONG.withName("DependentVolumeNameOffset"),
        Windows_h.C_LONG.withName("DependentVolumeNameSize"),
        Windows_h.C_LONG.withName("RelativePathOffset"),
        Windows_h.C_LONG.withName("RelativePathSize"),
        Windows_h.C_LONG.withName("DependentDeviceNameOffset"),
        Windows_h.C_LONG.withName("DependentDeviceNameSize")

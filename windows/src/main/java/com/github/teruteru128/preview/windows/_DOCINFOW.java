...
public class _DOCINFOW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("lpszDocName"),
        Windows_h.C_POINTER.withName("lpszOutput"),
        Windows_h.C_POINTER.withName("lpszDatatype"),
        Windows_h.C_LONG.withName("fwType"),
        MemoryLayout.paddingLayout(4)
    ).withName("_DOCINFOW");

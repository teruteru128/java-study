...
public class _DEVICEDUMP_STORAGESTACK_PUBLIC_STATE_RECORD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("Cdb"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("Command"),
        Windows_h.align(Windows_h.C_LONG_LONG, 1).withName("StartTime"),
        Windows_h.align(Windows_h.C_LONG_LONG, 1).withName("EndTime"),
        Windows_h.align(Windows_h.C_LONG, 1).withName("OperationStatus"),
        Windows_h.align(Windows_h.C_LONG, 1).withName("OperationError"),
    ...
    public static class StackSpecific {
        ...
        public static class ExternalStack {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                Windows_h.align(Windows_h.C_LONG, 1).withName("dwReserved")
            ).withName("$anon$6137:10");
        ...
        public static class AtaPort {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                Windows_h.align(Windows_h.C_LONG, 1).withName("dwAtaPortSpecific")
            ).withName("$anon$6141:10");
        ...
        public static class StorPort {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                Windows_h.align(Windows_h.C_LONG, 1).withName("SrbTag")
            ).withName("$anon$6145:10");

...
public class _SCRUB_DATA_INPUT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("MaximumIos"),
        MemoryLayout.sequenceLayout(4, Windows_h.C_LONG).withName("ObjectId"),
        MemoryLayout.sequenceLayout(41, Windows_h.C_LONG).withName("Reserved"),

...
public class MFT_ENUM_DATA_V1 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("StartFileReferenceNumber"),
        Windows_h.C_LONG_LONG.withName("LowUsn"),
        Windows_h.C_LONG_LONG.withName("HighUsn"),
        Windows_h.C_SHORT.withName("MinMajorVersion"),
        Windows_h.C_SHORT.withName("MaxMajorVersion"),
        MemoryLayout.paddingLayout(4)
    ).withName("$anon$11437:9");

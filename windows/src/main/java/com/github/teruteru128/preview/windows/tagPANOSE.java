...
public class tagPANOSE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("bFamilyType"),
        Windows_h.C_CHAR.withName("bSerifStyle"),
        Windows_h.C_CHAR.withName("bWeight"),
        Windows_h.C_CHAR.withName("bProportion"),
        Windows_h.C_CHAR.withName("bContrast"),
        Windows_h.C_CHAR.withName("bStrokeVariation"),
        Windows_h.C_CHAR.withName("bArmStyle"),
        Windows_h.C_CHAR.withName("bLetterform"),
        Windows_h.C_CHAR.withName("bMidline"),
        Windows_h.C_CHAR.withName("bXHeight")
    ).withName("tagPANOSE");

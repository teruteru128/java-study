 ...
 *     HRESULT (*QueryInterface)(IXMLDOMDocumentFragment *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IXMLDOMDocumentFragment *) __attribute__((stdcall));
 *     ULONG (*Release)(IXMLDOMDocumentFragment *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfoCount)(IXMLDOMDocumentFragment *, UINT *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfo)(IXMLDOMDocumentFragment *, UINT, LCID, ITypeInfo **) __attribute__((stdcall));
 *     HRESULT (*GetIDsOfNames)(IXMLDOMDocumentFragment *, const IID *const, LPOLESTR *, UINT, LCID, DISPID *) __attribute__((stdcall));
 *     HRESULT (*Invoke)(IXMLDOMDocumentFragment *, DISPID, const IID *const, LCID, WORD, DISPPARAMS *, VARIANT *, EXCEPINFO *, UINT *) __attribute__((stdcall));
 *     HRESULT (*get_nodeName)(IXMLDOMDocumentFragment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_nodeValue)(IXMLDOMDocumentFragment *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_nodeValue)(IXMLDOMDocumentFragment *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_nodeType)(IXMLDOMDocumentFragment *, DOMNodeType *) __attribute__((stdcall));
 *     HRESULT (*get_parentNode)(IXMLDOMDocumentFragment *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_childNodes)(IXMLDOMDocumentFragment *, IXMLDOMNodeList **) __attribute__((stdcall));
 *     HRESULT (*get_firstChild)(IXMLDOMDocumentFragment *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_lastChild)(IXMLDOMDocumentFragment *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_previousSibling)(IXMLDOMDocumentFragment *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nextSibling)(IXMLDOMDocumentFragment *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_attributes)(IXMLDOMDocumentFragment *, IXMLDOMNamedNodeMap **) __attribute__((stdcall));
 *     HRESULT (*insertBefore)(IXMLDOMDocumentFragment *, IXMLDOMNode *, VARIANT, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*replaceChild)(IXMLDOMDocumentFragment *, IXMLDOMNode *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*removeChild)(IXMLDOMDocumentFragment *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*appendChild)(IXMLDOMDocumentFragment *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*hasChildNodes)(IXMLDOMDocumentFragment *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_ownerDocument)(IXMLDOMDocumentFragment *, IXMLDOMDocument **) __attribute__((stdcall));
 *     HRESULT (*cloneNode)(IXMLDOMDocumentFragment *, VARIANT_BOOL, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nodeTypeString)(IXMLDOMDocumentFragment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_text)(IXMLDOMDocumentFragment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*put_text)(IXMLDOMDocumentFragment *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_specified)(IXMLDOMDocumentFragment *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_definition)(IXMLDOMDocumentFragment *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nodeTypedValue)(IXMLDOMDocumentFragment *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_nodeTypedValue)(IXMLDOMDocumentFragment *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_dataType)(IXMLDOMDocumentFragment *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_dataType)(IXMLDOMDocumentFragment *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_xml)(IXMLDOMDocumentFragment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*transformNode)(IXMLDOMDocumentFragment *, IXMLDOMNode *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*selectNodes)(IXMLDOMDocumentFragment *, BSTR, IXMLDOMNodeList **) __attribute__((stdcall));
 *     HRESULT (*selectSingleNode)(IXMLDOMDocumentFragment *, BSTR, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_parsed)(IXMLDOMDocumentFragment *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_namespaceURI)(IXMLDOMDocumentFragment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_prefix)(IXMLDOMDocumentFragment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_baseName)(IXMLDOMDocumentFragment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*transformNodeToObject)(IXMLDOMDocumentFragment *, IXMLDOMNode *, VARIANT) __attribute__((stdcall));
 * }
 * }
 */

...
public class tagMCI_WAVE_OPEN_PARMSA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.align(Windows_h.C_LONG, 1).withName("dwBufferSeconds")
    ...
    private static final OfInt dwBufferSeconds$LAYOUT = (OfInt)$LAYOUT.select(groupElement("dwBufferSeconds"));
     ...
     * }
     */
    public static final OfInt dwBufferSeconds$layout() {
        return dwBufferSeconds$LAYOUT;
    }

    private static final long dwBufferSeconds$OFFSET = 36;
     ...
     * }
     */
    public static final long dwBufferSeconds$offset() {
        return dwBufferSeconds$OFFSET;
    }
     ...
     * }
     */
    public static int dwBufferSeconds(MemorySegment struct) {
        return struct.get(dwBufferSeconds$LAYOUT, dwBufferSeconds$OFFSET);
    }
     ...
     * }
     */
    public static void dwBufferSeconds(MemorySegment struct, int fieldValue) {
        struct.set(dwBufferSeconds$LAYOUT, dwBufferSeconds$OFFSET, fieldValue);
    }

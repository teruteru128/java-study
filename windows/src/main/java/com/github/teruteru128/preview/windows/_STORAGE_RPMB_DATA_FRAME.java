...
public class _STORAGE_RPMB_DATA_FRAME {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(196, Windows_h.C_CHAR).withName("Stuff"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("KeyOrMAC"),
        MemoryLayout.sequenceLayout(256, Windows_h.C_CHAR).withName("Data"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("Nonce"),
        MemoryLayout.sequenceLayout(4, Windows_h.C_CHAR).withName("WriteCounter"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("Address"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("BlockCount"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("OperationResult"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("RequestOrResponseType")

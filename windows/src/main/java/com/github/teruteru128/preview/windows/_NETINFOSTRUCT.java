...
public class _NETINFOSTRUCT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("dwProviderVersion"),
        Windows_h.C_LONG.withName("dwStatus"),
        Windows_h.C_LONG.withName("dwCharacteristics"),
        Windows_h.C_LONG_LONG.withName("dwHandle"),
        Windows_h.C_SHORT.withName("wNetType"),
        MemoryLayout.paddingLayout(2),
        Windows_h.C_LONG.withName("dwPrinters"),
        Windows_h.C_LONG.withName("dwDrives"),

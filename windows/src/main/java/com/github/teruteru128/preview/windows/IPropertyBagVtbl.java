 ...
 *     HRESULT (*QueryInterface)(IPropertyBag *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IPropertyBag *) __attribute__((stdcall));
 *     ULONG (*Release)(IPropertyBag *) __attribute__((stdcall));
 *     HRESULT (*Read)(IPropertyBag *, LPCOLESTR, VARIANT *, IErrorLog *) __attribute__((stdcall));
 *     HRESULT (*Write)(IPropertyBag *, LPCOLESTR, VARIANT *) __attribute__((stdcall));
 * }
 * }
 */

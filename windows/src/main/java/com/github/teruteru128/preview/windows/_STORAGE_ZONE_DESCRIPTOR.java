...
public class _STORAGE_ZONE_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("ZoneType"),
        Windows_h.C_INT.withName("ZoneCondition"),
        Windows_h.C_CHAR.withName("ResetWritePointerRecommend"),
        MemoryLayout.sequenceLayout(3, Windows_h.C_CHAR).withName("Reserved0"),
        Windows_h.C_LONG_LONG.withName("ZoneSize"),
        Windows_h.C_LONG_LONG.withName("WritePointerOffset")

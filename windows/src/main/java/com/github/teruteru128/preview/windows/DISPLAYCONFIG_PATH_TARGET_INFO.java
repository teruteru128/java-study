...
public class DISPLAYCONFIG_PATH_TARGET_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.unionLayout(
            Windows_h.C_INT.withName("modeInfoIdx"),
            MemoryLayout.structLayout(
                MemoryLayout.paddingLayout(4)
            ).withName("$anon$2980:9")
        ).withName("$anon$2977:5"),
        Windows_h.C_INT.withName("outputTechnology"),
        Windows_h.C_INT.withName("rotation"),
        Windows_h.C_INT.withName("scaling"),
        DISPLAYCONFIG_RATIONAL.layout().withName("refreshRate"),
        Windows_h.C_INT.withName("scanLineOrdering"),
        Windows_h.C_INT.withName("targetAvailable"),
        Windows_h.C_INT.withName("statusFlags")
    ...
    private static final OfInt modeInfoIdx$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2977:5"), groupElement("modeInfoIdx"));

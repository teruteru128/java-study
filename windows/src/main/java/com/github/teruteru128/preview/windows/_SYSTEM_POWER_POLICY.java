...
public class _SYSTEM_POWER_POLICY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("Revision"),
        ...
        Windows_h.C_INT.withName("LidOpenWake"),
        Windows_h.C_LONG.withName("Reserved"),
        POWER_ACTION_POLICY.layout().withName("Idle"),
        Windows_h.C_LONG.withName("IdleTimeout"),
        Windows_h.C_CHAR.withName("IdleSensitivity"),
        Windows_h.C_CHAR.withName("DynamicThrottle"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("Spare2"),
        Windows_h.C_INT.withName("MinSleep"),
        Windows_h.C_INT.withName("MaxSleep"),
        Windows_h.C_INT.withName("ReducedLatencySleep"),
        Windows_h.C_LONG.withName("WinLogonFlags"),
        Windows_h.C_LONG.withName("Spare3"),
        Windows_h.C_LONG.withName("DozeS4Timeout"),
        Windows_h.C_LONG.withName("BroadcastCapacityResolution"),
        MemoryLayout.sequenceLayout(4, SYSTEM_POWER_LEVEL.layout()).withName("DischargePolicy"),
        Windows_h.C_LONG.withName("VideoTimeout"),
        Windows_h.C_CHAR.withName("VideoDimDisplay"),
        MemoryLayout.paddingLayout(3),
        MemoryLayout.sequenceLayout(3, Windows_h.C_LONG).withName("VideoReserved"),
        Windows_h.C_LONG.withName("SpindownTimeout"),
        Windows_h.C_CHAR.withName("OptimizeForPower"),
        Windows_h.C_CHAR.withName("FanThrottleTolerance"),
        Windows_h.C_CHAR.withName("ForcedThrottle"),
        Windows_h.C_CHAR.withName("MinThrottle"),

...
public class _CMSG_CTRL_MAIL_LIST_DECRYPT_PARA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("dwRecipientIndex"),
    ...
    private static final OfLong hKeyEncryptionKey$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$8137:5"), groupElement("hKeyEncryptionKey"));
    ...
    private static final AddressLayout pvKeyEncryptionKey$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$8137:5"), groupElement("pvKeyEncryptionKey"));

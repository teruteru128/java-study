...
public class _TAPE_GET_DRIVE_PARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("ECC"),
        Windows_h.C_CHAR.withName("Compression"),
        Windows_h.C_CHAR.withName("DataPadding"),
        Windows_h.C_CHAR.withName("ReportSetmarks"),
        Windows_h.C_LONG.withName("DefaultBlockSize"),
        Windows_h.C_LONG.withName("MaximumBlockSize"),
        Windows_h.C_LONG.withName("MinimumBlockSize"),
        Windows_h.C_LONG.withName("MaximumPartitionCount"),
        Windows_h.C_LONG.withName("FeaturesLow"),
        Windows_h.C_LONG.withName("FeaturesHigh"),
        Windows_h.C_LONG.withName("EOTWarningZoneSize")

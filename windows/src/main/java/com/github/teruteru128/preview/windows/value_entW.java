...
public class value_entW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_POINTER.withName("ve_valuename"),
        Windows_h.C_LONG.withName("ve_valuelen"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_LONG_LONG.withName("ve_valueptr"),
        Windows_h.C_LONG.withName("ve_type"),
        MemoryLayout.paddingLayout(4)
    ).withName("value_entW");

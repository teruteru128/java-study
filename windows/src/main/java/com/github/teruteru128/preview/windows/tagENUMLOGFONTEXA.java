...
public class tagENUMLOGFONTEXA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(64, Windows_h.C_CHAR).withName("elfFullName"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("elfStyle"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("elfScript")
    ...
    private static final long elfScript$OFFSET = 156;
     ...
     * }
     */
    public static byte elfScript(MemorySegment struct, long index0) {
        return (byte)elfScript$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void elfScript(MemorySegment struct, long index0, byte fieldValue) {

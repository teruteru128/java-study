...
public class _DRIVE_LAYOUT_INFORMATION_EX {
    ...
    private static final GroupLayout Mbr$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9244:5"), groupElement("Mbr"));
    ...
    private static final GroupLayout Gpt$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9244:5"), groupElement("Gpt"));

...
public class _ENCRYPTED_FILE_METADATA_SIGNATURE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("dwEfsAccessType"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("pCertificatesAdded"),
        Windows_h.C_POINTER.withName("pEncryptionCertificate"),
        Windows_h.C_POINTER.withName("pEfsStreamSignature")

...
public class tagHELPINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("iContextType"),
        Windows_h.C_INT.withName("iCtrlId"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("hItemHandle"),
        Windows_h.C_LONG_LONG.withName("dwContextId"),

 ...
 *     HRESULT (*QueryInterface)(IXMLDOMComment *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IXMLDOMComment *) __attribute__((stdcall));
 *     ULONG (*Release)(IXMLDOMComment *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfoCount)(IXMLDOMComment *, UINT *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfo)(IXMLDOMComment *, UINT, LCID, ITypeInfo **) __attribute__((stdcall));
 *     HRESULT (*GetIDsOfNames)(IXMLDOMComment *, const IID *const, LPOLESTR *, UINT, LCID, DISPID *) __attribute__((stdcall));
 *     HRESULT (*Invoke)(IXMLDOMComment *, DISPID, const IID *const, LCID, WORD, DISPPARAMS *, VARIANT *, EXCEPINFO *, UINT *) __attribute__((stdcall));
 *     HRESULT (*get_nodeName)(IXMLDOMComment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_nodeValue)(IXMLDOMComment *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_nodeValue)(IXMLDOMComment *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_nodeType)(IXMLDOMComment *, DOMNodeType *) __attribute__((stdcall));
 *     HRESULT (*get_parentNode)(IXMLDOMComment *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_childNodes)(IXMLDOMComment *, IXMLDOMNodeList **) __attribute__((stdcall));
 *     HRESULT (*get_firstChild)(IXMLDOMComment *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_lastChild)(IXMLDOMComment *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_previousSibling)(IXMLDOMComment *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nextSibling)(IXMLDOMComment *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_attributes)(IXMLDOMComment *, IXMLDOMNamedNodeMap **) __attribute__((stdcall));
 *     HRESULT (*insertBefore)(IXMLDOMComment *, IXMLDOMNode *, VARIANT, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*replaceChild)(IXMLDOMComment *, IXMLDOMNode *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*removeChild)(IXMLDOMComment *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*appendChild)(IXMLDOMComment *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*hasChildNodes)(IXMLDOMComment *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_ownerDocument)(IXMLDOMComment *, IXMLDOMDocument **) __attribute__((stdcall));
 *     HRESULT (*cloneNode)(IXMLDOMComment *, VARIANT_BOOL, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nodeTypeString)(IXMLDOMComment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_text)(IXMLDOMComment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*put_text)(IXMLDOMComment *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_specified)(IXMLDOMComment *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_definition)(IXMLDOMComment *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nodeTypedValue)(IXMLDOMComment *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_nodeTypedValue)(IXMLDOMComment *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_dataType)(IXMLDOMComment *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_dataType)(IXMLDOMComment *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_xml)(IXMLDOMComment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*transformNode)(IXMLDOMComment *, IXMLDOMNode *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*selectNodes)(IXMLDOMComment *, BSTR, IXMLDOMNodeList **) __attribute__((stdcall));
 *     HRESULT (*selectSingleNode)(IXMLDOMComment *, BSTR, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_parsed)(IXMLDOMComment *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_namespaceURI)(IXMLDOMComment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_prefix)(IXMLDOMComment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_baseName)(IXMLDOMComment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*transformNodeToObject)(IXMLDOMComment *, IXMLDOMNode *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_data)(IXMLDOMComment *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*put_data)(IXMLDOMComment *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_length)(IXMLDOMComment *, long *) __attribute__((stdcall));
 *     HRESULT (*substringData)(IXMLDOMComment *, long, long, BSTR *) __attribute__((stdcall));
 *     HRESULT (*appendData)(IXMLDOMComment *, BSTR) __attribute__((stdcall));
 *     HRESULT (*insertData)(IXMLDOMComment *, long, BSTR) __attribute__((stdcall));
 *     HRESULT (*deleteData)(IXMLDOMComment *, long, long) __attribute__((stdcall));
 *     HRESULT (*replaceData)(IXMLDOMComment *, long, long, BSTR) __attribute__((stdcall));
 * }
 * }
 */

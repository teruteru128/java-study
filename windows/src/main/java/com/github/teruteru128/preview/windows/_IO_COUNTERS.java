...
public class _IO_COUNTERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("ReadOperationCount"),
        Windows_h.C_LONG_LONG.withName("WriteOperationCount"),
        Windows_h.C_LONG_LONG.withName("OtherOperationCount"),
        Windows_h.C_LONG_LONG.withName("ReadTransferCount"),
        Windows_h.C_LONG_LONG.withName("WriteTransferCount"),
        Windows_h.C_LONG_LONG.withName("OtherTransferCount")

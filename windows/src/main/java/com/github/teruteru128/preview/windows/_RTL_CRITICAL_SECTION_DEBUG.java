...
public class _RTL_CRITICAL_SECTION_DEBUG {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_SHORT.withName("CreatorBackTraceIndex"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("CriticalSection"),
        _LIST_ENTRY.layout().withName("ProcessLocksList"),
        Windows_h.C_LONG.withName("EntryCount"),
        Windows_h.C_LONG.withName("ContentionCount"),
        Windows_h.C_LONG.withName("Flags"),
        Windows_h.C_SHORT.withName("CreatorBackTraceIndexHigh"),
        Windows_h.C_SHORT.withName("SpareWORD")

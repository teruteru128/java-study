...
public class _DISPLAY_DEVICEA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("DeviceName"),
        MemoryLayout.sequenceLayout(128, Windows_h.C_CHAR).withName("DeviceString"),
        Windows_h.C_LONG.withName("StateFlags"),
        MemoryLayout.sequenceLayout(128, Windows_h.C_CHAR).withName("DeviceID"),
        MemoryLayout.sequenceLayout(128, Windows_h.C_CHAR).withName("DeviceKey")

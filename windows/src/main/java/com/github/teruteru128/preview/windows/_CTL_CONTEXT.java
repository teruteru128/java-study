...
public class _CTL_CONTEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("pbCtlEncoded"),
        Windows_h.C_LONG.withName("cbCtlEncoded"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("pCtlInfo"),
        Windows_h.C_POINTER.withName("hCertStore"),
        Windows_h.C_POINTER.withName("hCryptMsg"),
        Windows_h.C_POINTER.withName("pbCtlContent"),
        Windows_h.C_LONG.withName("cbCtlContent"),
        MemoryLayout.paddingLayout(4)

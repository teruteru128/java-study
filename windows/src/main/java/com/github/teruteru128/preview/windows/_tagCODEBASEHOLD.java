...
public class _tagCODEBASEHOLD {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("szDistUnit"),
        Windows_h.C_POINTER.withName("szCodeBase"),
        Windows_h.C_LONG.withName("dwVersionMS"),
        Windows_h.C_LONG.withName("dwVersionLS"),

...
public class pvalueW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_POINTER.withName("pv_valuename"),
        Windows_h.C_INT.withName("pv_valuelen"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("pv_value_context"),
        Windows_h.C_LONG.withName("pv_type"),
        MemoryLayout.paddingLayout(4)
    ).withName("pvalueW");

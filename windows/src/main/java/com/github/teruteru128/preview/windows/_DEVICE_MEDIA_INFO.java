    ...
    public static class DeviceSpecific {
        ...
        public static class DiskInfo {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                ...
                Windows_h.C_INT.withName("MediaType"),
                Windows_h.C_LONG.withName("TracksPerCylinder"),
                Windows_h.C_LONG.withName("SectorsPerTrack"),
                Windows_h.C_LONG.withName("BytesPerSector"),
                Windows_h.C_LONG.withName("NumberMediaSides"),
                Windows_h.C_LONG.withName("MediaCharacteristics")
            ).withName("$anon$955:9");
        ...
        public static class TapeInfo {
            ...
            private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                Windows_h.C_INT.withName("MediaType"),
                Windows_h.C_LONG.withName("MediaCharacteristics"),
                Windows_h.C_LONG.withName("CurrentBlockSize"),
            ...
            public static class BusSpecificData {
                ...
                public static class ScsiInformation {
                    ...
                    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
                        Windows_h.C_CHAR.withName("MediumType"),
                        Windows_h.C_CHAR.withName("DensityCode")
                    ).withName("$anon$986:17");

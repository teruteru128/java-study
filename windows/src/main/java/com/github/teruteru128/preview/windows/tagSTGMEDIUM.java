...
public class tagSTGMEDIUM {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("tymed"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("hBitmap"),
            Windows_h.C_POINTER.withName("hMetaFilePict"),
            Windows_h.C_POINTER.withName("hEnhMetaFile"),
            Windows_h.C_POINTER.withName("hGlobal"),
            Windows_h.C_POINTER.withName("lpszFileName"),
            Windows_h.C_POINTER.withName("pstm"),
            Windows_h.C_POINTER.withName("pstg")
        ).withName("$anon$12046:36"),
        Windows_h.C_POINTER.withName("pUnkForRelease")
    ...
    private static final AddressLayout hBitmap$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12046:36"), groupElement("hBitmap"));
    ...
    private static final AddressLayout hMetaFilePict$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12046:36"), groupElement("hMetaFilePict"));
    ...
    private static final AddressLayout hEnhMetaFile$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12046:36"), groupElement("hEnhMetaFile"));
    ...
    private static final AddressLayout hGlobal$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12046:36"), groupElement("hGlobal"));
    ...
    private static final AddressLayout lpszFileName$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12046:36"), groupElement("lpszFileName"));
    ...
    private static final AddressLayout pstm$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12046:36"), groupElement("pstm"));
    ...
    private static final AddressLayout pstg$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$12046:36"), groupElement("pstg"));

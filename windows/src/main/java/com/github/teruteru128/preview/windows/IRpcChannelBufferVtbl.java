 ...
 *     HRESULT (*QueryInterface)(IRpcChannelBuffer *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IRpcChannelBuffer *) __attribute__((stdcall));
 *     ULONG (*Release)(IRpcChannelBuffer *) __attribute__((stdcall));
 *     HRESULT (*GetBuffer)(IRpcChannelBuffer *, RPCOLEMESSAGE *, const IID *const) __attribute__((stdcall));
 *     HRESULT (*SendReceive)(IRpcChannelBuffer *, RPCOLEMESSAGE *, ULONG *) __attribute__((stdcall));
 *     HRESULT (*FreeBuffer)(IRpcChannelBuffer *, RPCOLEMESSAGE *) __attribute__((stdcall));
 *     HRESULT (*GetDestCtx)(IRpcChannelBuffer *, DWORD *, void **) __attribute__((stdcall));
 *     HRESULT (*IsConnected)(IRpcChannelBuffer *) __attribute__((stdcall));
 * }
 * }
 */

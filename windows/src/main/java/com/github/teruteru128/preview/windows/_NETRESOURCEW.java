...
public class _NETRESOURCEW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("dwScope"),
        Windows_h.C_LONG.withName("dwType"),
        Windows_h.C_LONG.withName("dwDisplayType"),
        Windows_h.C_LONG.withName("dwUsage"),
        Windows_h.C_POINTER.withName("lpLocalName"),
        Windows_h.C_POINTER.withName("lpRemoteName"),
        Windows_h.C_POINTER.withName("lpComment"),
        Windows_h.C_POINTER.withName("lpProvider")

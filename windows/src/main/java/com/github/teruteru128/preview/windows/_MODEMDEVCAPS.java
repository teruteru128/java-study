...
public class _MODEMDEVCAPS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("dwActualSize"),
        Windows_h.C_LONG.withName("dwRequiredSize"),
        Windows_h.C_LONG.withName("dwDevSpecificOffset"),
        Windows_h.C_LONG.withName("dwDevSpecificSize"),
        Windows_h.C_LONG.withName("dwModemProviderVersion"),
        Windows_h.C_LONG.withName("dwModemManufacturerOffset"),
        Windows_h.C_LONG.withName("dwModemManufacturerSize"),
        Windows_h.C_LONG.withName("dwModemModelOffset"),
        Windows_h.C_LONG.withName("dwModemModelSize"),
        Windows_h.C_LONG.withName("dwModemVersionOffset"),
        Windows_h.C_LONG.withName("dwModemVersionSize"),
        Windows_h.C_LONG.withName("dwDialOptions"),
        Windows_h.C_LONG.withName("dwCallSetupFailTimer"),
        Windows_h.C_LONG.withName("dwInactivityTimeout"),
        Windows_h.C_LONG.withName("dwSpeakerVolume"),
        Windows_h.C_LONG.withName("dwSpeakerMode"),
        Windows_h.C_LONG.withName("dwModemOptions"),
        Windows_h.C_LONG.withName("dwMaxDTERate"),
        Windows_h.C_LONG.withName("dwMaxDCERate"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_CHAR).withName("abVariablePortion"),

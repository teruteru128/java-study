...
public class _MMCKINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.align(Windows_h.C_LONG, 1).withName("ckid"),
        Windows_h.align(Windows_h.C_LONG, 1).withName("cksize"),
        Windows_h.align(Windows_h.C_LONG, 1).withName("fccType"),
        Windows_h.align(Windows_h.C_LONG, 1).withName("dwDataOffset"),

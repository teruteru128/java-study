...
public class _CRL_DIST_POINT_NAME {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("dwDistPointNameChoice"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            _CERT_ALT_NAME_INFO.layout().withName("FullName")
        ).withName("$anon$4431:5")
    ...
    private static final GroupLayout FullName$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$4431:5"), groupElement("FullName"));

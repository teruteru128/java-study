...
public class _nlsversioninfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("dwNLSVersionInfoSize"),
        Windows_h.C_LONG.withName("dwNLSVersion"),
        Windows_h.C_LONG.withName("dwDefinedVersion"),
        Windows_h.C_LONG.withName("dwEffectiveId"),

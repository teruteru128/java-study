...
public class hostent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_POINTER.withName("h_name"),
        Windows_h.C_POINTER.withName("h_aliases"),
        Windows_h.C_SHORT.withName("h_addrtype"),
        Windows_h.C_SHORT.withName("h_length"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("h_addr_list")
    ).withName("hostent");

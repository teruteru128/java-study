...
public class SCARD_READERSTATEW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_POINTER.withName("szReader"),
        Windows_h.C_POINTER.withName("pvUserData"),
        Windows_h.C_LONG.withName("dwCurrentState"),
        Windows_h.C_LONG.withName("dwEventState"),
        Windows_h.C_LONG.withName("cbAtr"),
        MemoryLayout.sequenceLayout(36, Windows_h.C_CHAR).withName("rgbAtr")
    ).withName("$anon$512:9");

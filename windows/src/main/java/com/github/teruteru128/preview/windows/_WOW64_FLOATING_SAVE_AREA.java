...
public class _WOW64_FLOATING_SAVE_AREA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("ControlWord"),
        Windows_h.C_LONG.withName("StatusWord"),
        Windows_h.C_LONG.withName("TagWord"),
        Windows_h.C_LONG.withName("ErrorOffset"),
        Windows_h.C_LONG.withName("ErrorSelector"),
        Windows_h.C_LONG.withName("DataOffset"),
        Windows_h.C_LONG.withName("DataSelector"),
        MemoryLayout.sequenceLayout(80, Windows_h.C_CHAR).withName("RegisterArea"),
        Windows_h.C_LONG.withName("Cr0NpxState")

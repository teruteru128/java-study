...
public class _SESSION_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("sess_name"),
        Windows_h.C_CHAR.withName("num_sess"),
        Windows_h.C_CHAR.withName("rcv_dg_outstanding"),
        Windows_h.C_CHAR.withName("rcv_any_outstanding")

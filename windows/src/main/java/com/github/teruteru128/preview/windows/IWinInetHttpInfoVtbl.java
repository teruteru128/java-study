 ...
 *     HRESULT (*QueryInterface)(IWinInetHttpInfo *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IWinInetHttpInfo *) __attribute__((stdcall));
 *     ULONG (*Release)(IWinInetHttpInfo *) __attribute__((stdcall));
 *     HRESULT (*QueryOption)(IWinInetHttpInfo *, DWORD, LPVOID, DWORD *) __attribute__((stdcall));
 *     HRESULT (*QueryInfo)(IWinInetHttpInfo *, DWORD, LPVOID, DWORD *, DWORD *, DWORD *) __attribute__((stdcall));
 * }
 * }
 */
public class IWinInetHttpInfoVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("QueryOption"),
    ...
    public static class QueryOption {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(QueryOption.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(QueryOption.Function fi, Arena arena) {
            return Linker.nativeLinker().upcallStub(UP$MH.bindTo(fi), $DESC, arena);
        }
    ...
    private static final AddressLayout QueryOption$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("QueryOption"));
     ...
     * }
     */
    public static final AddressLayout QueryOption$layout() {
        return QueryOption$LAYOUT;
    }

    private static final long QueryOption$OFFSET = 24;
     ...
     * }
     */
    public static final long QueryOption$offset() {
        return QueryOption$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment QueryOption(MemorySegment struct) {
        return struct.get(QueryOption$LAYOUT, QueryOption$OFFSET);
    }
     ...
     * }
     */
    public static void QueryOption(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(QueryOption$LAYOUT, QueryOption$OFFSET, fieldValue);
    }
    ...
    private static final long QueryInfo$OFFSET = 32;

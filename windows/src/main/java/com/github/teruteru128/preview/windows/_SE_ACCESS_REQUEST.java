...
public class _SE_ACCESS_REQUEST {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("SeSecurityDescriptor"),
        Windows_h.C_LONG.withName("DesiredAccess"),
        Windows_h.C_LONG.withName("PreviouslyGrantedAccess"),
        Windows_h.C_POINTER.withName("PrincipalSelfSid"),
        Windows_h.C_POINTER.withName("GenericMapping"),
        Windows_h.C_LONG.withName("ObjectTypeListCount"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("ObjectTypeList")

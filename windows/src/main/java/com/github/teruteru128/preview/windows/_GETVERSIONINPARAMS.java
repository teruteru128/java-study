...
public class _GETVERSIONINPARAMS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("bVersion"),
        Windows_h.C_CHAR.withName("bRevision"),
        Windows_h.C_CHAR.withName("bReserved"),
        Windows_h.C_CHAR.withName("bIDEDeviceMap"),
        Windows_h.align(Windows_h.C_LONG, 1).withName("fCapabilities"),

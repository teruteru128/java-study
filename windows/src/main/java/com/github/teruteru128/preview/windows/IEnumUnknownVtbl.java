 ...
 *     HRESULT (*QueryInterface)(IEnumUnknown *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IEnumUnknown *) __attribute__((stdcall));
 *     ULONG (*Release)(IEnumUnknown *) __attribute__((stdcall));
 *     HRESULT (*Next)(IEnumUnknown *, ULONG, IUnknown **, ULONG *) __attribute__((stdcall));
 *     HRESULT (*Skip)(IEnumUnknown *, ULONG) __attribute__((stdcall));
 *     HRESULT (*Reset)(IEnumUnknown *) __attribute__((stdcall));
 *     HRESULT (*Clone)(IEnumUnknown *, IEnumUnknown **) __attribute__((stdcall));
 * }
 * }
 */

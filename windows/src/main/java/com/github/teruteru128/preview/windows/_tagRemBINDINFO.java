...
public class _tagRemBINDINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("szExtraInfo"),
        Windows_h.C_LONG.withName("grfBindInfoF"),
        Windows_h.C_LONG.withName("dwBindVerb"),
        Windows_h.C_POINTER.withName("szCustomVerb"),
        Windows_h.C_LONG.withName("cbstgmedData"),
        Windows_h.C_LONG.withName("dwOptions"),
        Windows_h.C_LONG.withName("dwOptionsFlags"),
        Windows_h.C_LONG.withName("dwCodePage"),
        _REMSECURITY_ATTRIBUTES.layout().withName("securityAttributes"),
        _GUID.layout().withName("iid"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("pUnk"),

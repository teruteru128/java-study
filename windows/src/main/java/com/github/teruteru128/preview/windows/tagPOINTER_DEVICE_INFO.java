...
public class tagPOINTER_DEVICE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("displayOrientation"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("device"),
        Windows_h.C_INT.withName("pointerDeviceType"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("monitor"),
        Windows_h.C_LONG.withName("startingCursorId"),
        Windows_h.C_SHORT.withName("maxActiveContacts"),
        MemoryLayout.sequenceLayout(520, Windows_h.C_SHORT).withName("productString"),

 ...
 *     HRESULT (*QueryInterface)(IEnumSTATSTG *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IEnumSTATSTG *) __attribute__((stdcall));
 *     ULONG (*Release)(IEnumSTATSTG *) __attribute__((stdcall));
 *     HRESULT (*Next)(IEnumSTATSTG *, ULONG, STATSTG *, ULONG *) __attribute__((stdcall));
 *     HRESULT (*Skip)(IEnumSTATSTG *, ULONG) __attribute__((stdcall));
 *     HRESULT (*Reset)(IEnumSTATSTG *) __attribute__((stdcall));
 *     HRESULT (*Clone)(IEnumSTATSTG *, IEnumSTATSTG **) __attribute__((stdcall));
 * }
 * }
 */

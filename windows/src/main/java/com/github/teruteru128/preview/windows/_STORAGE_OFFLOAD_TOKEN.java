...
public class _STORAGE_OFFLOAD_TOKEN {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(4, Windows_h.C_CHAR).withName("TokenType"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("Reserved"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("TokenIdLength"),
        MemoryLayout.unionLayout(
            _STORAGE_OFFLOAD_TOKEN.StorageOffloadZeroDataToken.layout().withName("StorageOffloadZeroDataToken"),
            MemoryLayout.sequenceLayout(504, Windows_h.C_CHAR).withName("Token")
        ).withName("$anon$3453:5")
    ...
    public static class StorageOffloadZeroDataToken {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            MemoryLayout.sequenceLayout(504, Windows_h.C_CHAR).withName("Reserved2")
        ).withName("$anon$3454:9");
    ...
    private static final GroupLayout StorageOffloadZeroDataToken$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$3453:5"), groupElement("StorageOffloadZeroDataToken"));
    ...
    private static final SequenceLayout Token$LAYOUT = (SequenceLayout)$LAYOUT.select(groupElement("$anon$3453:5"), groupElement("Token"));

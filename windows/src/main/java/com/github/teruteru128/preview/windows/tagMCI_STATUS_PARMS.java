...
public class tagMCI_STATUS_PARMS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.align(Windows_h.C_LONG_LONG, 1).withName("dwReturn"),
        Windows_h.align(Windows_h.C_LONG, 1).withName("dwItem"),
        Windows_h.align(Windows_h.C_LONG, 1).withName("dwTrack")

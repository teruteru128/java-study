...
public class tagBITMAPCOREHEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("bcSize"),
        Windows_h.C_SHORT.withName("bcWidth"),
        Windows_h.C_SHORT.withName("bcHeight"),
        Windows_h.C_SHORT.withName("bcPlanes"),
        Windows_h.C_SHORT.withName("bcBitCount")

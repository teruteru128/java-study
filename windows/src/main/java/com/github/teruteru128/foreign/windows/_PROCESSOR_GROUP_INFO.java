...
public class _PROCESSOR_GROUP_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("MaximumProcessorCount"),
        Windows_h.C_CHAR.withName("ActiveProcessorCount"),
        MemoryLayout.sequenceLayout(38, Windows_h.C_CHAR).withName("Reserved"),
        Windows_h.C_LONG_LONG.withName("ActiveProcessorMask")

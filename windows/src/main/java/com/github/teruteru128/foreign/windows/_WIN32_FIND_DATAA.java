...
public class _WIN32_FIND_DATAA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("dwFileAttributes"),
        ...
        Windows_h.C_LONG.withName("nFileSizeHigh"),
        Windows_h.C_LONG.withName("nFileSizeLow"),
        Windows_h.C_LONG.withName("dwReserved0"),
        Windows_h.C_LONG.withName("dwReserved1"),
        MemoryLayout.sequenceLayout(260, Windows_h.C_CHAR).withName("cFileName"),
        MemoryLayout.sequenceLayout(14, Windows_h.C_CHAR).withName("cAlternateFileName"),
     ...
     * }
     */
    public static byte cFileName(MemorySegment struct, long index0) {
        return (byte)cFileName$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void cFileName(MemorySegment struct, long index0, byte fieldValue) {
     ...
     * }
     */
    public static byte cAlternateFileName(MemorySegment struct, long index0) {
        return (byte)cAlternateFileName$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void cAlternateFileName(MemorySegment struct, long index0, byte fieldValue) {

...
public class tagMONITORINFOEXA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("szDevice")
     ...
     * }
     */
    public static byte szDevice(MemorySegment struct, long index0) {
        return (byte)szDevice$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void szDevice(MemorySegment struct, long index0, byte fieldValue) {

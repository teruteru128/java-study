...
public class _TOKEN_GROUPS_AND_PRIVILEGES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("SidCount"),
        Windows_h.C_LONG.withName("SidLength"),
        Windows_h.C_POINTER.withName("Sids"),
        Windows_h.C_LONG.withName("RestrictedSidCount"),
        Windows_h.C_LONG.withName("RestrictedSidLength"),
        Windows_h.C_POINTER.withName("RestrictedSids"),
        Windows_h.C_LONG.withName("PrivilegeCount"),
        Windows_h.C_LONG.withName("PrivilegeLength"),

...
public class _CRYPT_3DES_KEY_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(24, Windows_h.C_CHAR).withName("Key"),
        MemoryLayout.sequenceLayout(8, Windows_h.C_CHAR).withName("IV"),
        MemoryLayout.sequenceLayout(8, Windows_h.C_CHAR).withName("Feedback")

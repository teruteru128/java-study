...
public class tagMSGBOXPARAMSW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("lpszText"),
        Windows_h.C_POINTER.withName("lpszCaption"),
        Windows_h.C_LONG.withName("dwStyle"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("lpszIcon"),
        Windows_h.C_LONG_LONG.withName("dwContextHelpId"),
        Windows_h.C_POINTER.withName("lpfnMsgBoxCallback"),
        Windows_h.C_LONG.withName("dwLanguageId"),
        MemoryLayout.paddingLayout(4)

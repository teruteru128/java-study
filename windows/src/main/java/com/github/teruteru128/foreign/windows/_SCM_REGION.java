...
public class _SCM_REGION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("NfitHandle"),
        _GUID.layout().withName("LogicalDeviceGuid"),
        _GUID.layout().withName("AddressRangeType"),
        Windows_h.C_LONG.withName("AssociatedId"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_LONG_LONG.withName("Length"),
        Windows_h.C_LONG_LONG.withName("StartingDPA"),
        Windows_h.C_LONG_LONG.withName("BaseSPA"),
        Windows_h.C_LONG_LONG.withName("SPAOffset"),
        Windows_h.C_LONG_LONG.withName("RegionOffset")

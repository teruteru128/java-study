 ...
 *     HRESULT (*QueryInterface)(IXMLDOMText *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IXMLDOMText *) __attribute__((stdcall));
 *     ULONG (*Release)(IXMLDOMText *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfoCount)(IXMLDOMText *, UINT *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfo)(IXMLDOMText *, UINT, LCID, ITypeInfo **) __attribute__((stdcall));
 *     HRESULT (*GetIDsOfNames)(IXMLDOMText *, const IID *const, LPOLESTR *, UINT, LCID, DISPID *) __attribute__((stdcall));
 *     HRESULT (*Invoke)(IXMLDOMText *, DISPID, const IID *const, LCID, WORD, DISPPARAMS *, VARIANT *, EXCEPINFO *, UINT *) __attribute__((stdcall));
 *     HRESULT (*get_nodeName)(IXMLDOMText *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_nodeValue)(IXMLDOMText *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_nodeValue)(IXMLDOMText *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_nodeType)(IXMLDOMText *, DOMNodeType *) __attribute__((stdcall));
 *     HRESULT (*get_parentNode)(IXMLDOMText *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_childNodes)(IXMLDOMText *, IXMLDOMNodeList **) __attribute__((stdcall));
 *     HRESULT (*get_firstChild)(IXMLDOMText *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_lastChild)(IXMLDOMText *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_previousSibling)(IXMLDOMText *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nextSibling)(IXMLDOMText *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_attributes)(IXMLDOMText *, IXMLDOMNamedNodeMap **) __attribute__((stdcall));
 *     HRESULT (*insertBefore)(IXMLDOMText *, IXMLDOMNode *, VARIANT, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*replaceChild)(IXMLDOMText *, IXMLDOMNode *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*removeChild)(IXMLDOMText *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*appendChild)(IXMLDOMText *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*hasChildNodes)(IXMLDOMText *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_ownerDocument)(IXMLDOMText *, IXMLDOMDocument **) __attribute__((stdcall));
 *     HRESULT (*cloneNode)(IXMLDOMText *, VARIANT_BOOL, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nodeTypeString)(IXMLDOMText *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_text)(IXMLDOMText *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*put_text)(IXMLDOMText *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_specified)(IXMLDOMText *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_definition)(IXMLDOMText *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nodeTypedValue)(IXMLDOMText *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_nodeTypedValue)(IXMLDOMText *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_dataType)(IXMLDOMText *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_dataType)(IXMLDOMText *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_xml)(IXMLDOMText *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*transformNode)(IXMLDOMText *, IXMLDOMNode *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*selectNodes)(IXMLDOMText *, BSTR, IXMLDOMNodeList **) __attribute__((stdcall));
 *     HRESULT (*selectSingleNode)(IXMLDOMText *, BSTR, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_parsed)(IXMLDOMText *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_namespaceURI)(IXMLDOMText *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_prefix)(IXMLDOMText *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_baseName)(IXMLDOMText *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*transformNodeToObject)(IXMLDOMText *, IXMLDOMNode *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_data)(IXMLDOMText *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*put_data)(IXMLDOMText *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_length)(IXMLDOMText *, long *) __attribute__((stdcall));
 *     HRESULT (*substringData)(IXMLDOMText *, long, long, BSTR *) __attribute__((stdcall));
 *     HRESULT (*appendData)(IXMLDOMText *, BSTR) __attribute__((stdcall));
 *     HRESULT (*insertData)(IXMLDOMText *, long, BSTR) __attribute__((stdcall));
 *     HRESULT (*deleteData)(IXMLDOMText *, long, long) __attribute__((stdcall));
 *     HRESULT (*replaceData)(IXMLDOMText *, long, long, BSTR) __attribute__((stdcall));
 *     HRESULT (*splitText)(IXMLDOMText *, long, IXMLDOMText **) __attribute__((stdcall));
 * }
 * }
 */

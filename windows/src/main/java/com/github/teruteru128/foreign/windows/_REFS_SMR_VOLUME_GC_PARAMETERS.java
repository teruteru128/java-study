...
public class _REFS_SMR_VOLUME_GC_PARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("Method"),
        Windows_h.C_LONG.withName("IoGranularity"),
        Windows_h.C_LONG.withName("CompressionFormat"),
        MemoryLayout.sequenceLayout(8, Windows_h.C_LONG_LONG).withName("Unused")

...
public class _GUID {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("Data1"),
        Windows_h.C_SHORT.withName("Data2"),
        Windows_h.C_SHORT.withName("Data3"),
        MemoryLayout.sequenceLayout(8, Windows_h.C_CHAR).withName("Data4")
    ).withName("_GUID");

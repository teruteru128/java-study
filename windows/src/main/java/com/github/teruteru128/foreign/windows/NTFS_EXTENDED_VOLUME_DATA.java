...
public class NTFS_EXTENDED_VOLUME_DATA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_SHORT.withName("LfsMajorVersion"),
        Windows_h.C_SHORT.withName("LfsMinorVersion"),
        Windows_h.C_LONG.withName("MaxDeviceTrimExtentCount"),
        Windows_h.C_LONG.withName("MaxDeviceTrimByteCount"),
        Windows_h.C_LONG.withName("MaxVolumeTrimExtentCount"),
        Windows_h.C_LONG.withName("MaxVolumeTrimByteCount")
    ).withName("$anon$11174:9");

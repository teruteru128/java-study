...
public class _PHYSICAL_ELEMENT_STATUS_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("ElementIdentifier"),
        Windows_h.C_CHAR.withName("PhysicalElementType"),
        Windows_h.C_CHAR.withName("PhysicalElementHealth"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("Reserved1"),
        Windows_h.C_LONG_LONG.withName("AssociatedCapacity"),
        MemoryLayout.sequenceLayout(4, Windows_h.C_LONG).withName("Reserved2")

...
public class tagRemHGLOBAL {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("fNullHGlobal"),
        Windows_h.C_LONG.withName("cbData"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_CHAR).withName("data"),
    ...
    private static final OfInt fNullHGlobal$LAYOUT = (OfInt)$LAYOUT.select(groupElement("fNullHGlobal"));
     ...
     * }
     */
    public static final OfInt fNullHGlobal$layout() {
        return fNullHGlobal$LAYOUT;
    }

    private static final long fNullHGlobal$OFFSET = 0;
     ...
     * }
     */
    public static final long fNullHGlobal$offset() {
        return fNullHGlobal$OFFSET;
    }
     ...
     * }
     */
    public static int fNullHGlobal(MemorySegment struct) {
        return struct.get(fNullHGlobal$LAYOUT, fNullHGlobal$OFFSET);
    }
     ...
     * }
     */
    public static void fNullHGlobal(MemorySegment struct, int fieldValue) {
        struct.set(fNullHGlobal$LAYOUT, fNullHGlobal$OFFSET, fieldValue);
    }

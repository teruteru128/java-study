 ...
 *     HRESULT (*QueryInterface)(IPipeLong *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IPipeLong *) __attribute__((stdcall));
 *     ULONG (*Release)(IPipeLong *) __attribute__((stdcall));
 *     HRESULT (*Pull)(IPipeLong *, LONG *, ULONG, ULONG *) __attribute__((stdcall));
 *     HRESULT (*Push)(IPipeLong *, LONG *, ULONG) __attribute__((stdcall));
 * }
 * }
 */

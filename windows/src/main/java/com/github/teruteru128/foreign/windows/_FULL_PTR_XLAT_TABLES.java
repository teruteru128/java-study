...
public class _FULL_PTR_XLAT_TABLES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_POINTER.withName("RefIdToPointer"),
        Windows_h.C_POINTER.withName("PointerToRefId"),
        Windows_h.C_LONG.withName("NextRefId"),
        Windows_h.C_INT.withName("XlatSide")

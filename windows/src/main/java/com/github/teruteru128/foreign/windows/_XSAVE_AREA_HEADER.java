...
public class _XSAVE_AREA_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("Mask"),
        Windows_h.C_LONG_LONG.withName("CompactionMask"),
        MemoryLayout.sequenceLayout(6, Windows_h.C_LONG_LONG).withName("Reserved2")

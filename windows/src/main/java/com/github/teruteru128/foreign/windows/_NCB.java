...
public class _NCB {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("ncb_command"),
        Windows_h.C_CHAR.withName("ncb_retcode"),
        Windows_h.C_CHAR.withName("ncb_lsn"),
        Windows_h.C_CHAR.withName("ncb_num"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("ncb_buffer"),
        Windows_h.C_SHORT.withName("ncb_length"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("ncb_callname"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("ncb_name"),
        Windows_h.C_CHAR.withName("ncb_rto"),
        Windows_h.C_CHAR.withName("ncb_sto"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("ncb_post"),
        Windows_h.C_CHAR.withName("ncb_lana_num"),
        Windows_h.C_CHAR.withName("ncb_cmd_cplt"),
        MemoryLayout.sequenceLayout(18, Windows_h.C_CHAR).withName("ncb_reserve"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("ncb_event")
    ).withName("_NCB");
    ...
    public static class ncb_post {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(ncb_post.Function.class, "apply", $DESC);

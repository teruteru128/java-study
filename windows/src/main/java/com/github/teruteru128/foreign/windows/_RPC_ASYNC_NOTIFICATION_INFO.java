...
public class _RPC_ASYNC_NOTIFICATION_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        ...
        Windows_h.C_POINTER.withName("hEvent"),
        Windows_h.C_POINTER.withName("NotificationRoutine")
    ...
    public static class IOC {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            Windows_h.C_POINTER.withName("hIOPort"),
            Windows_h.C_LONG.withName("dwNumberOfBytesTransferred"),
            MemoryLayout.paddingLayout(4),
            Windows_h.C_LONG_LONG.withName("dwCompletionKey"),
            Windows_h.C_POINTER.withName("lpOverlapped")
        ).withName("$anon$117:5");

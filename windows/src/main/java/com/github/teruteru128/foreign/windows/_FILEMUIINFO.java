...
public class _FILEMUIINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("dwFileType"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("pChecksum"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("pServiceChecksum"),
        Windows_h.C_LONG.withName("dwLanguageNameOffset"),
        Windows_h.C_LONG.withName("dwTypeIDMainSize"),
        Windows_h.C_LONG.withName("dwTypeIDMainOffset"),
        Windows_h.C_LONG.withName("dwTypeNameMainOffset"),
        Windows_h.C_LONG.withName("dwTypeIDMUISize"),
        Windows_h.C_LONG.withName("dwTypeIDMUIOffset"),
        Windows_h.C_LONG.withName("dwTypeNameMUIOffset"),
        MemoryLayout.sequenceLayout(8, Windows_h.C_CHAR).withName("abBuffer")

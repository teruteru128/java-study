 ...
 *     HRESULT (*QueryInterface)(ISynchronizeContainer *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(ISynchronizeContainer *) __attribute__((stdcall));
 *     ULONG (*Release)(ISynchronizeContainer *) __attribute__((stdcall));
 *     HRESULT (*AddSynchronize)(ISynchronizeContainer *, ISynchronize *) __attribute__((stdcall));
 *     HRESULT (*WaitMultiple)(ISynchronizeContainer *, DWORD, DWORD, ISynchronize **) __attribute__((stdcall));
 * }
 * }
 */
public class ISynchronizeContainerVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("AddSynchronize"),
        Windows_h.C_POINTER.withName("WaitMultiple")
    ...
    public static class AddSynchronize {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(AddSynchronize.Function.class, "apply", $DESC);
    ...
    private static final long AddSynchronize$OFFSET = 24;
    ...
    public static class WaitMultiple {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(WaitMultiple.Function.class, "apply", $DESC);
    ...
    private static final long WaitMultiple$OFFSET = 32;

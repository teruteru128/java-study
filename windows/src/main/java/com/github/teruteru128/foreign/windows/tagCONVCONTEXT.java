...
public class tagCONVCONTEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("wFlags"),
        Windows_h.C_INT.withName("wCountryID"),
        Windows_h.C_INT.withName("iCodePage"),
        Windows_h.C_LONG.withName("dwLangID"),
        Windows_h.C_LONG.withName("dwSecurity"),

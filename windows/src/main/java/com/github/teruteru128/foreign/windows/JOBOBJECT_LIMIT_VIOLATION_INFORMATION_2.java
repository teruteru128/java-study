...
public class JOBOBJECT_LIMIT_VIOLATION_INFORMATION_2 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("ViolationLimitFlags"),
        Windows_h.C_LONG_LONG.withName("IoReadBytes"),
        Windows_h.C_LONG_LONG.withName("IoReadBytesLimit"),
        Windows_h.C_LONG_LONG.withName("IoWriteBytes"),
    ...
    private static final OfLong JobHighMemoryLimit$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$12898:5"), groupElement("JobHighMemoryLimit"));
    ...
    private static final OfLong JobMemoryLimit$LAYOUT = (OfLong)$LAYOUT.select(groupElement("$anon$12898:5"), groupElement("JobMemoryLimit"));
    ...
    private static final OfInt RateControlTolerance$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12903:5"), groupElement("RateControlTolerance"));
    ...
    private static final OfInt CpuRateControlTolerance$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12903:5"), groupElement("CpuRateControlTolerance"));
    ...
    private static final OfInt RateControlToleranceLimit$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12908:5"), groupElement("RateControlToleranceLimit"));
    ...
    private static final OfInt CpuRateControlToleranceLimit$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$12908:5"), groupElement("CpuRateControlToleranceLimit"));

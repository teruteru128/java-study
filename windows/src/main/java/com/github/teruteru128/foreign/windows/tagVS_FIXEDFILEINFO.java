...
public class tagVS_FIXEDFILEINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("dwSignature"),
        Windows_h.C_LONG.withName("dwStrucVersion"),
        Windows_h.C_LONG.withName("dwFileVersionMS"),
        Windows_h.C_LONG.withName("dwFileVersionLS"),
        Windows_h.C_LONG.withName("dwProductVersionMS"),
        Windows_h.C_LONG.withName("dwProductVersionLS"),
        Windows_h.C_LONG.withName("dwFileFlagsMask"),
        Windows_h.C_LONG.withName("dwFileFlags"),
        Windows_h.C_LONG.withName("dwFileOS"),
        Windows_h.C_LONG.withName("dwFileType"),
        Windows_h.C_LONG.withName("dwFileSubtype"),
        Windows_h.C_LONG.withName("dwFileDateMS"),
        Windows_h.C_LONG.withName("dwFileDateLS")

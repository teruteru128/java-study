...
public class _STREAMS_QUERY_PARAMETERS_OUTPUT_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("OptimalWriteSize"),
        Windows_h.C_LONG.withName("StreamGranularitySize"),
        Windows_h.C_LONG.withName("StreamIdMin"),
        Windows_h.C_LONG.withName("StreamIdMax")

...
public class _UNWIND_HISTORY_TABLE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_CHAR.withName("LocalHint"),
        Windows_h.C_CHAR.withName("GlobalHint"),
        Windows_h.C_CHAR.withName("Search"),
        Windows_h.C_CHAR.withName("Once"),
        Windows_h.C_LONG_LONG.withName("LowAddress"),
        Windows_h.C_LONG_LONG.withName("HighAddress"),

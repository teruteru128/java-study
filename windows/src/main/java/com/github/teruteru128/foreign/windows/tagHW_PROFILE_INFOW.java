...
public class tagHW_PROFILE_INFOW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("dwDockInfo"),
        MemoryLayout.sequenceLayout(39, Windows_h.C_SHORT).withName("szHwProfileGuid"),
        MemoryLayout.sequenceLayout(80, Windows_h.C_SHORT).withName("szHwProfileName"),

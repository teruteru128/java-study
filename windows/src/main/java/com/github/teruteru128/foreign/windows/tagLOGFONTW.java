...
public class tagLOGFONTW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("lfHeight"),
        Windows_h.C_LONG.withName("lfWidth"),
        Windows_h.C_LONG.withName("lfEscapement"),
        Windows_h.C_LONG.withName("lfOrientation"),
        Windows_h.C_LONG.withName("lfWeight"),
        Windows_h.C_CHAR.withName("lfItalic"),
        Windows_h.C_CHAR.withName("lfUnderline"),
        Windows_h.C_CHAR.withName("lfStrikeOut"),
        Windows_h.C_CHAR.withName("lfCharSet"),
        Windows_h.C_CHAR.withName("lfOutPrecision"),
        Windows_h.C_CHAR.withName("lfClipPrecision"),
        Windows_h.C_CHAR.withName("lfQuality"),
        Windows_h.C_CHAR.withName("lfPitchAndFamily"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_SHORT).withName("lfFaceName")
     ...
     * }
     */
    public static short lfFaceName(MemorySegment struct, long index0) {
        return (short)lfFaceName$ELEM_HANDLE.get(struct, 0L, index0);
    }
     ...
     * }
     */
    public static void lfFaceName(MemorySegment struct, long index0, short fieldValue) {

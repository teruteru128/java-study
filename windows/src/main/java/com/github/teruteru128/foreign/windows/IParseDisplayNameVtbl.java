 ...
 *     HRESULT (*QueryInterface)(IParseDisplayName *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IParseDisplayName *) __attribute__((stdcall));
 *     ULONG (*Release)(IParseDisplayName *) __attribute__((stdcall));
 *     HRESULT (*ParseDisplayName)(IParseDisplayName *, IBindCtx *, LPOLESTR, ULONG *, IMoniker **) __attribute__((stdcall));
 * }
 * }
 */

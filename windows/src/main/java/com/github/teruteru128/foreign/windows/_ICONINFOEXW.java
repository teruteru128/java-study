...
public class _ICONINFOEXW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("fIcon"),
        Windows_h.C_LONG.withName("xHotspot"),
        Windows_h.C_LONG.withName("yHotspot"),
        Windows_h.C_POINTER.withName("hbmMask"),
        Windows_h.C_POINTER.withName("hbmColor"),
        Windows_h.C_SHORT.withName("wResID"),
        MemoryLayout.sequenceLayout(260, Windows_h.C_SHORT).withName("szModName"),
        MemoryLayout.sequenceLayout(260, Windows_h.C_SHORT).withName("szResName"),

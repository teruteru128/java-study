...
public class _DEVICE_DATA_SET_REPAIR_PARAMETERS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("NumberOfRepairCopies"),
        Windows_h.C_LONG.withName("SourceCopy"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_LONG).withName("RepairCopies")

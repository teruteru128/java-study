...
public class FILE_ID_DESCRIPTOR {
    ...
    private static final GroupLayout FileId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9187:5"), groupElement("FileId"));
    ...
    private static final GroupLayout ObjectId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9187:5"), groupElement("ObjectId"));
    ...
    private static final GroupLayout ExtendedFileId$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$9187:5"), groupElement("ExtendedFileId"));

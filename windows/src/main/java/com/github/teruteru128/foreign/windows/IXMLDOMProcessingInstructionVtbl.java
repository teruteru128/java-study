 ...
 *     HRESULT (*QueryInterface)(IXMLDOMProcessingInstruction *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IXMLDOMProcessingInstruction *) __attribute__((stdcall));
 *     ULONG (*Release)(IXMLDOMProcessingInstruction *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfoCount)(IXMLDOMProcessingInstruction *, UINT *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfo)(IXMLDOMProcessingInstruction *, UINT, LCID, ITypeInfo **) __attribute__((stdcall));
 *     HRESULT (*GetIDsOfNames)(IXMLDOMProcessingInstruction *, const IID *const, LPOLESTR *, UINT, LCID, DISPID *) __attribute__((stdcall));
 *     HRESULT (*Invoke)(IXMLDOMProcessingInstruction *, DISPID, const IID *const, LCID, WORD, DISPPARAMS *, VARIANT *, EXCEPINFO *, UINT *) __attribute__((stdcall));
 *     HRESULT (*get_nodeName)(IXMLDOMProcessingInstruction *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_nodeValue)(IXMLDOMProcessingInstruction *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_nodeValue)(IXMLDOMProcessingInstruction *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_nodeType)(IXMLDOMProcessingInstruction *, DOMNodeType *) __attribute__((stdcall));
 *     HRESULT (*get_parentNode)(IXMLDOMProcessingInstruction *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_childNodes)(IXMLDOMProcessingInstruction *, IXMLDOMNodeList **) __attribute__((stdcall));
 *     HRESULT (*get_firstChild)(IXMLDOMProcessingInstruction *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_lastChild)(IXMLDOMProcessingInstruction *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_previousSibling)(IXMLDOMProcessingInstruction *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nextSibling)(IXMLDOMProcessingInstruction *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_attributes)(IXMLDOMProcessingInstruction *, IXMLDOMNamedNodeMap **) __attribute__((stdcall));
 *     HRESULT (*insertBefore)(IXMLDOMProcessingInstruction *, IXMLDOMNode *, VARIANT, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*replaceChild)(IXMLDOMProcessingInstruction *, IXMLDOMNode *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*removeChild)(IXMLDOMProcessingInstruction *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*appendChild)(IXMLDOMProcessingInstruction *, IXMLDOMNode *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*hasChildNodes)(IXMLDOMProcessingInstruction *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_ownerDocument)(IXMLDOMProcessingInstruction *, IXMLDOMDocument **) __attribute__((stdcall));
 *     HRESULT (*cloneNode)(IXMLDOMProcessingInstruction *, VARIANT_BOOL, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nodeTypeString)(IXMLDOMProcessingInstruction *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_text)(IXMLDOMProcessingInstruction *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*put_text)(IXMLDOMProcessingInstruction *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_specified)(IXMLDOMProcessingInstruction *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_definition)(IXMLDOMProcessingInstruction *, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_nodeTypedValue)(IXMLDOMProcessingInstruction *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_nodeTypedValue)(IXMLDOMProcessingInstruction *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_dataType)(IXMLDOMProcessingInstruction *, VARIANT *) __attribute__((stdcall));
 *     HRESULT (*put_dataType)(IXMLDOMProcessingInstruction *, BSTR) __attribute__((stdcall));
 *     HRESULT (*get_xml)(IXMLDOMProcessingInstruction *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*transformNode)(IXMLDOMProcessingInstruction *, IXMLDOMNode *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*selectNodes)(IXMLDOMProcessingInstruction *, BSTR, IXMLDOMNodeList **) __attribute__((stdcall));
 *     HRESULT (*selectSingleNode)(IXMLDOMProcessingInstruction *, BSTR, IXMLDOMNode **) __attribute__((stdcall));
 *     HRESULT (*get_parsed)(IXMLDOMProcessingInstruction *, VARIANT_BOOL *) __attribute__((stdcall));
 *     HRESULT (*get_namespaceURI)(IXMLDOMProcessingInstruction *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_prefix)(IXMLDOMProcessingInstruction *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_baseName)(IXMLDOMProcessingInstruction *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*transformNodeToObject)(IXMLDOMProcessingInstruction *, IXMLDOMNode *, VARIANT) __attribute__((stdcall));
 *     HRESULT (*get_target)(IXMLDOMProcessingInstruction *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*get_data)(IXMLDOMProcessingInstruction *, BSTR *) __attribute__((stdcall));
 *     HRESULT (*put_data)(IXMLDOMProcessingInstruction *, BSTR) __attribute__((stdcall));
 * }
 * }
 */
public class IXMLDOMProcessingInstructionVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("get_target"),
    ...
    public static class get_target {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(get_target.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(get_target.Function fi, Arena arena) {
            return Linker.nativeLinker().upcallStub(UP$MH.bindTo(fi), $DESC, arena);
        }
    ...
    private static final AddressLayout get_target$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("get_target"));
     ...
     * }
     */
    public static final AddressLayout get_target$layout() {
        return get_target$LAYOUT;
    }
     ...
     * }
     */
    public static final long get_target$offset() {
     ...
     * }
     */
    public static MemorySegment get_target(MemorySegment struct) {
        return struct.get(get_target$LAYOUT, get_target$OFFSET);
    }
     ...
     * }
     */
    public static void get_target(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(get_target$LAYOUT, get_target$OFFSET, fieldValue);
    }

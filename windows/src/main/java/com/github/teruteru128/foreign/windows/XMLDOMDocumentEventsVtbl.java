 ...
 *     HRESULT (*QueryInterface)(XMLDOMDocumentEvents *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(XMLDOMDocumentEvents *) __attribute__((stdcall));
 *     ULONG (*Release)(XMLDOMDocumentEvents *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfoCount)(XMLDOMDocumentEvents *, UINT *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfo)(XMLDOMDocumentEvents *, UINT, LCID, ITypeInfo **) __attribute__((stdcall));
 *     HRESULT (*GetIDsOfNames)(XMLDOMDocumentEvents *, const IID *const, LPOLESTR *, UINT, LCID, DISPID *) __attribute__((stdcall));
 *     HRESULT (*Invoke)(XMLDOMDocumentEvents *, DISPID, const IID *const, LCID, WORD, DISPPARAMS *, VARIANT *, EXCEPINFO *, UINT *) __attribute__((stdcall));
 * }
 * }
 */

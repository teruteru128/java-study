...
public class _CERT_EXTENSION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("fCritical"),
    ...
    private static final OfInt fCritical$LAYOUT = (OfInt)$LAYOUT.select(groupElement("fCritical"));
     ...
     * }
     */
    public static final OfInt fCritical$layout() {
        return fCritical$LAYOUT;
    }

    private static final long fCritical$OFFSET = 8;
     ...
     * }
     */
    public static final long fCritical$offset() {
        return fCritical$OFFSET;
    }
     ...
     * }
     */
    public static int fCritical(MemorySegment struct) {
        return struct.get(fCritical$LAYOUT, fCritical$OFFSET);
    }
     ...
     * }
     */
    public static void fCritical(MemorySegment struct, int fieldValue) {
        struct.set(fCritical$LAYOUT, fCritical$OFFSET, fieldValue);
    }

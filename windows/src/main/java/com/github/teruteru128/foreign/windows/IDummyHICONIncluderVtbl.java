 ...
 *     HRESULT (*QueryInterface)(IDummyHICONIncluder *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IDummyHICONIncluder *) __attribute__((stdcall));
 *     ULONG (*Release)(IDummyHICONIncluder *) __attribute__((stdcall));
 *     HRESULT (*Dummy)(IDummyHICONIncluder *, HICON, HDC) __attribute__((stdcall));
 * }
 * }
 */
public class IDummyHICONIncluderVtbl {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("Dummy")
    ...
    public static class Dummy {
        ...
        private static final MethodHandle UP$MH = Windows_h.upcallHandle(Dummy.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(Dummy.Function fi, Arena arena) {
            return Linker.nativeLinker().upcallStub(UP$MH.bindTo(fi), $DESC, arena);
        }
    ...
    private static final AddressLayout Dummy$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("Dummy"));
     ...
     * }
     */
    public static final AddressLayout Dummy$layout() {
        return Dummy$LAYOUT;
    }

    private static final long Dummy$OFFSET = 24;

...
public class _MARK_HANDLE_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        ).withName("$anon$11749:5"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("VolumeHandle"),
    ...
    private static final OfInt UsnSourceInfo$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$11749:5"), groupElement("UsnSourceInfo"));
    ...
    private static final OfInt CopyNumber$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$11749:5"), groupElement("CopyNumber"));

...
public class _STORAGE_TEMPERATURE_DATA_DESCRIPTOR {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_SHORT.withName("CriticalTemperature"),
        Windows_h.C_SHORT.withName("WarningTemperature"),
        Windows_h.C_SHORT.withName("InfoCount"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_CHAR).withName("Reserved0"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_LONG).withName("Reserved1"),

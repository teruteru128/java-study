...
public class _IMAGE_COFF_SYMBOLS_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("NumberOfSymbols"),
        Windows_h.C_LONG.withName("LvaToFirstSymbol"),
        Windows_h.C_LONG.withName("NumberOfLinenumbers"),
        Windows_h.C_LONG.withName("LvaToFirstLinenumber"),
        Windows_h.C_LONG.withName("RvaToFirstByteOfCode"),
        Windows_h.C_LONG.withName("RvaToLastByteOfCode"),
        Windows_h.C_LONG.withName("RvaToFirstByteOfData"),
        Windows_h.C_LONG.withName("RvaToLastByteOfData")

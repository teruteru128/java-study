...
public class PPM_WMI_PERF_STATES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("MaxFrequency"),
        Windows_h.C_LONG.withName("CurrentState"),
        Windows_h.C_LONG.withName("MaxPerfState"),
        Windows_h.C_LONG.withName("MinPerfState"),
        Windows_h.C_LONG.withName("LowestPerfState"),
        Windows_h.C_LONG.withName("ThermalConstraint"),
        Windows_h.C_CHAR.withName("BusyAdjThreshold"),
        Windows_h.C_CHAR.withName("PolicyType"),
        Windows_h.C_CHAR.withName("Type"),
        Windows_h.C_CHAR.withName("Reserved"),
        Windows_h.C_LONG.withName("TimerInterval"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_LONG_LONG.withName("TargetProcessors"),
        Windows_h.C_LONG.withName("PStateHandler"),
        Windows_h.C_LONG.withName("PStateContext"),
        Windows_h.C_LONG.withName("TStateHandler"),
        Windows_h.C_LONG.withName("TStateContext"),
        Windows_h.C_LONG.withName("FeedbackHandler"),

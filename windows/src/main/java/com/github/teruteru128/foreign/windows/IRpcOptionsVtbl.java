 ...
 *     HRESULT (*QueryInterface)(IRpcOptions *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IRpcOptions *) __attribute__((stdcall));
 *     ULONG (*Release)(IRpcOptions *) __attribute__((stdcall));
 *     HRESULT (*Set)(IRpcOptions *, IUnknown *, RPCOPT_PROPERTIES, ULONG_PTR) __attribute__((stdcall));
 *     HRESULT (*Query)(IRpcOptions *, IUnknown *, RPCOPT_PROPERTIES, ULONG_PTR *) __attribute__((stdcall));
 * }
 * }
 */

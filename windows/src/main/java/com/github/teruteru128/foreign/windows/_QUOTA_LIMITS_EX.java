...
public class _QUOTA_LIMITS_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("PagedPoolLimit"),
        Windows_h.C_LONG_LONG.withName("NonPagedPoolLimit"),
        Windows_h.C_LONG_LONG.withName("MinimumWorkingSetSize"),
        Windows_h.C_LONG_LONG.withName("MaximumWorkingSetSize"),
        Windows_h.C_LONG_LONG.withName("PagefileLimit"),
        _LARGE_INTEGER.layout().withName("TimeLimit"),
        Windows_h.C_LONG_LONG.withName("WorkingSetLimit"),
        Windows_h.C_LONG_LONG.withName("Reserved2"),
        Windows_h.C_LONG_LONG.withName("Reserved3"),
        Windows_h.C_LONG_LONG.withName("Reserved4"),

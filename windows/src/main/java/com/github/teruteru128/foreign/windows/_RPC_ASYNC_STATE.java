...
public class _RPC_ASYNC_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("Lock"),
        Windows_h.C_LONG.withName("Flags"),
        Windows_h.C_POINTER.withName("StubInfo"),
        Windows_h.C_POINTER.withName("UserInfo"),
        Windows_h.C_POINTER.withName("RuntimeInfo"),
        Windows_h.C_INT.withName("Event"),
        Windows_h.C_INT.withName("NotificationType"),
        _RPC_ASYNC_NOTIFICATION_INFO.layout().withName("u"),
        MemoryLayout.sequenceLayout(4, Windows_h.C_LONG_LONG).withName("Reserved")

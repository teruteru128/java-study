 ...
 *     HRESULT (*QueryInterface)(IPersistStream *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IPersistStream *) __attribute__((stdcall));
 *     ULONG (*Release)(IPersistStream *) __attribute__((stdcall));
 *     HRESULT (*GetClassID)(IPersistStream *, CLSID *) __attribute__((stdcall));
 *     HRESULT (*IsDirty)(IPersistStream *) __attribute__((stdcall));
 *     HRESULT (*Load)(IPersistStream *, IStream *) __attribute__((stdcall));
 *     HRESULT (*Save)(IPersistStream *, IStream *, BOOL) __attribute__((stdcall));
 *     HRESULT (*GetSizeMax)(IPersistStream *, ULARGE_INTEGER *) __attribute__((stdcall));
 * }
 * }
 */

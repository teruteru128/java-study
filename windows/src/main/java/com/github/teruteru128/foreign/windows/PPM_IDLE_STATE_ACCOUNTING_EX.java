...
public class PPM_IDLE_STATE_ACCOUNTING_EX {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG_LONG.withName("TotalTime"),
        Windows_h.C_LONG.withName("IdleTransitions"),
        Windows_h.C_LONG.withName("FailedTransitions"),
        Windows_h.C_LONG.withName("InvalidBucketIndex"),
        Windows_h.C_LONG.withName("MinTimeUs"),
        Windows_h.C_LONG.withName("MaxTimeUs"),
        Windows_h.C_LONG.withName("CancelledTransitions"),
        MemoryLayout.sequenceLayout(16, PPM_IDLE_STATE_BUCKET_EX.layout()).withName("IdleTimeBuckets")
    ).withName("$anon$17458:9");

 ...
 *     HRESULT (*QueryInterface)(IDispatch *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IDispatch *) __attribute__((stdcall));
 *     ULONG (*Release)(IDispatch *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfoCount)(IDispatch *, UINT *) __attribute__((stdcall));
 *     HRESULT (*GetTypeInfo)(IDispatch *, UINT, LCID, ITypeInfo **) __attribute__((stdcall));
 *     HRESULT (*GetIDsOfNames)(IDispatch *, const IID *const, LPOLESTR *, UINT, LCID, DISPID *) __attribute__((stdcall));
 *     HRESULT (*Invoke)(IDispatch *, DISPID, const IID *const, LCID, WORD, DISPPARAMS *, VARIANT *, EXCEPINFO *, UINT *) __attribute__((stdcall));
 * }
 * }
 */

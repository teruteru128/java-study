...
public class PROCESSOR_PERFSTATE_POLICY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_CHAR.withName("MaxThrottle"),
        Windows_h.C_CHAR.withName("MinThrottle"),
        Windows_h.C_CHAR.withName("BusyAdjThreshold"),
        MemoryLayout.unionLayout(
            Windows_h.C_CHAR.withName("Spare"),
            PROCESSOR_PERFSTATE_POLICY.Flags.layout().withName("Flags")
        ).withName("$anon$17818:5"),
        Windows_h.C_LONG.withName("TimeCheck"),
        Windows_h.C_LONG.withName("IncreaseTime"),
        Windows_h.C_LONG.withName("DecreaseTime"),
        Windows_h.C_LONG.withName("IncreasePercent"),
        Windows_h.C_LONG.withName("DecreasePercent")
    ).withName("$anon$17813:9");
    ...
    private static final OfByte Spare$LAYOUT = (OfByte)$LAYOUT.select(groupElement("$anon$17818:5"), groupElement("Spare"));
    ...
    public static class Flags {
        ...
        private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
            ...
            ).withName("$anon$17822:13")
        ).withName("$anon$17820:9");
    ...
    private static final GroupLayout Flags$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$17818:5"), groupElement("Flags"));

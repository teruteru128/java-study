...
public class _DEVICE_LOCATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("Socket"),
        Windows_h.C_LONG.withName("Slot"),
        Windows_h.C_LONG.withName("Adapter"),
        Windows_h.C_LONG.withName("Port"),
        MemoryLayout.unionLayout(
            MemoryLayout.structLayout(
                Windows_h.C_LONG.withName("Channel"),
                Windows_h.C_LONG.withName("Device")
            ).withName("$anon$2993:9"),
            MemoryLayout.structLayout(
                Windows_h.C_LONG.withName("Target"),
                Windows_h.C_LONG.withName("Lun")
            ).withName("$anon$3001:9")
        ).withName("$anon$2991:5")
    ...
    private static final OfInt Channel$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2991:5"), groupElement("$anon$2993:9"), groupElement("Channel"));
    ...
    private static final OfInt Device$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2991:5"), groupElement("$anon$2993:9"), groupElement("Device"));
    ...
    private static final OfInt Target$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2991:5"), groupElement("$anon$3001:9"), groupElement("Target"));
    ...
    private static final OfInt Lun$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2991:5"), groupElement("$anon$3001:9"), groupElement("Lun"));

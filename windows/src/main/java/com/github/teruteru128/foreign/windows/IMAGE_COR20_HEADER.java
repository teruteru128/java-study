...
public class IMAGE_COR20_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_SHORT.withName("MajorRuntimeVersion"),
        Windows_h.C_SHORT.withName("MinorRuntimeVersion"),
        _IMAGE_DATA_DIRECTORY.layout().withName("MetaData"),
        Windows_h.C_LONG.withName("Flags"),
        MemoryLayout.unionLayout(
            Windows_h.C_LONG.withName("EntryPointToken"),
            Windows_h.C_LONG.withName("EntryPointRVA")
        ).withName("$anon$20387:5"),
    ...
    private static final OfInt EntryPointToken$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20387:5"), groupElement("EntryPointToken"));
    ...
    private static final OfInt EntryPointRVA$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$20387:5"), groupElement("EntryPointRVA"));

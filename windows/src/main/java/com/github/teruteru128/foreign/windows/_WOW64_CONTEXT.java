...
public class _WOW64_CONTEXT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("Dr0"),
        Windows_h.C_LONG.withName("Dr1"),
        Windows_h.C_LONG.withName("Dr2"),
        Windows_h.C_LONG.withName("Dr3"),
        Windows_h.C_LONG.withName("Dr6"),
        Windows_h.C_LONG.withName("Dr7"),
        _WOW64_FLOATING_SAVE_AREA.layout().withName("FloatSave"),
        Windows_h.C_LONG.withName("SegGs"),
        Windows_h.C_LONG.withName("SegFs"),
        Windows_h.C_LONG.withName("SegEs"),
        Windows_h.C_LONG.withName("SegDs"),
        Windows_h.C_LONG.withName("Edi"),
        Windows_h.C_LONG.withName("Esi"),
        Windows_h.C_LONG.withName("Ebx"),
        Windows_h.C_LONG.withName("Edx"),
        Windows_h.C_LONG.withName("Ecx"),
        Windows_h.C_LONG.withName("Eax"),
        Windows_h.C_LONG.withName("Ebp"),
        Windows_h.C_LONG.withName("Eip"),
        Windows_h.C_LONG.withName("SegCs"),
        Windows_h.C_LONG.withName("EFlags"),
        Windows_h.C_LONG.withName("Esp"),
        Windows_h.C_LONG.withName("SegSs"),
        MemoryLayout.sequenceLayout(512, Windows_h.C_CHAR).withName("ExtendedRegisters")

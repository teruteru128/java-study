...
public class _STORAGE_PHYSICAL_DEVICE_DATA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("DeviceId"),
        Windows_h.C_LONG.withName("Role"),
        ...
        Windows_h.C_INT.withName("FormFactor"),
        ...
        Windows_h.C_LONG_LONG.withName("Capacity"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("PhysicalLocation"),
        MemoryLayout.sequenceLayout(2, Windows_h.C_LONG).withName("Reserved")

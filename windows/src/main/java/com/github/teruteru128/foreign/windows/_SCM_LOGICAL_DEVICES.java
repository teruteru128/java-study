...
public class _SCM_LOGICAL_DEVICES {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, _SCM_LOGICAL_DEVICE_INSTANCE.layout()).withName("Devices")
    ...
    public static void Devices(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, Devices(struct, index0), 0L, _SCM_LOGICAL_DEVICE_INSTANCE.layout().byteSize());
    }

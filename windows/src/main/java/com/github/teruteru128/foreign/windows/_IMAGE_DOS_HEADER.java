...
public class _IMAGE_DOS_HEADER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_SHORT.withName("e_magic"),
        Windows_h.C_SHORT.withName("e_cblp"),
        Windows_h.C_SHORT.withName("e_cp"),
        Windows_h.C_SHORT.withName("e_crlc"),
        Windows_h.C_SHORT.withName("e_cparhdr"),
        Windows_h.C_SHORT.withName("e_minalloc"),
        Windows_h.C_SHORT.withName("e_maxalloc"),
        Windows_h.C_SHORT.withName("e_ss"),
        Windows_h.C_SHORT.withName("e_sp"),
        Windows_h.C_SHORT.withName("e_csum"),
        Windows_h.C_SHORT.withName("e_ip"),
        Windows_h.C_SHORT.withName("e_cs"),
        Windows_h.C_SHORT.withName("e_lfarlc"),
        Windows_h.C_SHORT.withName("e_ovno"),
        MemoryLayout.sequenceLayout(4, Windows_h.C_SHORT).withName("e_res"),
        Windows_h.C_SHORT.withName("e_oemid"),
        Windows_h.C_SHORT.withName("e_oeminfo"),
        MemoryLayout.sequenceLayout(10, Windows_h.C_SHORT).withName("e_res2"),
        Windows_h.align(Windows_h.C_LONG, 2).withName("e_lfanew")

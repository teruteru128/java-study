...
public class _CERT_CHAIN_ELEMENT {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("pCertContext"),
        _CERT_TRUST_STATUS.layout().withName("TrustStatus"),
        Windows_h.C_POINTER.withName("pRevocationInfo"),
        Windows_h.C_POINTER.withName("pIssuanceUsage"),
        Windows_h.C_POINTER.withName("pApplicationUsage"),
        Windows_h.C_POINTER.withName("pwszExtendedErrorInfo")

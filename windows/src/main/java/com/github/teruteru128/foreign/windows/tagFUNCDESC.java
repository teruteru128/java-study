...
public class tagFUNCDESC {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("lprgscode"),
        Windows_h.C_POINTER.withName("lprgelemdescParam"),
        Windows_h.C_INT.withName("funckind"),
        Windows_h.C_INT.withName("invkind"),
        Windows_h.C_INT.withName("callconv"),
        Windows_h.C_SHORT.withName("cParams"),
        Windows_h.C_SHORT.withName("cParamsOpt"),
        Windows_h.C_SHORT.withName("oVft"),
        Windows_h.C_SHORT.withName("cScodes"),
        MemoryLayout.paddingLayout(4),
        tagELEMDESC.layout().withName("elemdescFunc"),
        Windows_h.C_SHORT.withName("wFuncFlags"),

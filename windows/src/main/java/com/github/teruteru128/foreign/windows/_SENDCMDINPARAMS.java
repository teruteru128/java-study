...
public class _SENDCMDINPARAMS {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.align(Windows_h.C_LONG, 1).withName("cBufferSize"),
        _IDEREGS.layout().withName("irDriveRegs"),
        Windows_h.C_CHAR.withName("bDriveNumber"),
        MemoryLayout.sequenceLayout(3, Windows_h.C_CHAR).withName("bReserved"),
        MemoryLayout.sequenceLayout(4, Windows_h.align(Windows_h.C_LONG, 1)).withName("dwReserved"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_CHAR).withName("bBuffer")

...
public class _STORAGE_CRYPTO_CAPABILITY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("CryptoCapabilityIndex"),
        Windows_h.C_INT.withName("AlgorithmId"),
        Windows_h.C_INT.withName("KeySize"),
        Windows_h.C_LONG.withName("DataUnitSizeBitmask")

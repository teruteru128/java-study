...
public class _GROUP_RELATIONSHIP {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_SHORT.withName("MaximumGroupCount"),
        Windows_h.C_SHORT.withName("ActiveGroupCount"),
        MemoryLayout.sequenceLayout(20, Windows_h.C_CHAR).withName("Reserved"),

...
public class _TIME_DYNAMIC_ZONE_INFORMATION {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("Bias"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_SHORT).withName("StandardName"),
        _SYSTEMTIME.layout().withName("StandardDate"),
        Windows_h.C_LONG.withName("StandardBias"),
        MemoryLayout.sequenceLayout(32, Windows_h.C_SHORT).withName("DaylightName"),
        _SYSTEMTIME.layout().withName("DaylightDate"),
        Windows_h.C_LONG.withName("DaylightBias"),
        MemoryLayout.sequenceLayout(128, Windows_h.C_SHORT).withName("TimeZoneKeyName"),
        Windows_h.C_CHAR.withName("DynamicDaylightTimeDisabled"),

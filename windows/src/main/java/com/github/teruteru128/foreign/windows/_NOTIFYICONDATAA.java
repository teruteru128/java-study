...
public class _NOTIFYICONDATAA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(128, Windows_h.C_CHAR).withName("szTip"),
        Windows_h.C_LONG.withName("dwState"),
        Windows_h.C_LONG.withName("dwStateMask"),
        MemoryLayout.sequenceLayout(256, Windows_h.C_CHAR).withName("szInfo"),
        MemoryLayout.unionLayout(
            Windows_h.C_INT.withName("uTimeout"),
            Windows_h.C_INT.withName("uVersion")
        ).withName("$anon$1026:5"),
        MemoryLayout.sequenceLayout(64, Windows_h.C_CHAR).withName("szInfoTitle"),

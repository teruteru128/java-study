...
public class _SERVICE_FAILURE_ACTIONSA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("dwResetPeriod"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("lpRebootMsg"),
        Windows_h.C_POINTER.withName("lpCommand"),
        Windows_h.C_LONG.withName("cActions"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("lpsaActions")

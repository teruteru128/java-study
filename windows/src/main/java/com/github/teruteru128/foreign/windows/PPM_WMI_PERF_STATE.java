...
public class PPM_WMI_PERF_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("Frequency"),
        Windows_h.C_LONG.withName("Power"),
        Windows_h.C_CHAR.withName("PercentFrequency"),
        Windows_h.C_CHAR.withName("IncreaseLevel"),
        Windows_h.C_CHAR.withName("DecreaseLevel"),
        Windows_h.C_CHAR.withName("Type"),
        Windows_h.C_LONG.withName("IncreaseTime"),
        Windows_h.C_LONG.withName("DecreaseTime"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_LONG_LONG.withName("Control"),
        Windows_h.C_LONG_LONG.withName("Status"),
        Windows_h.C_LONG.withName("HitCount"),
        Windows_h.C_LONG.withName("Reserved1"),
        Windows_h.C_LONG_LONG.withName("Reserved2"),
        Windows_h.C_LONG_LONG.withName("Reserved3")
    ).withName("$anon$17358:9");

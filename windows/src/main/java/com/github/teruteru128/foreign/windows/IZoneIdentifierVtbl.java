 ...
 *     HRESULT (*QueryInterface)(IZoneIdentifier *, const IID *const, void **) __attribute__((stdcall));
 *     ULONG (*AddRef)(IZoneIdentifier *) __attribute__((stdcall));
 *     ULONG (*Release)(IZoneIdentifier *) __attribute__((stdcall));
 *     HRESULT (*GetId)(IZoneIdentifier *, DWORD *) __attribute__((stdcall));
 *     HRESULT (*SetId)(IZoneIdentifier *, DWORD) __attribute__((stdcall));
 *     HRESULT (*Remove)(IZoneIdentifier *) __attribute__((stdcall));
 * }
 * }
 */

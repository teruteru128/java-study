...
public class _STREAM_LAYOUT_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("NextStreamOffset"),
        Windows_h.C_LONG.withName("Flags"),
        Windows_h.C_LONG.withName("ExtentInformationOffset"),
        _LARGE_INTEGER.layout().withName("AllocationSize"),
        _LARGE_INTEGER.layout().withName("EndOfFile"),
        Windows_h.C_LONG.withName("StreamInformationOffset"),
        Windows_h.C_LONG.withName("AttributeTypeCode"),
        Windows_h.C_LONG.withName("AttributeFlags"),
        Windows_h.C_LONG.withName("StreamIdentifierLength"),
        MemoryLayout.sequenceLayout(1, Windows_h.C_SHORT).withName("StreamIdentifier"),

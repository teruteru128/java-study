...
public class _CRYPT_AES_256_KEY_STATE {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("Key"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("IV"),
        MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR)).withName("EncryptionState"),
        MemoryLayout.sequenceLayout(15, MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR)).withName("DecryptionState"),

...
public class tagSCROLLBARINFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_INT.withName("dxyLineButton"),
        Windows_h.C_INT.withName("xyThumbTop"),
        Windows_h.C_INT.withName("xyThumbBottom"),
        Windows_h.C_INT.withName("reserved"),
        MemoryLayout.sequenceLayout(6, Windows_h.C_LONG).withName("rgstate")

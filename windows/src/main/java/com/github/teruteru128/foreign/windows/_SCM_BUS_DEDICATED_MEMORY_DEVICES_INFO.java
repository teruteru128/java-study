...
public class _SCM_BUS_DEDICATED_MEMORY_DEVICES_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(1, _SCM_BUS_DEDICATED_MEMORY_DEVICE_INFO.layout()).withName("Devices")
    ...
    private static final long Devices$OFFSET = 16;
    ...
    public static void Devices(MemorySegment struct, long index0, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, Devices(struct, index0), 0L, _SCM_BUS_DEDICATED_MEMORY_DEVICE_INFO.layout().byteSize());
    }

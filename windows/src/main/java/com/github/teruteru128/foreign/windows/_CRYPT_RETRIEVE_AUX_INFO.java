...
public class _CRYPT_RETRIEVE_AUX_INFO {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("dwMaxUrlRetrievalByteCount"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("pPreFetchInfo"),
        Windows_h.C_POINTER.withName("pFlushInfo"),
        Windows_h.C_POINTER.withName("ppResponseInfo"),
        Windows_h.C_POINTER.withName("pwszCacheFileNamePrefix"),
        Windows_h.C_POINTER.withName("pftCacheResync"),
        Windows_h.C_INT.withName("fProxyCacheRetrieval"),
        Windows_h.C_LONG.withName("dwHttpStatusCode"),
        Windows_h.C_POINTER.withName("ppwszErrorResponseHeaders"),
        Windows_h.C_POINTER.withName("ppErrorContentBlob")

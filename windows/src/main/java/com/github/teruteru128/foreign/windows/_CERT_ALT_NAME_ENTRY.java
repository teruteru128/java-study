...
public class _CERT_ALT_NAME_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_LONG.withName("dwAltNameChoice"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("pOtherName"),
            Windows_h.C_POINTER.withName("pwszRfc822Name"),
            Windows_h.C_POINTER.withName("pwszDNSName"),
            _CRYPTOAPI_BLOB.layout().withName("DirectoryName"),
            Windows_h.C_POINTER.withName("pwszURL"),
            _CRYPTOAPI_BLOB.layout().withName("IPAddress"),
            Windows_h.C_POINTER.withName("pszRegisteredID")
        ).withName("$anon$3959:5")
    ...
    private static final AddressLayout pOtherName$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$3959:5"), groupElement("pOtherName"));
    ...
    private static final AddressLayout pwszRfc822Name$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$3959:5"), groupElement("pwszRfc822Name"));
    ...
    private static final AddressLayout pwszDNSName$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$3959:5"), groupElement("pwszDNSName"));
    ...
    private static final GroupLayout DirectoryName$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$3959:5"), groupElement("DirectoryName"));
    ...
    private static final AddressLayout pwszURL$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$3959:5"), groupElement("pwszURL"));
    ...
    private static final GroupLayout IPAddress$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$3959:5"), groupElement("IPAddress"));
    ...
    private static final AddressLayout pszRegisteredID$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$3959:5"), groupElement("pszRegisteredID"));

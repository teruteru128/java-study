...
public class _OCSP_BASIC_RESPONSE_ENTRY {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_LONG.withName("dwCertStatus"),
        MemoryLayout.paddingLayout(4),
        MemoryLayout.unionLayout(
            Windows_h.C_POINTER.withName("pRevokedInfo")
        ).withName("$anon$5684:5"),
    ...
    private static final AddressLayout pRevokedInfo$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("$anon$5684:5"), groupElement("pRevokedInfo"));

...
public class tagGCP_RESULTSW {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("lpOutString"),
        Windows_h.C_POINTER.withName("lpOrder"),
        Windows_h.C_POINTER.withName("lpDx"),
        Windows_h.C_POINTER.withName("lpCaretPos"),
        Windows_h.C_POINTER.withName("lpClass"),
        Windows_h.C_POINTER.withName("lpGlyphs"),
        Windows_h.C_INT.withName("nGlyphs"),
        Windows_h.C_INT.withName("nMaxFit")

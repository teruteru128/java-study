...
public class _SERVICE_NOTIFY_2A {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Windows_h.C_POINTER.withName("pfnNotifyCallback"),
        Windows_h.C_POINTER.withName("pContext"),
        Windows_h.C_LONG.withName("dwNotificationStatus"),
        _SERVICE_STATUS_PROCESS.layout().withName("ServiceStatus"),
        Windows_h.C_LONG.withName("dwNotificationTriggered"),
        MemoryLayout.paddingLayout(4),
        Windows_h.C_POINTER.withName("pszServiceNames")

...
public class _devicemodeA {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("dmDeviceName"),
        ...
        MemoryLayout.sequenceLayout(32, Windows_h.C_CHAR).withName("dmFormName"),
    ...
    private static final OfShort dmOrientation$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmOrientation"));
    ...
    private static final OfShort dmPaperSize$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmPaperSize"));
    ...
    private static final OfShort dmPaperLength$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmPaperLength"));
    ...
    private static final OfShort dmPaperWidth$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmPaperWidth"));
    ...
    private static final OfShort dmScale$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmScale"));
    ...
    private static final OfShort dmCopies$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmCopies"));
    ...
    private static final OfShort dmDefaultSource$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmDefaultSource"));
    ...
    private static final OfShort dmPrintQuality$LAYOUT = (OfShort)$LAYOUT.select(groupElement("$anon$2205:5"), groupElement("$anon$2207:7"), groupElement("dmPrintQuality"));
    ...
    private static final GroupLayout dmPosition$LAYOUT = (GroupLayout)$LAYOUT.select(groupElement("$anon$2205:5"), groupElement("$anon$2218:7"), groupElement("dmPosition"));
    ...
    private static final OfInt dmDisplayOrientation$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2205:5"), groupElement("$anon$2218:7"), groupElement("dmDisplayOrientation"));
    ...
    private static final OfInt dmDisplayFixedOutput$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2205:5"), groupElement("$anon$2218:7"), groupElement("dmDisplayFixedOutput"));
    ...
    private static final OfInt dmDisplayFlags$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2234:5"), groupElement("dmDisplayFlags"));
    ...
    private static final OfInt dmNup$LAYOUT = (OfInt)$LAYOUT.select(groupElement("$anon$2234:5"), groupElement("dmNup"));

...
public class _SESSION_BUFFER {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        Windows_h.C_CHAR.withName("lsn"),
        Windows_h.C_CHAR.withName("state"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("local_name"),
        MemoryLayout.sequenceLayout(16, Windows_h.C_CHAR).withName("remote_name"),
        Windows_h.C_CHAR.withName("rcvs_outstanding"),
        Windows_h.C_CHAR.withName("sends_outstanding")
